/*
 * QD2_MissionCtrl_Hover_FreqSwp_2021a.h
 *
...
#ifndef QD2_MissionCtrl_Hover_FreqSwp_2021a_h_
#define QD2_MissionCtrl_Hover_FreqSwp_2021a_h_
#ifndef QD2_MissionCtrl_Hover_FreqSwp_2021a_COMMON_INCLUDES_
#define QD2_MissionCtrl_Hover_FreqSwp_2021a_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                /* QD2_MissionCtrl_Hover_FreqSwp_2021a_COMMON_INCLUDES_ */

#include "QD2_MissionCtrl_Hover_FreqSwp_2021a_types.h"
#include "rt_zcfcn.h"
...
#define QD2_MissionCtrl_Hover_FreqSwp_2021a_rtModel RT_MODEL_QD2_MissionCtrl_Hove_T
...
typedef struct {
  int8_T q00_SubsysRanBC;              /* '<S31>/q0 ~ 0' */
  int8_T q10_SubsysRanBC;              /* '<S33>/q1 ~ 0' */
  int8_T q10_SubsysRanBC_a;            /* '<S33>/q1 > 0' */
  int8_T q00_SubsysRanBC_b;            /* '<S31>/q0 > 0' */
...
typedef struct {
  ...
  real_T Gain[3];                      /* '<S28>/Gain' */
  real_T Flight_State;                 /* '<S13>/MATLAB Function' */
  real_T FixPtSum1;                    /* '<S26>/FixPt Sum1' */
  ...
  real_T DataTypeConversion_g;         /* '<S24>/Data Type Conversion' */
  ...
  boolean_T LogicalOperator_l;         /* '<S10>/Logical Operator' */
...
typedef struct {
  ...
  int8_T DiscreteTimeIntegrator_PrevRe_i;/* '<S24>/Discrete-Time Integrator' */
...
} DW_QD2_MissionCtrl_Hover_Freq_T;
...
#define rtB                            QD2_MissionCtrl_Hover_FreqSwp_B
#define BlockIO                        B_QD2_MissionCtrl_Hover_FreqS_T
#define rtP                            QD2_MissionCtrl_Hover_FreqSwp_P
#define Parameters                     P_QD2_MissionCtrl_Hover_FreqS_T
#define rtDWork                        QD2_MissionCtrl_Hover_FreqSw_DW
#define D_Work                         DW_QD2_MissionCtrl_Hover_Freq_T
#define ConstParam                     ConstP_QD2_MissionCtrl_Hover__T
#define rtcP                           QD2_MissionCtrl_Hover_Fr_ConstP
#define rtPrevZCSigState               QD2_MissionCtrl_Hover_F_PrevZCX
...
struct P_CoreSubsys_QD2_MissionCtrl__T_ {
  ...
  real_T QualisysRotateMatrixR_VPRNcolum[9];/* Expression: [0 1 0;0 0 1;1 0 0]'
                                             * Referenced by: '<S27>/ Qualisys Rotate Matrix R_VPRN (column vectors are basis vectors) of VF w.r.t. TNF'
                                             */
  real_T OptiTrackRotateMatrixR_Toolcolu[9];/* Expression: [0 0 -1 ;-1 0 0 ;0 1 0 ]
                                             * Referenced by: '<S27>/OptiTrack Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
                                             */
  real_T PhaseSpaceRotateMatrixR_Toolcol[9];/* Expression: [0 0 1 ;1 0 0 ;0 1 0 ]
                                             * Referenced by: '<S27>/Phase Space Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
                                             */
  real_T GenericRotateMatrixR_VPRNcolumn[9];/* Expression: [1 0 0 ;0 1 0;0 0 1]
                                             * Referenced by: '<S27>/ Generic Rotate Matrix R_VPRN (column vectors are basis vectors) of VF w.r.t. TNF1'
                                             */
  real_T GenericRotateMatrixR_Toolcolumn[9];/* Expression: [1 0 0;0 1 0 ;0 0 1]
                                             * Referenced by: '<S27>/Generic Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
                                             */
...
struct P_QD2_MissionCtrl_Hover_FreqS_T_ {
  ...
  real_T NumberofPulses_Y0;            /* Computed Parameter: NumberofPulses_Y0
                                        * Referenced by: '<S25>/Number of Pulses'
                                        */
  ...
  boolean_T TakeoffAutolandbool_Y0;/* Computed Parameter: TakeoffAutolandbool_Y0
                                    ...
                                    */
  boolean_T SysIDReq_Y0;               /* Computed Parameter: SysIDReq_Y0
                                        * Referenced by: '<S18>/SysIDReq'
                                        */
  ...
  uint8_T ToHostFile_FileFormat;    /* Computed Parameter: ToHostFile_FileFormat
                                     * Referenced by: '<S2>/To Host File'
                                     */
  uint8_T ToHostFile_file_name[87];    /* Expression: file_name_argument
                                        * Referenced by: '<S2>/To Host File'
                                        */
...
extern P_QD2_MissionCtrl_Hover_FreqS_T QD2_MissionCtrl_Hover_FreqSwp_P;

/* Block signals (default storage) */
extern B_QD2_MissionCtrl_Hover_FreqS_T QD2_MissionCtrl_Hover_FreqSwp_B;

/* Block states (default storage) */
extern DW_QD2_MissionCtrl_Hover_Freq_T QD2_MissionCtrl_Hover_FreqSw_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_QD2_MissionCtrl_Hover_T QD2_MissionCtrl_Hover_F_PrevZCX;

/* Constant parameters (default storage) */
extern const ConstP_QD2_MissionCtrl_Hover__T QD2_MissionCtrl_Hover_Fr_ConstP;
...
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_initialize(void);
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_output0(void);
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_update0(void);
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_output2(void);
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_update2(void);
extern void QD2_MissionCtrl_Hover_FreqSwp_2021a_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QD2_MissionCtrl_Hover_FreqSwp_2021a_rtModel
  *QD2_MissionCtrl_Hover_FreqSwp_2021a(void);
...
extern RT_MODEL_QD2_MissionCtrl_Hove_T *const QD2_MissionCtrl_Hover_FreqSw_M;
 ...
 *
 * '<Root>' : 'QD2_MissionCtrl_Hover_FreqSwp_2021a'
 * '<S1>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication'
 * '<S2>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL'
 * '<S3>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Powered by QUARC'
 * '<S4>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Quanser'
 * '<S5>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Compare To Constant'
 * '<S6>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Detect Communication loss'
 * '<S7>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Detect Communication loss/MATLAB Function'
 * '<S8>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Detect Communication loss/Threshold'
 * '<S9>'   : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Calculate Home Pose'
 * '<S10>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY'
 * '<S11>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) '
 * '<S12>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Measurement Conditioning'
 * '<S13>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem'
 * '<S14>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Triggered Subsystem'
 * '<S15>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Calculate Home Pose/Compare To Constant'
 * '<S16>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Calculate Home Pose/Enabled Subsystem'
 * '<S17>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Calculate Home Pose/One Shot'
 * '<S18>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping'
 * '<S19>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Initialization and Conditioning'
 * '<S20>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check'
 * '<S21>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Threshold'
 * '<S22>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping/Compare To Constant'
 * '<S23>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping/Compare To Constant1'
 * '<S24>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping/Threshold'
 * '<S25>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check/pulse count '
 * '<S26>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check/pulse count /Increment Stored Integer'
 * '<S27>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1'
 * '<S28>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /Radians to Degrees'
 * '<S29>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix'
 * '<S30>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion to Rotation Matrix'
 * '<S31>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs'
 * '<S32>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 > 0'
 * '<S33>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0'
 * '<S34>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0'
 * '<S35>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 ~ 0'
 * '<S36>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0/Compare To Zero'
 * '<S37>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0/Compare To Zero1'
 * '<S38>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 ~ 0/Compare To Zero'
 * '<S39>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/Compare To Constant'
 * '<S40>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/Compare To Constant1'
 * '<S41>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/MATLAB Function'
 * '<S42>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/Stop with Message'
 * '<S43>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/Stop with Message/Compare'
 * '<S44>'  : 'QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Triggered Subsystem/Compare To Constant'
 */
#endif                              /* QD2_MissionCtrl_Hover_FreqSwp_2021a_h_ */
