/*
 * QD2_MissionCtrl_Hover_FreqSwp_2021a.c
 *
 ...
 * C source code generated on : Tue Sep 15 19:50:58 2026
 *
...
#include "QD2_MissionCtrl_Hover_FreqSwp_2021a.h"
#include "rtwtypes.h"
#include <string.h>
#include <math.h>
#include "QD2_MissionCtrl_Hover_FreqSwp_2021a_private.h"
#include "zero_crossing_types.h"
#include "rt_nonfinite.h"
#include "QD2_MissionCtrl_Hover_FreqSwp_2021a_dt.h"

/* Named constants for MATLAB Function: '<S6>/MATLAB Function' */
#define QD2_MissionCtrl_Hove_CALL_EVENT (-1)

/* Block signals (default storage) */
B_QD2_MissionCtrl_Hover_FreqS_T QD2_MissionCtrl_Hover_FreqSwp_B;

/* Block states (default storage) */
DW_QD2_MissionCtrl_Hover_Freq_T QD2_MissionCtrl_Hover_FreqSw_DW;

/* Previous zero-crossings (trigger) states */
PrevZCX_QD2_MissionCtrl_Hover_T QD2_MissionCtrl_Hover_F_PrevZCX;

/* Real-time model */
static RT_MODEL_QD2_MissionCtrl_Hove_T QD2_MissionCtrl_Hover_FreqSw_M_;
RT_MODEL_QD2_MissionCtrl_Hove_T *const QD2_MissionCtrl_Hover_FreqSw_M =
  &QD2_MissionCtrl_Hover_FreqSw_M_;
...
{
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Host Game Controller (host_game_controller_block) */
  {
    if (QD2_MissionCtrl_Hover_FreqSwp_P.HostGameController_Enabled) {
...
#pragma pack(pop)
      ...
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M, _rt_error_message);
      }
    }
  }
          ...
          if (result == 0) {
            memory_copy
              (&QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt,
               ...
               (*&QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt),
               state);
            QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_NewData = true;
            qthread_section_unlock
              (&QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_Lock);
          }
        } else {
          rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M,
...
{
  rtmSampleHitPtr[1] = rtmStepTask(QD2_MissionCtrl_Hover_FreqSw_M, 1);
  rtmSampleHitPtr[2] = rtmStepTask(QD2_MissionCtrl_Hover_FreqSw_M, 2);
...
static void rate_monotonic_scheduler(void)
{
  ...
  if (QD2_MissionCtrl_Hover_FreqSw_M->Timing.TaskCounters.TID[1] == 0) {
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.RateInteraction.TID1_2 =
      (QD2_MissionCtrl_Hover_FreqSw_M->Timing.TaskCounters.TID[2] == 0);

    /* update PerTaskSampleHits matrix for non-inline sfcn */
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.perTaskSampleHits[5] =
      QD2_MissionCtrl_Hover_FreqSw_M->Timing.RateInteraction.TID1_2;
  }
   ...
   */
  (QD2_MissionCtrl_Hover_FreqSw_M->Timing.TaskCounters.TID[2])++;
  if ((QD2_MissionCtrl_Hover_FreqSw_M->Timing.TaskCounters.TID[2]) > 15) {/* Sample time: [0.016s, 0.0s] */
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.TaskCounters.TID[2] = 0;
  }
}

/* Model output function for TID0 */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_HostGameController_o8;
  ...
  real_T rtb_TmpSignalConversionAtStream[17];
  ...
  srClearBC(QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_MissionCtrl_Hover_FreqSw_DW.InitializationandConditioning_S);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_MissionCtrl_Hover_FreqSw_DW.pulsecount_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_MissionCtrl_Hover_FreqSw_DW.TriggeredSubsystem_SubsysRanBC);

  /* S-Function (host_initialize_block): '<S10>/Host Initialize' */

  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Host Initialize (host_initialize_block) */
  {
      ...
      if (result == 0) {
        {
          ...
          for (i1=0; i1 < 32; i1++) {
            y1[i1] =
              ((QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.buttons
                & (1U << i1)) != 0);
          }
        }

        rtb_HostGameController_o3[0] =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.sliders
          [0];
        rtb_HostGameController_o3[1] =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.sliders
          [1];
        rtb_HostGameController_o4 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.x;
        rtb_HostGameController_o5 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.y;
        rtb_HostGameController_o6 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.z;
        rtb_HostGameController_o7 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.rx;
        rtb_HostGameController_o8 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.ry;
        rtb_HostGameController_o9 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_ControllerSt.rz;
        QD2_MissionCtrl_Hover_FreqSwp_B.HostGameController_o1 =
          QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_NewData;
        QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_NewData = false;
        qthread_section_unlock
          (&QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_Lock);
      } else {
        {
        ...
        rtb_HostGameController_o8 = 0;
        rtb_HostGameController_o9 = 0;
        QD2_MissionCtrl_Hover_FreqSwp_B.HostGameController_o1 = false;
      }
    } else {
      {
        int_T i1;
  ...
  rtb_TmpSignalConversionAtCompar[4] = rtb_HostGameController_o8;
  ...
  rtb_Relation = (rtb_TmpSignalConversionAtCompar[0] ==
                  QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_k[0]);
  for (i = 0; i < 5; i++) {
    rtb_Relation = (rtb_Relation && (rtb_TmpSignalConversionAtCompar[i + 1] ==
      QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_k[i + 1]));
  }
  ...
  QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator = !rtb_Relation;

  /* DiscreteIntegrator: '<S21>/Discrete-Time Integrator' */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator ||
      (QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRese != 0)) {
  ...
  /* Logic: '<S10>/NOT' */
  NOT = !rtb_RelationalOperator;

  /* Outputs for Enabled SubSystem: '<S10>/FrSKYMapping' incorporates:
   *  EnablePort: '<S18>/Valid Signals Detected'
   */
  if (NOT) {
    QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_MODE = true;
    for (i = 0; i < 32; i++) {
      /* SignalConversion generated from: '<S18>/Buttons' */
      QD2_MissionCtrl_Hover_FreqSwp_B.Buttons[i] = rtb_HostGameController_o2[i];
    }

    /* RelationalOperator: '<S24>/Relation' incorporates:
     *  Constant: '<S24>/threshold'
     */
    rtb_Compare_a = ((real_T)QD2_MissionCtrl_Hover_FreqSwp_B.Buttons[0] >=
                     QD2_MissionCtrl_Hover_FreqSwp_P.Threshold_threshold);

    /* DataTypeConversion: '<S24>/Data Type Conversion' */
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_g = rtb_Compare_a;

    /* Logic: '<S24>/Logical Operator' */
    QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_n = !rtb_Compare_a;

    /* DiscreteIntegrator: '<S24>/Discrete-Time Integrator' */
    if (QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_n ||
        (QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRe_i != 0))
    {
    ...
    QD2_MissionCtrl_Hover_FreqSwp_B.Gain_h =
      QD2_MissionCtrl_Hover_FreqSwp_P.Gain_Gain * rtb_HostGameController_o7;

    /* Bias: '<S18>/Bias' incorporates:
     *  Gain: '<S18>/Gain1'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Bias =
      QD2_MissionCtrl_Hover_FreqSwp_P.Gain1_Gain * rtb_HostGameController_o4 +
      QD2_MissionCtrl_Hover_FreqSwp_P.Bias_Bias;

    /* SignalConversion generated from: '<S18>/y' */
    QD2_MissionCtrl_Hover_FreqSwp_B.y = rtb_HostGameController_o5;

    /* SignalConversion generated from: '<S18>/z' */
    QD2_MissionCtrl_Hover_FreqSwp_B.z = rtb_HostGameController_o6;

    /* RelationalOperator: '<S22>/Compare' incorporates:
     *  Constant: '<S22>/Constant'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Compare_n = (rtb_HostGameController_o9 >=
      QD2_MissionCtrl_Hover_FreqSwp_P.CompareToConstant_const);

    /* RelationalOperator: '<S23>/Compare' incorporates:
     *  Constant: '<S23>/Constant'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Compare_f2 = (rtb_HostGameController_o8 >=
      QD2_MissionCtrl_Hover_FreqSwp_P.CompareToConstant1_const);
    srUpdateBC(QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_SubsysRanBC);
  } else if (QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_MODE) {
    /* Disable for DiscreteIntegrator: '<S24>/Discrete-Time Integrator' */
    QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_DSTATE_h =
      QD2_MissionCtrl_Hover_FreqSwp_B.DiscreteTimeIntegrator;
    QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_MODE = false;
  }
   ...
   */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.HostGameController_o1 &&
      (QD2_MissionCtrl_Hover_F_PrevZCX.pulsecount_Trig_ZCE != POS_ZCSIG)) {
    ...
    QD2_MissionCtrl_Hover_FreqSw_DW.UnitDelay_DSTATE =
      QD2_MissionCtrl_Hover_FreqSwp_B.FixPtSum1;
    QD2_MissionCtrl_Hover_FreqSw_DW.pulsecount_SubsysRanBC = 4;
  }

  QD2_MissionCtrl_Hover_F_PrevZCX.pulsecount_Trig_ZCE =
    QD2_MissionCtrl_Hover_FreqSwp_B.HostGameController_o1;
   ...
   */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.Compare_g) {
    ...
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion4 = rtb_RelationalOperator;

    /* DataTypeConversion: '<S19>/Data Type Conversion5' */
    rtb_Time_e = QD2_MissionCtrl_Hover_FreqSwp_B.Buttons[1];
    ...
    if (QD2_MissionCtrl_Hover_FreqSwp_B.y >
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End) {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_FreqSwp_B.y -
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End;
    } else if (QD2_MissionCtrl_Hover_FreqSwp_B.y >=
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[0] = rtb_Time_h *
      rtb_Product_idx_1;

    /* DeadZone: '<S19>/Dead Zone' */
    if (QD2_MissionCtrl_Hover_FreqSwp_B.z >
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End) {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_FreqSwp_B.z -
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End;
    } else if (QD2_MissionCtrl_Hover_FreqSwp_B.z >=
               QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_Start) {
      rtb_Product_idx_1 = 0.0;
    } else {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_FreqSwp_B.z -
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[1] = rtb_Time_h *
      rtb_Product_idx_1;

    /* DeadZone: '<S19>/Dead Zone' */
    if (QD2_MissionCtrl_Hover_FreqSwp_B.Gain_h >
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End) {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_FreqSwp_B.Gain_h -
        QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_End;
    } else if (QD2_MissionCtrl_Hover_FreqSwp_B.Gain_h >=
               QD2_MissionCtrl_Hover_FreqSwp_P.DeadZone_Start) {
      rtb_Product_idx_1 = 0.0;
    } else {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_FreqSwp_B.Gain_h -
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[2] = rtb_Time_h *
      rtb_Product_idx_1;

    /* Product: '<S19>/Product1' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product1 = rtb_Time_h *
      QD2_MissionCtrl_Hover_FreqSwp_B.Bias;

    /* Product: '<S19>/Product2' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product2 = rtb_Time_h * rtb_Time_e;

    /* Product: '<S19>/Product3' incorporates:
     *  DataTypeConversion: '<S19>/Data Type Conversion7'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Product3 = rtb_Time_h * (real_T)
      QD2_MissionCtrl_Hover_FreqSwp_B.Compare_n;
    srUpdateBC(QD2_MissionCtrl_Hover_FreqSw_DW.InitializationandConditioning_S);
  }
  ...
  QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_l =
    (QD2_MissionCtrl_Hover_FreqSwp_B.Compare_f2 && NOT);

  /* DataTypeConversion: '<S21>/Data Type Conversion' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion = rtb_Relation;

  /* S-Function (time_block): '<S6>/Time' */

  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Detect Communication loss/Time (time_block) */
  {
    t_error result;
  ...
  if (QD2_MissionCtrl_Hover_FreqSwp_P.ManualSwitch1_CurrentSetting == 1) {
    /* ManualSwitch: '<S2>/Manual Switch1' */
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product2;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[1] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product3;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[2] =
      QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion2_i;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[3] =
      QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion4;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[4] =
      QD2_MissionCtrl_Hover_FreqSwp_B.OutportBufferForJoystickIssue01;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[5] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product1;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[6] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[0];
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[7] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[1];
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[8] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[2];
  } else {
    /* ManualSwitch: '<S2>/Manual Switch1' */
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[1] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[2] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[3] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[4] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[5] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[6] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[7] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[8] = 0.0;
  }

  /* End of ManualSwitch: '<S2>/Manual Switch1' */

  /* RateTransition: '<S11>/Rate Transition2' */
  if (QD2_MissionCtrl_Hover_FreqSw_M->Timing.RateInteraction.TID1_2) {
    /* RateTransition: '<S11>/Rate Transition2' */
    for (i = 0; i < 7; i++) {
      QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition2[i] =
        QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition2_Buffer0[i];
    }
  }
  ...
  for (i = 0; i < 7; i++) {
     ...
     *  RateTransition: '<S11>/Rate Transition2'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[i] =
      QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition2[i];
  }

  /* DataTypeConversion: '<S12>/Data Type Conversion2' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion2 =
    QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[6];

  /* Bias: '<S12>/Subtract Rigid Body Reference Offset  (Initial Height)  to get height above the ground' */
  rtb_Time_e = QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[0] +
    QD2_MissionCtrl_Hover_FreqSwp_P.SubtractRigidBodyReferenceOffse[0];

  /* Saturate: '<S12>/Saturation' */
  if (rtb_Time_e > QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[0]) {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[0] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[0];
  } else if (rtb_Time_e < QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[0])
  {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[0] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[0];
  } else {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[0] = rtb_Time_e;
  }

  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[0] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[3];

  /* Bias: '<S12>/Subtract Rigid Body Reference Offset  (Initial Height)  to get height above the ground' */
  rtb_Time_e = QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[1] +
    QD2_MissionCtrl_Hover_FreqSwp_P.SubtractRigidBodyReferenceOffse[1];

  /* Saturate: '<S12>/Saturation' */
  if (rtb_Time_e > QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[1]) {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[1] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[1];
  } else if (rtb_Time_e < QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[1])
  {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[1] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[1];
  } else {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[1] = rtb_Time_e;
  }

  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[1] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[4];

  /* Bias: '<S12>/Subtract Rigid Body Reference Offset  (Initial Height)  to get height above the ground' */
  rtb_Time_e = QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[2] +
    QD2_MissionCtrl_Hover_FreqSwp_P.SubtractRigidBodyReferenceOffse[2];

  /* Saturate: '<S12>/Saturation' */
  if (rtb_Time_e > QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[2]) {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[2] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_UpperSat[2];
  } else if (rtb_Time_e < QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[2])
  {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[2] =
      QD2_MissionCtrl_Hover_FreqSwp_P.Saturation_LowerSat[2];
  } else {
    /* Saturate: '<S12>/Saturation' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[2] = rtb_Time_e;
  }

  /* DataTypeConversion: '<S12>/Data Type Conversion1' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[2] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Reshape1[5];

  /* S-Function (inverse_modulus_block): '<S12>/Unwrap optitrack measurement' */
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Measurement Conditioning/Unwrap optitrack measurement (inverse_modulus_block) */
  {
    static const real_T sampling_period = 0.001;
    real_T half_range =
      QD2_MissionCtrl_Hover_FreqSwp_P.Unwrapoptitrackmeasurement_Modu / 2.0;
    real_T du, dy;
    if (QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Firs) {
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Firs = false;
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Prev =
        QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[2];
    }

    du = (real_T) QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[2] -
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Prev;
    if (du > half_range) {
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Revo =
        QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Revo - 1;
      dy = du - QD2_MissionCtrl_Hover_FreqSwp_P.Unwrapoptitrackmeasurement_Modu;
   ...
   */
  if (QD2_MissionCtrl_Hover_FreqSwp_P.CommandEnable_CurrentSetting == 1) {
    rtb_Time_h = QD2_MissionCtrl_Hover_FreqSwp_P.CustomMode_Value;
  } else {
    rtb_Time_h = QD2_MissionCtrl_Hover_FreqSwp_P.HomeMode_Value;
  }
   ...
   *  Constant: '<S17>/width'
   */
  if (QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_trigger_type == 1.0 &&
      QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] -
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] > 0 ) {
    if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
        QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_redun_pulse == 1.0 ) {
    } else if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
               QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_redun_pulse == 2.0
               ) {
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] = 0.0;
    } else {
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] = 1.0;
    }
  } else if (QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_trigger_type == 2.0 &&
             QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] -
             QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] < 0 ) {
    if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
        QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_redun_pulse == 1.0 ) {
  ...
  } else if ((QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_trigger_type == 3.0
              && QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] -
              QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] < 0 ) ||
             (QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_trigger_type == 3.0
              && QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] -
              QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] > 0 ) ) {
    if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
        QD2_MissionCtrl_Hover_FreqSwp_P.one_shot_block_redun_pulse == 1.0 ) {
  ...
  QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] =
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] ;
  if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] <
      QD2_MissionCtrl_Hover_FreqSwp_P.width_Value ) {
    QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] += 1.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.one_shot_block = 1.0;
  } else if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 1.0 &&
             QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] >=
             QD2_MissionCtrl_Hover_FreqSwp_P.width_Value ) {
    QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] = 0.0;
    QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.one_shot_block = 0.0;
  } else if (QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] == 0.0 ) {
    QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] = 0.0;
    QD2_MissionCtrl_Hover_FreqSwp_B.one_shot_block = 0.0;
  }

  /* Switch: '<S17>/Switch' */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.one_shot_block >=
   ...
   */
  rtb_LogicalOperator = ((QD2_MissionCtrl_Hover_FreqSw_M->Timing.t[0] >
    QD2_MissionCtrl_Hover_FreqSwp_P.CompareToConstant_const_d) &&
    (QD2_MissionCtrl_Hover_FreqSwp_B.Switch != 0.0));

  /* Outputs for Enabled SubSystem: '<S9>/Enabled Subsystem' incorporates:
   *  EnablePort: '<S16>/Enable'
   */
  if (rtb_LogicalOperator) {
    if (!QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_MODE) {
      QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_MODE = true;
    }

    /* SignalConversion generated from: '<S16>/Pose (m, rad ) [4] ' */
    QD2_MissionCtrl_Hover_FreqSwp_B.Posemrad4[0] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[0];
    QD2_MissionCtrl_Hover_FreqSwp_B.Posemrad4[1] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[1];
    QD2_MissionCtrl_Hover_FreqSwp_B.Posemrad4[2] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[2];
    QD2_MissionCtrl_Hover_FreqSwp_B.Posemrad4[3] =
      QD2_MissionCtrl_Hover_FreqSwp_B.Unwrapoptitrackmeasurement;
    srUpdateBC(QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_SubsysRanBC);
  } else if (QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_MODE) {
    QD2_MissionCtrl_Hover_FreqSw_DW.EnabledSubsystem_MODE = false;
  }

  /* End of Outputs for SubSystem: '<S9>/Enabled Subsystem' */

  /* Switch: '<S2>/Switch' */
  if (rtb_Time_h > QD2_MissionCtrl_Hover_FreqSwp_P.Switch_Threshold_l) {
    /* Switch: '<S2>/Switch' incorporates:
     *  Constant: '<S2>/Default Position'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[0] =
      QD2_MissionCtrl_Hover_FreqSwp_P.DefaultPosition_Value[0];
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[1] =
      QD2_MissionCtrl_Hover_FreqSwp_P.DefaultPosition_Value[1];
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[2] =
      QD2_MissionCtrl_Hover_FreqSwp_P.DefaultPosition_Value[2];
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[3] =
      QD2_MissionCtrl_Hover_FreqSwp_P.DefaultPosition_Value[3];
  } else {
    /* Switch: '<S2>/Switch' incorporates:
  ...
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Time (time_block) */
  {
    t_error result;
    t_timeout current_time;
    t_timeout time_difference;
    ...
    if (result == 0) {
      result = timeout_subtract(&time_difference, &current_time,
        &_high_resolution_start_time);
      rtb_Time_h = time_difference.seconds + time_difference.nanoseconds * 1e-9;
    }
  ...
  rtb_Time_e = QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_l;
  ...
  rtb_TmpSignalConversionAtStream[14] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[3];
  rtb_TmpSignalConversionAtStream[15] = rtb_Time_h;
  rtb_TmpSignalConversionAtStream[16] = rtb_Time_e;

  /* S-Function (stream_server_block): '<S1>/Stream Server' incorporates:
   *  Constant: '<S1>/Constant'
   */

  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Stream Server (stream_server_block) */
  {
    t_pstream_state state;
    t_error send_result;
    t_error receive_result;
    if (!QD2_MissionCtrl_Hover_FreqSw_DW.StreamServer_Listening) {
      ...
      options.flags = QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_Endian &
        PSTREAM_FLAG_ENDIAN_MASK;
      if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_Implementation ==
          STREAM_SERVER_IMPLEMENTATION_THREAD) {
        options.flags |= PSTREAM_FLAG_MULTITHREADED;
      }

      if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_Optimize ==
      ...
      if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_SndPriority <
          min_priority) {
        scheduling_parameters.sched_priority = min_priority;
      } else if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_SndPriority >
                 max_priority) {
      ...
      if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_RcvPriority <
          min_priority) {
        scheduling_parameters.sched_priority = min_priority;
      } else if (QD2_MissionCtrl_Hover_FreqSwp_P.StreamServer_RcvPriority >
                 max_priority) {
        scheduling_parameters.sched_priority = max_priority;
      } else {
        scheduling_parameters.sched_priority =
      ...
      if (result == 0) {
        ...
        if (string_length((char *)
                          &QD2_MissionCtrl_Hover_FreqSwp_B.ModelArgument[0], 80)
            == 80) {
          rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M,
          ...
          result = pstream_listen((char *)
            &QD2_MissionCtrl_Hover_FreqSwp_B.ModelArgument[0], &options,
      ...
      QD2_MissionCtrl_Hover_FreqSw_DW.StreamServer_Listening = true;
    }

    if (QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_h) {
    ...
    pstream_get_state(QD2_MissionCtrl_Hover_FreqSw_DW.StreamServer_Stream,
                      &state);
    rtb_StreamServer_o1 = state;
  }

  /* MATLAB Function: '<S6>/MATLAB Function' */
  QD2_MissionCtrl_Hover_FreqSw_DW.sfEvent_m = QD2_MissionCtrl_Hove_CALL_EVENT;
   ...
   */
  rtb_Relation = (i >= QD2_MissionCtrl_Hover_FreqSwp_P.Threshold_threshold_d);

  /* Logic: '<S8>/Logical Operator' */
  QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_k = !rtb_Relation;

  /* DiscreteIntegrator: '<S8>/Discrete-Time Integrator' */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_k ||
      (QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRe_b != 0)) {
  ...
  zcEvent = rt_ZCFcn(FALLING_ZERO_CROSSING,
                     &QD2_MissionCtrl_Hover_F_PrevZCX.TriggeredSubsystem_Trig_ZCE,
                     (QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_e));
  if (zcEvent != NO_ZCEVENT) {
    /* Memory: '<S14>/Memory' */
    rtb_Time_e = QD2_MissionCtrl_Hover_FreqSw_DW.Memory_PreviousInput;

    /* DataTypeConversion: '<S8>/Data Type Conversion' incorporates:
     *  Constant: '<S14>/Constant'
     *  Sum: '<S14>/Add'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_o =
      QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_i + rtb_Time_e;
    ...
    QD2_MissionCtrl_Hover_FreqSw_DW.Memory_PreviousInput =
      QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_o;
    QD2_MissionCtrl_Hover_FreqSw_DW.TriggeredSubsystem_SubsysRanBC = 4;
  }
  ...
  QD2_MissionCtrl_Hover_FreqSwp_B.Product =
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_e * (real_T)
    QD2_MissionCtrl_Hover_FreqSwp_B.Compare_f;

  /* Sum: '<S2>/Subtract' */
  QD2_MissionCtrl_Hover_FreqSwp_B.Subtract = rtb_Time_h -
    QD2_MissionCtrl_Hover_FreqSwp_B.StreamServer_o4;

  /* S-Function (time_block): '<S13>/Time' */

  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/Time (time_block) */
  {
    t_error result;
    t_timeout current_time;
    t_timeout time_difference;
  ...
  /* Product: '<S13>/Product' */
  rtb_Time_h = (real_T)rtb_RelationalOperator *
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0] * (real_T)rtb_Compare_a;
  rtb_Product_idx_1 = (real_T)rtb_RelationalOperator *
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[1] * (real_T)rtb_Compare_a;
  rtb_Product_idx_2 = (real_T)rtb_RelationalOperator *
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[2] * (real_T)rtb_Compare_a;
  rtb_Product_idx_3 = (real_T)rtb_RelationalOperator *
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[3] * (real_T)rtb_Compare_a;

  /* MATLAB Function: '<S13>/MATLAB Function' */
  QD2_MissionCtrl_Hover_FreqSw_DW.sfEvent = QD2_MissionCtrl_Hove_CALL_EVENT;

  /* MATLAB Function 'MISSION CONTROL QDRONE POSITION CONTROL/Subsystem/MATLAB Function': '<S41>:1' */
  /* '<S41>:1:13' */
  rtb_Time_e = 0.0;
  switch ((int32_T)QD2_MissionCtrl_Hover_FreqSw_DW.State) {
   case 0:
    if ((rtb_Time_h == 1.0) && (rtb_Product_idx_2 == 0.0) && (rtb_Product_idx_3 ==
         0.0)) {
      /* '<S41>:1:20' */
      /* '<S41>:1:21' */
      QD2_MissionCtrl_Hover_FreqSw_DW.State = 1.0;
    } else if ((rtb_Product_idx_3 == 1.0) || (rtb_Product_idx_2 == 1.0) ||
               (rtb_Product_idx_1 == 1.0) ||
               (QD2_MissionCtrl_Hover_FreqSwp_B.Product == 1.0)) {
      /* '<S41>:1:22' */
      /* '<S41>:1:23' */
      QD2_MissionCtrl_Hover_FreqSw_DW.State = 9.0;
    }
    break;
   ...
   case 1:
    if ((rtb_Product_idx_2 == 0.0) && (rtb_Product_idx_3 == 0.0)) {
      ...
      if (rtb_Time_h == 0.0) {
        /* '<S41>:1:28' */
        /* '<S41>:1:29' */
        QD2_MissionCtrl_Hover_FreqSw_DW.State = 0.0;
      } else if ((rtb_Time_h == 1.0) && (rtb_Product_idx_1 == 1.0)) {
        /* '<S41>:1:30' */
        /* '<S41>:1:31' */
        QD2_MissionCtrl_Hover_FreqSw_DW.State = 2.0;
      }
   ...
   case 2:
    if ((rtb_Product_idx_2 == 0.0) && (rtb_Product_idx_3 == 0.0)) {
      ...
      if (rtb_Product_idx_1 == 0.0) {
        /* '<S41>:1:39' */
        /* '<S41>:1:40' */
        QD2_MissionCtrl_Hover_FreqSw_DW.State = 3.0;
      } else if ((rtb_Time_h == 0.0) || (QD2_MissionCtrl_Hover_FreqSwp_B.Product
                  == 1.0)) {
        /* '<S41>:1:41' */
        /* '<S41>:1:42' */
        QD2_MissionCtrl_Hover_FreqSw_DW.State = 9.0;
   ...
   case 3:
    if ((rtb_Product_idx_3 == 1.0) || (rtb_Time_h == 0.0) ||
        (QD2_MissionCtrl_Hover_FreqSwp_B.Product == 1.0)) {
      /* '<S41>:1:47' */
      /* '<S41>:1:48' */
      QD2_MissionCtrl_Hover_FreqSw_DW.State = 9.0;
  ...
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[0] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[0];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[1] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[1];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[2] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[2];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[3] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DesiredPosemrad[3];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[4] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[0];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[5] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[1];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[6] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Saturation[2];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[7] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[0];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[8] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion1[1];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[9] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Unwrapoptitrackmeasurement;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[10] =
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion2;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[11] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Subtract;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[12] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Product;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[13] =
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[0];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[14] =
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[1];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[15] =
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[2];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[16] =
    QD2_MissionCtrl_Hover_FreqSwp_B.ManualSwitch1[3];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[17] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Flight_State;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[18] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Product1;
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[19] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[0];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[20] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[1];
  QD2_MissionCtrl_Hover_FreqSwp_B.TmpSignalConversionAtToHostFile[21] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Product_n[2];

  /* RateTransition: '<S11>/Rate Transition6' */
  if (QD2_MissionCtrl_Hover_FreqSw_M->Timing.RateInteraction.TID1_2) {
    /* RateTransition: '<S11>/Rate Transition6' */
    memcpy(&QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition6[0],
           &QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition6_Buffer0[0], 9U *
           sizeof(real_T));

    /* RateTransition: '<S11>/Rate Transition7' */
    memcpy(&QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition7[0],
           &QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition7_Buffer0[0], 9U *
           sizeof(real_T));
  }
   ...
   *  RateTransition: '<S11>/Rate Transition7'
   */
  memcpy(&QD2_MissionCtrl_Hover_FreqSwp_B.Selector[0],
         &QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition7[0], 9U * sizeof(real_T));

  /* RateTransition: '<S11>/Rate Transition8' */
  if (QD2_MissionCtrl_Hover_FreqSw_M->Timing.RateInteraction.TID1_2) {
    /* RateTransition: '<S11>/Rate Transition8' */
    memcpy(&QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition8[0],
           &QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition8_Buffer0[0], 9U *
           sizeof(real_T));
  }
   ...
   *  RateTransition: '<S11>/Rate Transition8'
   */
  memcpy(&QD2_MissionCtrl_Hover_FreqSwp_B.Selector1[0],
         &QD2_MissionCtrl_Hover_FreqSwp_B.RateTransition8[0], 9U * sizeof(real_T));

  /* Delay: '<S13>/Delay' */
  QD2_MissionCtrl_Hover_FreqSwp_B.Delay =
    QD2_MissionCtrl_Hover_FreqSw_DW.Delay_DSTATE[0];

  /* Stop: '<S42>/Stop Simulation' incorporates:
   *  Constant: '<S43>/Constant'
   *  RelationalOperator: '<S43>/Compare'
   */
  if (QD2_MissionCtrl_Hover_FreqSwp_B.Delay !=
      QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_h0) {
    rtmSetStopRequested(QD2_MissionCtrl_Hover_FreqSw_M, true);
  }
  ...
  QD2_MissionCtrl_Hover_FreqSwp_B.OR =
    (QD2_MissionCtrl_Hover_FreqSw_DW.Delay1_DSTATE[0] || (rtb_Time_e != 0.0));

  /* DataTypeConversion: '<S8>/Data Type Conversion' */
  QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_o = rtb_Relation;
}

/* Model update function for TID0 */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_update0(void) /* Sample time: [0.0s, 0.0s] */
{
  int32_T idxDelay;
  ...
  QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRese = (int8_T)
    QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator;

  /* Update for Enabled SubSystem: '<S10>/FrSKYMapping' incorporates:
   *  EnablePort: '<S18>/Valid Signals Detected'
   */
  if (QD2_MissionCtrl_Hover_FreqSw_DW.FrSKYMapping_MODE) {
    ...
    QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRe_i = (int8_T)
  ...
  QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_DSTATE_j +=
    ...
    QD2_MissionCtrl_Hover_FreqSwp_B.DataTypeConversion_o;
  QD2_MissionCtrl_Hover_FreqSw_DW.DiscreteTimeIntegrator_PrevRe_b = (int8_T)
    QD2_MissionCtrl_Hover_FreqSwp_B.LogicalOperator_k;

  /* Update for Delay: '<S13>/Delay' */
  for (idxDelay = 0; idxDelay < 5999; idxDelay++) {
    QD2_MissionCtrl_Hover_FreqSw_DW.Delay_DSTATE[idxDelay] =
      QD2_MissionCtrl_Hover_FreqSw_DW.Delay_DSTATE[idxDelay + 1];
  }

  QD2_MissionCtrl_Hover_FreqSw_DW.Delay_DSTATE[5999] =
    QD2_MissionCtrl_Hover_FreqSwp_B.OR;
  ...
  for (idxDelay = 0; idxDelay < 1999; idxDelay++) {
    QD2_MissionCtrl_Hover_FreqSw_DW.Delay1_DSTATE[idxDelay] =
      QD2_MissionCtrl_Hover_FreqSw_DW.Delay1_DSTATE[idxDelay + 1];
  }

  QD2_MissionCtrl_Hover_FreqSw_DW.Delay1_DSTATE[1999] =
    QD2_MissionCtrl_Hover_FreqSwp_B.Compare;
   ...
   */
  if (!(++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick0)) {
    ++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH0;
  }

  QD2_MissionCtrl_Hover_FreqSw_M->Timing.t[0] =
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick0 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize0 +
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH0 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize0 * 4294967296.0;
   ...
   */
  if (!(++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick1)) {
    ++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH1;
  }

  QD2_MissionCtrl_Hover_FreqSw_M->Timing.t[1] =
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick1 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize1 +
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH1 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize1 * 4294967296.0;
}

/* Model output function for TID2 */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_output2(void) /* Sample time: [0.016s, 0.0s] */
{
  ...
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /VRPN Client (vrpn_client_block) */
  {
    t_error result = 0;
    result = result = vrpn_client_read
      (QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_VRPNClient,
       ...
       NULL, 0,
       NULL, 0,
       &QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData, 1,
    ...
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o1[0] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.pos[0];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o1[1] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.pos[1];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o1[2] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.pos[2];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[0] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.quat[0];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[1] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.quat[1];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[2] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.quat[2];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[3] =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.quat[3];
    QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o9 =
      QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_TrackerData.new_data;
  }
  ...
  for (ForEach_itr = 0; ForEach_itr < 1; ForEach_itr++) {
     ...
     *  Constant: '<S27>/Generic Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
     *  Constant: '<S27>/OptiTrack Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
     *  Constant: '<S27>/Phase Space Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
     *  Constant: '<S2>/Constant'
     */
    switch ((int32_T)QD2_MissionCtrl_Hover_FreqSwp_P.Constant_Value_j) {
     case 0:
      rtb_R_Tool_0 =
       ...
       *  Constant: '<S27>/ Generic Rotate Matrix R_VPRN (column vectors are basis vectors) of VF w.r.t. TNF1'
       *  Constant: '<S27>/Generic Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
     ...
     case 3:
      ...
      /* MultiPortSwitch: '<S27>/Multiport Switch1' incorporates:
       *  Constant: '<S27>/ Qualisys Rotate Matrix R_VPRN (column vectors are basis vectors) of VF w.r.t. TNF'
       *  Constant: '<S27>/Generic Rotate Matrix R_Tool (column vectors are basis vectors) of TNF w.r.t. RSF'
       *  MultiPortSwitch: '<S27>/Multiport Switch'
       */
      rtb_R_VRPN_0 =
     ...
     *  ForEachSliceSelector generated from: '<S27>/q_VF [4xn]'
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_r33 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[0] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[0];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_MathFunction1 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[1] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[1];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_MathFunction2 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[2] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[2];

    /* Math: '<S30>/Math Function3' incorporates:
     *  ForEachSliceSelector generated from: '<S27>/q_VF [4xn]'
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_MathFunction3 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[3] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[3];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_q0q1 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[1] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[2];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_q2q3 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[0] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[3];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_q2q3 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[2] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[3];
     ...
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_q0q1 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[0] *
      QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o2[1];
    ...
    for (i = 0; i < 3; i++) {
      ...
      for (i_0 = 0; i_0 < 3; i_0++) {
        ...
        /* Product: '<S27>/Matrix Multiply2' incorporates:
         *  MultiPortSwitch: '<S27>/Multiport Switch'
         *  MultiPortSwitch: '<S27>/Multiport Switch1'
         */
      ...
      /* End of Product: '<S27>/Matrix Multiply1' */
    }

    for (i = 0; i < 3; i++) {
      /* Product: '<S27>/Matrix Multiply2' incorporates:
       *  Math: '<S27>/Transpose'
       *  Product: '<S27>/Matrix Multiply1'
       */
      ...
      for (i_0 = 0; i_0 < 3; i_0++) {
        /* Math: '<S27>/Transpose' incorporates:
         *  Product: '<S27>/Matrix Multiply3'
         */
        rtb_MatrixMultiply3_tmp = 3 * i + i_0;
    ...
    /* Product: '<S27>/Matrix Multiply3' incorporates:
     *  Math: '<S27>/Transpose'
     *  Product: '<S27>/Matrix Multiply2'
     */
    for (i = 0; i < 3; i++) {
    ...
    /* S-Function (euler_angles_from_rotation_matrix_block): '<S27>/Euler Angles from Rotation Matrix (Relative ZYX)' */
    {
    ...
    /* Product: '<S27>/Matrix Multiply' incorporates:
     *  ForEachSliceSelector generated from: '<S27>/xyz_VF (m) [3xn]'
     *  Product: '<S27>/Matrix Multiply1'
     *  S-Function (vrpn_client_block): '<S11>/VRPN Client'
     */
    rtb_MathFunction3 = 0.0;
    ...
    rtb_q2q3 = 0.0;
    for (i = 0; i < 3; i++) {
      rtb_MathFunction2 = QD2_MissionCtrl_Hover_FreqSwp_B.VRPNClient_o1[i];
    ...
    /* ForEachSliceAssignment generated from: '<S27>/data_RSF (m, rad, bool) [7n]' incorporates:
     *  DataTypeConversion: '<S27>/Data Type Conversion'
     *  ForEachSliceSelector generated from: '<S27>/isTracking [1xn]'
     *  Product: '<S27>/Matrix Multiply'
     *  SignalConversion generated from: '<S27>/data_RSF (m, rad, bool) [7n]'
     */
    i = ForEach_itr * 7;
    ...
    /* ForEachSliceAssignment generated from: '<S27>/rot_RSF (rad) [3n]' incorporates:
     *  SignalConversion generated from: '<S27>/rot_RSF (rad) [3n]'
     */
    ...
    /* Gain: '<S29>/Gain' */
    rtb_r33 = QD2_MissionCtrl_Hover_FreqSwp_P.CoreSubsys.Gain_Gain_b *
      rtb_MathFunction1;
     ...
     */
    if (rtb_r33 > 1.0E-8) {
      /* Update for IfAction SubSystem: '<S31>/q0 > 0' incorporates:
       *  ActionPort: '<S32>/Action Port'
       */
      /* Update for If: '<S31>/If1' */
      srUpdateBC(QD2_MissionCtrl_Hover_FreqSw_DW.CoreSubsys[ForEach_itr].
                 q00_SubsysRanBC_b);

      /* End of Update for SubSystem: '<S31>/q0 > 0' */
    } else {
      /* Outputs for IfAction SubSystem: '<S31>/q0 ~ 0' incorporates:
       *  ActionPort: '<S33>/Action Port'
       */
      if (QD2_MissionCtrl_Hover_FreqSwp_P.CoreSubsys.Gain1_Gain_a *
          rtb_MathFunction1 > 1.0E-8) {
        /* Update for IfAction SubSystem: '<S33>/q1 > 0' incorporates:
        ...
        /* End of Update for SubSystem: '<S33>/q1 > 0' */
      } else {
        /* Update for IfAction SubSystem: '<S33>/q1 ~ 0' incorporates:
      ...
      /* End of Outputs for SubSystem: '<S31>/q0 ~ 0' */
    ...
    /* ForEachSliceAssignment generated from: '<S27>/R_VRPN [3nx3]' incorporates:
     *  MultiPortSwitch: '<S27>/Multiport Switch1'
     */
    i = ForEach_itr * 3;
    for (i_0 = 0; i_0 < 3; i_0++) {
      /* ForEachSliceAssignment generated from: '<S27>/R_Tool [3nx3]' incorporates:
       *  ForEachSliceAssignment generated from: '<S27>/R_RSF [3n x 3]'
       */
      ...
      /* ForEachSliceAssignment generated from: '<S27>/R_Tool [3nx3]' incorporates:
       *  ForEachSliceAssignment generated from: '<S27>/R_VRPN [3nx3]'
       *  MultiPortSwitch: '<S27>/Multiport Switch'
       *  MultiPortSwitch: '<S27>/Multiport Switch1'
       */
      ...
      /* ForEachSliceAssignment generated from: '<S27>/R_RSF [3n x 3]' incorporates:
       *  Product: '<S27>/Matrix Multiply3'
       */
   ...
   *  ForEachSliceAssignment generated from: '<S27>/R_RSF [3n x 3]'
   */
  memcpy(&QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition6_Buffer0[0],
         &rtb_ImpAsg_InsertedFor_R_RSF3nx[0], 9U * sizeof(real_T));

  /* RateTransition: '<S11>/Rate Transition7' incorporates:
   *  ForEachSliceAssignment generated from: '<S27>/R_Tool [3nx3]'
   */
  memcpy(&QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition7_Buffer0[0],
         &rtb_ImpAsg_InsertedFor_R_Tool3n[0], 9U * sizeof(real_T));

  /* RateTransition: '<S11>/Rate Transition8' incorporates:
   *  ForEachSliceAssignment generated from: '<S27>/R_VRPN [3nx3]'
   */
  memcpy(&QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition8_Buffer0[0],
         &rtb_ImpAsg_InsertedFor_R_VRPN3n[0], 9U * sizeof(real_T));
}

/* Model update function for TID2 */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_update2(void) /* Sample time: [0.016s, 0.0s] */
{
  /* Update absolute time */
   ...
   */
  if (!(++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick2)) {
    ++QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH2;
  }

  QD2_MissionCtrl_Hover_FreqSw_M->Timing.t[2] =
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTick2 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize2 +
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.clockTickH2 *
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize2 * 4294967296.0;
}

/* Use this function only if you need to maintain compatibility with an existing static main program. */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_output(int_T tid)
{
  switch (tid) {
   case 0 :
    QD2_MissionCtrl_Hover_FreqSwp_2021a_output0();
    break;

   case 2 :
    QD2_MissionCtrl_Hover_FreqSwp_2021a_output2();
    break;
...
/* Use this function only if you need to maintain compatibility with an existing static main program. */
void QD2_MissionCtrl_Hover_FreqSwp_2021a_update(int_T tid)
{
  switch (tid) {
   case 0 :
    QD2_MissionCtrl_Hover_FreqSwp_2021a_update0();
    break;

   case 2 :
    QD2_MissionCtrl_Hover_FreqSwp_2021a_update2();
    break;
...
void QD2_MissionCtrl_Hover_FreqSwp_2021a_initialize(void)
{
  {
    int32_T i;
    ...
    /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Host Game Controller (host_game_controller_block) */
    {
      qthread_section_init
        (&QD2_MissionCtrl_Hover_FreqSw_DW.HostGameController_Lock, NULL);
    }
    ...
    /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/JOYSTICK_FRSKY/Host Initialize (host_initialize_block) */
    {
      ...
      QD2_MissionCtrl_Hover_FreqSwp_B.HostInitialize_o2 = result;
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M, _rt_error_message);
    ...
    /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Measurement Conditioning/Unwrap optitrack measurement (inverse_modulus_block) */
    {
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Firs = true;
      QD2_MissionCtrl_Hover_FreqSw_DW.Unwrapoptitrackmeasurement_Revo = 0;
    }
    ...
    /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /VRPN Client (vrpn_client_block) */
    {
      ...
      device_list = (const char*)
        QD2_MissionCtrl_Hover_Fr_ConstP.VRPNClient_TraStringList;
      ep = device_list + 11 - 1;
      wp = device_list;
      index = 0;
      ...
      result = vrpn_client_open
        (&QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_VRPNClient,
         ...
         &QD2_MissionCtrl_Hover_FreqSwp_P.VRPNClient_TraNumSensors, 1);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M, _rt_error_message);
      ...
      result = vrpn_client_initialize
        (QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_VRPNClient,
         ...
         NULL, NULL, 0,
         NULL, NULL, 0,
         (t_int *)QD2_MissionCtrl_Hover_FreqSwp_P.VRPNClient_TraReadSensors,
         (t_int *)&QD2_MissionCtrl_Hover_FreqSwp_P.VRPNClient_TraReadSensors[1],
         1);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
...

  {
     ...
     */
    {
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[0] = 0.0;
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[1] = 0.0;
      QD2_MissionCtrl_Hover_FreqSw_DW.one_shot_block_DSTATE[2] = 0.0;
    }
    ...
    for (i = 0; i < 9; i++) {
      ...
      QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition6_Buffer0[i] =
        QD2_MissionCtrl_Hover_FreqSwp_P.RateTransition6_InitialConditio;

      /* InitializeConditions for RateTransition: '<S11>/Rate Transition7' */
      QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition7_Buffer0[i] =
        QD2_MissionCtrl_Hover_FreqSwp_P.RateTransition7_InitialConditio;

      /* InitializeConditions for RateTransition: '<S11>/Rate Transition8' */
      QD2_MissionCtrl_Hover_FreqSw_DW.RateTransition8_Buffer0[i] =
        QD2_MissionCtrl_Hover_FreqSwp_P.RateTransition8_InitialConditio;
    }

    /* InitializeConditions for Delay: '<S13>/Delay' */
    for (i = 0; i < 6000; i++) {
      QD2_MissionCtrl_Hover_FreqSw_DW.Delay_DSTATE[i] =
    ...
    for (i = 0; i < 2000; i++) {
      QD2_MissionCtrl_Hover_FreqSw_DW.Delay1_DSTATE[i] =
    ...
    /* SystemInitialize for RelationalOperator: '<S24>/Relational Operator' incorporates:
     ...
     *  Outport: '<S18>/Roll (%)'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.y = QD2_MissionCtrl_Hover_FreqSwp_P.Roll_Y0;

    /* SystemInitialize for SignalConversion generated from: '<S18>/z' incorporates:
     *  Outport: '<S18>/Pitch (%)'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.z = QD2_MissionCtrl_Hover_FreqSwp_P.Pitch_Y0;

    /* SystemInitialize for Outport: '<S18>/Arm//Disarm (bool) ' incorporates:
     *  SignalConversion generated from: '<S18>/Buttons'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.Buttons[1] =
    ...
    /* SystemInitialize for Sum: '<S26>/FixPt Sum1' incorporates:
     *  Outport: '<S25>/Number of Pulses'
     */
    QD2_MissionCtrl_Hover_FreqSwp_B.FixPtSum1 =
    ...
    QD2_MissionCtrl_Hover_FreqSw_DW.State = 0.0;
    QD2_MissionCtrl_Hover_FreqSw_DW.State_not_empty = true;
    QD2_MissionCtrl_Hover_FreqSw_DW.sfEvent = QD2_MissionCtrl_Hove_CALL_EVENT;
    ...
    /* SystemInitialize for RelationalOperator: '<S44>/Compare' incorporates:
...
void QD2_MissionCtrl_Hover_FreqSwp_2021a_terminate(void)
{
  ...
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/Communication/Stream Server (stream_server_block) */
  {
    if (QD2_MissionCtrl_Hover_FreqSw_DW.StreamServer_Stream != NULL) {
      pstream_close(QD2_MissionCtrl_Hover_FreqSw_DW.StreamServer_Stream);
    }
  ...
  /* S-Function Block: QD2_MissionCtrl_Hover_FreqSwp_2021a/MISSION CONTROL QDRONE POSITION CONTROL/Localization Data Server (VRPN) /VRPN Client (vrpn_client_block) */
  {
    ...
    if ((result = vrpn_client_close
         (QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_VRPNClient)) < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M, _rt_error_message);
    }

    QD2_MissionCtrl_Hover_FreqSw_DW.VRPNClient_VRPNClient = NULL;
  }
}
...
void MdlOutputs(int_T tid)
{
  if (tid == 1)
    tid = 0;
  QD2_MissionCtrl_Hover_FreqSwp_2021a_output(tid);
}
...
void MdlUpdate(int_T tid)
{
  if (tid == 1)
    tid = 0;
  QD2_MissionCtrl_Hover_FreqSwp_2021a_update(tid);
}
...
void MdlStart(void)
{
  QD2_MissionCtrl_Hover_FreqSwp_2021a_initialize();
}

void MdlTerminate(void)
{
  QD2_MissionCtrl_Hover_FreqSwp_2021a_terminate();
}

/* Registration function */
RT_MODEL_QD2_MissionCtrl_Hove_T *QD2_MissionCtrl_Hover_FreqSwp_2021a(void)
{
  /* Registration code */
  ...
  QD2_MissionCtrl_Hover_FreqSwp_P.CoreSubsys.Saturation_UpperSat = rtInf;
  QD2_MissionCtrl_Hover_FreqSwp_P.CoreSubsys.Saturation1_UpperSat = rtInf;

  /* initialize real-time model */
  (void) memset((void *)QD2_MissionCtrl_Hover_FreqSw_M, 0,
                sizeof(RT_MODEL_QD2_MissionCtrl_Hove_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                          &QD2_MissionCtrl_Hover_FreqSw_M->Timing.simTimeStep);
    rtsiSetTPtr(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo, &rtmGetTPtr
                (QD2_MissionCtrl_Hover_FreqSw_M));
    rtsiSetStepSizePtr(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                       &QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                          (&rtmGetErrorStatus(QD2_MissionCtrl_Hover_FreqSw_M)));
    rtsiSetRTModelPtr(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                      QD2_MissionCtrl_Hover_FreqSw_M);
  }

  rtsiSetSimTimeStep(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                     MAJOR_TIME_STEP);
  rtsiSetIsMinorTimeStepWithModeChange
    (&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo, false);
  rtsiSetIsContModeFrozen(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo, false);
  rtsiSetSolverName(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                    "FixedStepDiscrete");

  /* Initialize timing info */
  {
    int_T *mdlTsMap =
      QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;
    mdlTsMap[2] = 2;
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimes =
      (&QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimesArray[0]);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.offsetTimes =
      (&QD2_MissionCtrl_Hover_FreqSw_M->Timing.offsetTimesArray[0]);

    /* task periods */
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimes[0] = (0.0);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimes[1] = (0.001);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleTimes[2] = (0.016);

    /* task offsets */
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.offsetTimes[0] = (0.0);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.offsetTimes[1] = (0.0);
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.offsetTimes[2] = (0.0);
  }

  rtmSetTPtr(QD2_MissionCtrl_Hover_FreqSw_M,
             &QD2_MissionCtrl_Hover_FreqSw_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleHitArray;
    int_T *mdlPerTaskSampleHits =
      QD2_MissionCtrl_Hover_FreqSw_M->Timing.perTaskSampleHitsArray;
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.perTaskSampleHits =
      (&mdlPerTaskSampleHits[0]);
    mdlSampleHits[0] = 1;
    QD2_MissionCtrl_Hover_FreqSw_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(QD2_MissionCtrl_Hover_FreqSw_M, -1);
  QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize0 = 0.001;
  QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize1 = 0.001;
  QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize2 = 0.016;

  /* External mode info */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.checksums[0] = (4127139882U);
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.checksums[1] = (2309731343U);
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.checksums[2] = (1029588233U);
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.checksums[3] = (3868340967U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[24];
    QD2_MissionCtrl_Hover_FreqSw_M->extModeInfo = (&rt_ExtModeInfo);
    ...
    systemRan[9] = (sysRanDType *)&QD2_MissionCtrl_Hover_FreqSw_DW.CoreSubsys[0]
      .q10_SubsysRanBC_a;
    systemRan[10] = (sysRanDType *)&QD2_MissionCtrl_Hover_FreqSw_DW.CoreSubsys[0]
      .q10_SubsysRanBC;
    systemRan[11] = (sysRanDType *)&QD2_MissionCtrl_Hover_FreqSw_DW.CoreSubsys[0]
      .q00_SubsysRanBC;
    systemRan[12] = (sysRanDType *)&QD2_MissionCtrl_Hover_FreqSw_DW.CoreSubsys[0]
      .q00_SubsysRanBC_b;
    ...
    rteiSetModelMappingInfoPtr(QD2_MissionCtrl_Hover_FreqSw_M->extModeInfo,
      &QD2_MissionCtrl_Hover_FreqSw_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(QD2_MissionCtrl_Hover_FreqSw_M->extModeInfo,
                        QD2_MissionCtrl_Hover_FreqSw_M->Sizes.checksums);
    rteiSetTPtr(QD2_MissionCtrl_Hover_FreqSw_M->extModeInfo, rtmGetTPtr
                (QD2_MissionCtrl_Hover_FreqSw_M));
  }

  QD2_MissionCtrl_Hover_FreqSw_M->solverInfoPtr =
    (&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo);
  QD2_MissionCtrl_Hover_FreqSw_M->Timing.stepSize = (0.001);
  rtsiSetFixedStepSize(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo, 0.001);
  rtsiSetSolverMode(&QD2_MissionCtrl_Hover_FreqSw_M->solverInfo,
                    SOLVER_MODE_MULTITASKING);

  /* block I/O */
  QD2_MissionCtrl_Hover_FreqSw_M->blockIO = ((void *)
    &QD2_MissionCtrl_Hover_FreqSwp_B);
  (void) memset(((void *) &QD2_MissionCtrl_Hover_FreqSwp_B), 0,
                sizeof(B_QD2_MissionCtrl_Hover_FreqS_T));

  /* parameters */
  QD2_MissionCtrl_Hover_FreqSw_M->defaultParam = ((real_T *)
    &QD2_MissionCtrl_Hover_FreqSwp_P);

  /* states (dwork) */
  QD2_MissionCtrl_Hover_FreqSw_M->dwork = ((void *)
    &QD2_MissionCtrl_Hover_FreqSw_DW);
  (void) memset((void *)&QD2_MissionCtrl_Hover_FreqSw_DW, 0,
                sizeof(DW_QD2_MissionCtrl_Hover_Freq_T));
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    QD2_MissionCtrl_Hover_FreqSw_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  /* Initialize Sizes */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numContStates = (0);/* Number of continuous states */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numY = (0);/* Number of model outputs */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numU = (0);/* Number of model inputs */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.sysDirFeedThru = (0);/* The model is not direct feedthrough */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numSampTimes = (3);/* Number of sample times */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numBlocks = (271);/* Number of blocks */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numBlockIO = (68);/* Number of block outputs */
  QD2_MissionCtrl_Hover_FreqSw_M->Sizes.numBlockPrms = (309);/* Sum of parameter "widths" */
  return QD2_MissionCtrl_Hover_FreqSw_M;
}
