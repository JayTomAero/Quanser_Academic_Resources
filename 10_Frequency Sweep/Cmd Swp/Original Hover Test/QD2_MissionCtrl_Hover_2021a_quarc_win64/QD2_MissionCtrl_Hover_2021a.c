 ...
 * C source code generated on : Tue Sep 15 15:58:55 2026
 *
...
void QD2_MissionCtrl_Hover_2021a_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (NOT) {
     ...
     */
    QD2_MissionCtrl_Hover_2021a_B.Compare_f2 = (rtb_HostGameController_o8 >=
  ...
  if (QD2_MissionCtrl_Hover_2021a_B.Compare_g) {
    ...
    rtb_Time_e = QD2_MissionCtrl_Hover_2021a_B.Buttons[1];
    ...
    if (QD2_MissionCtrl_Hover_2021a_B.y >
      ...
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_2021a_B.y -
        QD2_MissionCtrl_Hover_2021a_P.DeadZone_End;
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_2021a_B.Product_n[0] = rtb_Time_h * rtb_Product_idx_1;

    /* DeadZone: '<S19>/Dead Zone' */
    if (QD2_MissionCtrl_Hover_2021a_B.z >
        QD2_MissionCtrl_Hover_2021a_P.DeadZone_End) {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_2021a_B.z -
        QD2_MissionCtrl_Hover_2021a_P.DeadZone_End;
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_2021a_B.Product_n[1] = rtb_Time_h * rtb_Product_idx_1;

    /* DeadZone: '<S19>/Dead Zone' */
    if (QD2_MissionCtrl_Hover_2021a_B.Gain_h >
        QD2_MissionCtrl_Hover_2021a_P.DeadZone_End) {
      rtb_Product_idx_1 = QD2_MissionCtrl_Hover_2021a_B.Gain_h -
        QD2_MissionCtrl_Hover_2021a_P.DeadZone_End;
     ...
     *  DeadZone: '<S19>/Dead Zone'
     */
    QD2_MissionCtrl_Hover_2021a_B.Product_n[2] = rtb_Time_h * rtb_Product_idx_1;

    /* Product: '<S19>/Product1' */
    QD2_MissionCtrl_Hover_2021a_B.Product1 = rtb_Time_h *
      QD2_MissionCtrl_Hover_2021a_B.Bias;

    /* Product: '<S19>/Product2' */
    QD2_MissionCtrl_Hover_2021a_B.Product2 = rtb_Time_h * rtb_Time_e;

    /* Product: '<S19>/Product3' incorporates:
     *  DataTypeConversion: '<S19>/Data Type Conversion7'
     */
    QD2_MissionCtrl_Hover_2021a_B.Product3 = rtb_Time_h * (real_T)
  ...
  QD2_MissionCtrl_Hover_2021a_B.LogicalOperator_l =
    (QD2_MissionCtrl_Hover_2021a_B.Compare_f2 && NOT);
  ...
  if (QD2_MissionCtrl_Hover_2021a_P.CommandEnable_CurrentSetting == 1) {
    rtb_Time_h = QD2_MissionCtrl_Hover_2021a_P.CustomMode_Value;
  } else {
    rtb_Time_h = QD2_MissionCtrl_Hover_2021a_P.HomeMode_Value;
  }
  ...
  /* Switch: '<S2>/Switch' */
  if (rtb_Time_h > QD2_MissionCtrl_Hover_2021a_P.Switch_Threshold_l) {
  ...
  rtb_Time_e = QD2_MissionCtrl_Hover_2021a_B.LogicalOperator_l;
  ...
  if (zcEvent != NO_ZCEVENT) {
    /* Memory: '<S14>/Memory' */
    rtb_Time_e = QD2_MissionCtrl_Hover_2021a_DW.Memory_PreviousInput;
    ...
    QD2_MissionCtrl_Hover_2021a_B.DataTypeConversion_o =
      QD2_MissionCtrl_Hover_2021a_P.Constant_Value_i + rtb_Time_e;
  ...
  /* Sum: '<S2>/Subtract' */
  QD2_MissionCtrl_Hover_2021a_B.Subtract = rtb_Time_h -
    QD2_MissionCtrl_Hover_2021a_B.StreamServer_o4;
  ...
  switch ((int32_T)QD2_MissionCtrl_Hover_2021a_DW.State) {
   ...
   case 2:
    if ((rtb_Product_idx_2 == 0.0) && (rtb_Product_idx_3 == 0.0)) {
      ...
      } else if ((rtb_Time_h == 0.0) || (QD2_MissionCtrl_Hover_2021a_B.Product ==
                  1.0)) {
        /* '<S41>:1:41' */
        /* '<S41>:1:42' */
        QD2_MissionCtrl_Hover_2021a_DW.State = 9.0;
...
RT_MODEL_QD2_MissionCtrl_Hove_T *QD2_MissionCtrl_Hover_2021a(void)
{
  ...
  /* External mode info */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[0] = (3856208487U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[1] = (2971127491U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[2] = (279589858U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[3] = (4211855376U);
  ...
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlocks = (271);/* Number of blocks */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlockIO = (68);/* Number of block outputs */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlockPrms = (301);/* Sum of parameter "widths" */
