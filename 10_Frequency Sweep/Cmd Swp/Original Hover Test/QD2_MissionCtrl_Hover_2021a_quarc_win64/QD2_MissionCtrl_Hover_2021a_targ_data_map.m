    ...
    ;%***********************
        ...
        ;%
        ;% Auto data (QD2_MissionCtrl_Hover_2021a_P)
        ;%
            section.nData     = 13;
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CompareToConstant1_const_i
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Threshold_threshold_d
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.StopwithMessage_message_icon
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.StringDisplay_alignment
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.StringDisplay_display_mode
            ...
            section.data(50)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Yaw_Y0
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Roll_Y0
                    section.data(6).logicalSrcIdx = 23;
                    section.data(6).dtTransOffset = 5;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Pitch_Y0
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Gain_Gain
                    section.data(10).logicalSrcIdx = 27;
                    section.data(10).dtTransOffset = 9;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Gain1_Gain
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CustomMode_Value
                    section.data(23).logicalSrcIdx = 40;
                    section.data(23).dtTransOffset = 22;

                    ;% QD2_MissionCtrl_Hover_2021a_P.HomeMode_Value
                    section.data(24).logicalSrcIdx = 41;
                    section.data(24).dtTransOffset = 23;

                    ;% QD2_MissionCtrl_Hover_2021a_P.DefaultPosition_Value
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Constant_Value_k
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.SubtractRigidBodyReferenceOffse
                    section.data(33).logicalSrcIdx = 50;
                    section.data(33).dtTransOffset = 40;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Saturation_UpperSat
                    section.data(34).logicalSrcIdx = 51;
                    section.data(34).dtTransOffset = 43;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Saturation_LowerSat
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.one_shot_block_trigger_type
                    section.data(38).logicalSrcIdx = 55;
                    section.data(38).dtTransOffset = 51;

                    ;% QD2_MissionCtrl_Hover_2021a_P.one_shot_block_redun_pulse
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.Switch_Threshold_l
                    section.data(41).logicalSrcIdx = 58;
                    section.data(41).dtTransOffset = 54;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Constant_Value_h
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.DummyTranslation_Value
                    section.data(48).logicalSrcIdx = 65;
                    section.data(48).dtTransOffset = 61;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Constant_Value_j
                    section.data(49).logicalSrcIdx = 66;
                    section.data(49).dtTransOffset = 64;

                    ;% QD2_MissionCtrl_Hover_2021a_P.Gain_Gain_n
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_SendBufferSize
                    section.data(1).logicalSrcIdx = 68;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_ReceiveBufferSiz
                    section.data(2).logicalSrcIdx = 69;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_ThreadPriority
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_Encoding
                    section.data(7).logicalSrcIdx = 74;
                    section.data(7).dtTransOffset = 6;

                    ;% QD2_MissionCtrl_Hover_2021a_P.VRPNClient_TraNumSensors
                    section.data(8).logicalSrcIdx = 75;
                    section.data(8).dtTransOffset = 7;

                    ;% QD2_MissionCtrl_Hover_2021a_P.VRPNClient_TraReadSensors
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_Decimation
                    section.data(5).logicalSrcIdx = 81;
                    section.data(5).dtTransOffset = 4;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_BitRate
            ...
            section.data(16)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.SysIDReq_Y0
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_RunClient
                    section.data(7).logicalSrcIdx = 89;
                    section.data(7).dtTransOffset = 6;

                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_UseWindow
                    section.data(8).logicalSrcIdx = 90;
                    section.data(8).dtTransOffset = 7;

                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_Active
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.HostGameController_Enabled
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.StreamServer_Active
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.VRPNClient_Active
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.StreamServer_Optimize
                    section.data(2).logicalSrcIdx = 100;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.StreamServer_Implementation
                    section.data(3).logicalSrcIdx = 101;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ShowMessageonHost_MsgIcon
                    section.data(4).logicalSrcIdx = 102;
                    section.data(4).dtTransOffset = 3;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ShowMessageonHost_MsgIcon_e
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.HostInitialize_URI
                    section.data(1).logicalSrcIdx = 104;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ManualSwitch1_CurrentSetting
                    section.data(2).logicalSrcIdx = 105;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CommandEnable_CurrentSetting
                    section.data(3).logicalSrcIdx = 106;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_P.StreamServer_URI
                    section.data(4).logicalSrcIdx = 107;
                    section.data(4).dtTransOffset = 3;

                    ;% QD2_MissionCtrl_Hover_2021a_P.StreamServer_Endian
                    section.data(5).logicalSrcIdx = 108;
                    section.data(5).dtTransOffset = 4;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_VarName
                    section.data(6).logicalSrcIdx = 109;
                    section.data(6).dtTransOffset = 5;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_FileFormat
                    section.data(7).logicalSrcIdx = 110;
                    section.data(7).dtTransOffset = 25;

                    ;% QD2_MissionCtrl_Hover_2021a_P.ToHostFile_file_name
            ...
            section.data(21)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Constant_Value
                    section.data(1).logicalSrcIdx = 112;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Constant_Value_e
                    section.data(2).logicalSrcIdx = 113;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Constant_Value_b
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain_Gain_b
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain1_Gain_a
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias_Bias
                    section.data(1).logicalSrcIdx = 133;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias1_Bias
                    section.data(2).logicalSrcIdx = 134;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias2_Bias
                    section.data(3).logicalSrcIdx = 135;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias1_Bias_i
                    section.data(4).logicalSrcIdx = 136;
                    section.data(4).dtTransOffset = 3;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias_Bias_c
                    section.data(5).logicalSrcIdx = 137;
                    section.data(5).dtTransOffset = 4;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Constant_Value_f
                    section.data(6).logicalSrcIdx = 138;
                    section.data(6).dtTransOffset = 5;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Bias_Bias_a
                    section.data(7).logicalSrcIdx = 139;
                    section.data(7).dtTransOffset = 6;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Constant_Value_n
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain_Gain_c
                    section.data(1).logicalSrcIdx = 141;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain1_Gain_f
                    section.data(2).logicalSrcIdx = 142;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain2_Gain_h
                    section.data(3).logicalSrcIdx = 143;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain1_Gain_k
                    section.data(4).logicalSrcIdx = 144;
                    section.data(4).dtTransOffset = 3;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain_Gain_p
                    section.data(5).logicalSrcIdx = 145;
                    section.data(5).dtTransOffset = 4;

                    ;% QD2_MissionCtrl_Hover_2021a_P.CoreSubsys.Gain_Gain_co
    ...
    ;%**************************
        ...
        ;%
        ;% Auto data (QD2_MissionCtrl_Hover_2021a_B)
        ;%
            section.nData     = 46;
            section.data(46)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.ManualSwitch1
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_B.RateTransition2
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 10;

                    ;% QD2_MissionCtrl_Hover_2021a_B.Reshape1
                    section.data(4).logicalSrcIdx = 3;
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.Saturation
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 25;

                    ;% QD2_MissionCtrl_Hover_2021a_B.DataTypeConversion1
                    section.data(7).logicalSrcIdx = 6;
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.one_shot_block
                    section.data(9).logicalSrcIdx = 8;
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.DesiredPosemrad
                    section.data(11).logicalSrcIdx = 10;
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.TmpSignalConversionAtToHostFile
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 42;

                    ;% QD2_MissionCtrl_Hover_2021a_B.RateTransition6
                    section.data(17).logicalSrcIdx = 16;
                    section.data(17).dtTransOffset = 64;

                    ;% QD2_MissionCtrl_Hover_2021a_B.RateTransition7
                    section.data(18).logicalSrcIdx = 17;
                    section.data(18).dtTransOffset = 73;

                    ;% QD2_MissionCtrl_Hover_2021a_B.Selector
                    section.data(19).logicalSrcIdx = 18;
                    section.data(19).dtTransOffset = 82;

                    ;% QD2_MissionCtrl_Hover_2021a_B.RateTransition8
                    section.data(20).logicalSrcIdx = 19;
                    section.data(20).dtTransOffset = 91;

                    ;% QD2_MissionCtrl_Hover_2021a_B.Selector1
                    section.data(21).logicalSrcIdx = 20;
                    section.data(21).dtTransOffset = 100;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o1
                    section.data(22).logicalSrcIdx = 21;
                    section.data(22).dtTransOffset = 109;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o2
                    section.data(23).logicalSrcIdx = 22;
                    section.data(23).dtTransOffset = 112;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o3
                    section.data(24).logicalSrcIdx = 23;
                    section.data(24).dtTransOffset = 116;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o4
                    section.data(25).logicalSrcIdx = 24;
                    section.data(25).dtTransOffset = 119;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o5
                    section.data(26).logicalSrcIdx = 25;
                    section.data(26).dtTransOffset = 123;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o6
                    section.data(27).logicalSrcIdx = 26;
                    section.data(27).dtTransOffset = 124;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o7
                    section.data(28).logicalSrcIdx = 27;
                    section.data(28).dtTransOffset = 127;

                    ;% QD2_MissionCtrl_Hover_2021a_B.VRPNClient_o8
                    section.data(29).logicalSrcIdx = 28;
                    section.data(29).dtTransOffset = 131;

                    ;% QD2_MissionCtrl_Hover_2021a_B.Gain
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.Product_n
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.HostInitialize_o2
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.HostInitialize_o1
                    section.data(1).logicalSrcIdx = 50;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_B.ModelArgument
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.LogicalOperator_l
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.Buttons
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_B.Compare_f2
    ...
    ;%*******************
        ...
        ;%
        ;% Auto data (QD2_MissionCtrl_Hover_2021a_DW)
        ;%
            section.nData     = 1;
            section.data(1)  = dumData; %prealloc

                    ;% QD2_MissionCtrl_Hover_2021a_DW.VRPNClient_TrackerData
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Timeout
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Timeout_m
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Timeout_g
            ...
            section.data(13)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.one_shot_block_DSTATE
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.RateTransition2_Buffer0
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.RateTransition6_Buffer0
                    section.data(9).logicalSrcIdx = 14;
                    section.data(9).dtTransOffset = 16;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.RateTransition7_Buffer0
                    section.data(10).logicalSrcIdx = 15;
                    section.data(10).dtTransOffset = 25;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.RateTransition8_Buffer0
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.ToHostFile_PointsWritten
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.Scope_PWORK.LoggedData
                    section.data(1).logicalSrcIdx = 23;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.ToHostFile_PWORK
                    section.data(2).logicalSrcIdx = 24;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.NewData_PWORK.LoggedData
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.sfEvent
                    section.data(1).logicalSrcIdx = 26;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.sfEvent_m
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.ToHostFile_SamplesCount
                    section.data(1).logicalSrcIdx = 28;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.ToHostFile_ArrayNameLength
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.StringDisplay_IWORK
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.Delay_DSTATE
                    section.data(1).logicalSrcIdx = 31;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Delay1_DSTATE
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.DiscreteTimeIntegrator_PrevRese
                    section.data(1).logicalSrcIdx = 33;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.DiscreteTimeIntegrator_PrevRe_b
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.DiscreteTimeIntegrator_PrevRe_i
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Owner
                    section.data(2).logicalSrcIdx = 42;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Unwrapoptitrackmeasurement_Firs
                    section.data(3).logicalSrcIdx = 43;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Owner_a
                    section.data(4).logicalSrcIdx = 44;
                    section.data(4).dtTransOffset = 3;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.StreamServer_Listening
                    section.data(5).logicalSrcIdx = 45;
                    section.data(5).dtTransOffset = 4;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.Time_Owner_e
                    section.data(6).logicalSrcIdx = 46;
                    section.data(6).dtTransOffset = 5;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.doneDoubleBufferReInit
                    section.data(7).logicalSrcIdx = 47;
                    section.data(7).dtTransOffset = 6;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.State_not_empty
                    section.data(8).logicalSrcIdx = 48;
                    section.data(8).dtTransOffset = 7;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.doneDoubleBufferReInit_c
                    section.data(9).logicalSrcIdx = 49;
                    section.data(9).dtTransOffset = 8;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.FrSKYMapping_MODE
                    section.data(10).logicalSrcIdx = 50;
                    section.data(10).dtTransOffset = 9;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.EnabledSubsystem_MODE
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% QD2_MissionCtrl_Hover_2021a_DW.CoreSubsys[0].q00_SubsysRanBC
                    section.data(1).logicalSrcIdx = 52;
                    section.data(1).dtTransOffset = 0;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.CoreSubsys[0].q10_SubsysRanBC
                    section.data(2).logicalSrcIdx = 53;
                    section.data(2).dtTransOffset = 1;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.CoreSubsys[0].q10_SubsysRanBC_a
                    section.data(3).logicalSrcIdx = 54;
                    section.data(3).dtTransOffset = 2;

                    ;% QD2_MissionCtrl_Hover_2021a_DW.CoreSubsys[0].q00_SubsysRanBC_b
    ...
    targMap.checksum0 = 3856208487;
    targMap.checksum1 = 2971127491;
    targMap.checksum2 = 279589858;
    targMap.checksum3 = 4211855376;
