/*
 * QD2_MissionCtrl_ManualPC_2021a.h
 *
...
#ifndef QD2_MissionCtrl_ManualPC_2021a_h_
#define QD2_MissionCtrl_ManualPC_2021a_h_
#ifndef QD2_MissionCtrl_ManualPC_2021a_COMMON_INCLUDES_
#define QD2_MissionCtrl_ManualPC_2021a_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                     /* QD2_MissionCtrl_ManualPC_2021a_COMMON_INCLUDES_ */

#include "QD2_MissionCtrl_ManualPC_2021a_types.h"
#include "rt_zcfcn.h"
...
#define QD2_MissionCtrl_ManualPC_2021a_rtModel RT_MODEL_QD2_MissionCtrl_Manu_T

/* Block states (default storage) for system '<S10>/For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1' */
typedef struct {
  int8_T q00_SubsysRanBC;              /* '<S30>/q0 ~ 0' */
  int8_T q10_SubsysRanBC;              /* '<S32>/q1 ~ 0' */
  int8_T q10_SubsysRanBC_h;            /* '<S32>/q1 > 0' */
  int8_T q00_SubsysRanBC_f;            /* '<S30>/q0 > 0' */
} DW_CoreSubsys_QD2_MissionCtrl_T;

/* Block signals for system '<S14>/For Each Subsystem' */
typedef struct {
  real_T one_shot_block;               /* '<S47>/one_shot_block' */
} B_CoreSubsys_QD2_MissionCtr_c_T;

/* Block states (default storage) for system '<S14>/For Each Subsystem' */
typedef struct {
  real_T one_shot_block_DSTATE[3];     /* '<S47>/one_shot_block' */
} DW_CoreSubsys_QD2_MissionCt_f_T;

/* Block signals (default storage) */
typedef struct {
  real_T DataTypeConversion;           /* '<S21>/Data Type Conversion' */
  real_T ManualSwitch1[9];             /* '<S2>/Manual Switch1' */
  real_T RateTransition2[7];           /* '<S10>/Rate Transition2' */
  real_T Reshape1[7];                  /* '<S10>/Reshape1' */
  real_T DataTypeConversion2;          /* '<S11>/Data Type Conversion2' */
  real_T Saturation[3];                /* '<S11>/Saturation' */
  real_T DataTypeConversion1[3];       /* '<S11>/Data Type Conversion1' */
  real_T Unwrapoptitrackmeasurement;  /* '<S11>/Unwrap optitrack measurement' */
  real_T MatrixMultiply[3];            /* '<S14>/Matrix Multiply' */
  real_T Integrator2;                  /* '<S14>/Integrator2' */
  real_T one_shot_block;               /* '<S17>/one_shot_block' */
  real_T Switch;                       /* '<S17>/Switch' */
  real_T Sum[4];                       /* '<S14>/Sum' */
  real_T Gain;                         /* '<S14>/Gain' */
  real_T Switch2[2];                   /* '<S46>/Switch2' */
  real_T Switch2_h;                    /* '<S45>/Switch2' */
  real_T CommandEnable;                /* '<S2>/Command Enable' */
  ...
  real_T RateTransition8[9];           /* '<S10>/Rate Transition8' */
  real_T Selector1[9];                 /* '<S10>/Selector1' */
  real_T Abs[2];                       /* '<S14>/Abs' */
  real_T Switch_g[2];                  /* '<S14>/Switch' */
  real_T YawVelocityScaling;           /* '<S14>/Yaw Velocity Scaling' */
  real_T VRPNClient_o1[3];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o2[4];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o3[3];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o4[4];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o5;                /* '<S10>/VRPN Client' */
  real_T VRPNClient_o6[3];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o7[4];             /* '<S10>/VRPN Client' */
  real_T VRPNClient_o8;                /* '<S10>/VRPN Client' */
  real_T Gain_i[3];                    /* '<S27>/Gain' */
  real_T ImpAsg_InsertedFor_OutputSignal[2];/* '<S44>/One Shot' */
  real_T Flight_State;                 /* '<S12>/MATLAB Function' */
  ...
  int32_T HostInitialize_o2;           /* '<S9>/Host Initialize' */
  uint8_T HostInitialize_o1;           /* '<S9>/Host Initialize' */
  uint8_T ModelArgument[80];           /* '<S1>/Model Argument' */
  boolean_T HostGameController_o1;     /* '<S9>/Host Game Controller' */
  boolean_T LogicalOperator;           /* '<S21>/Logical Operator' */
  boolean_T LogicalOperator_m;         /* '<S8>/Logical Operator' */
  boolean_T HiddenBuf_InsertedFor_EnabledSu;/* '<S8>/Logical Operator' */
  boolean_T LogicalOperator_k;         /* '<S7>/Logical Operator' */
  boolean_T Delay;                     /* '<S12>/Delay' */
  boolean_T Compare;                   /* '<S39>/Compare' */
  boolean_T OR;                        /* '<S12>/OR' */
  boolean_T Compare_d[2];              /* '<S14>/Compare' */
  boolean_T Memory[2];                 /* '<S14>/Memory' */
  boolean_T VRPNClient_o9;             /* '<S10>/VRPN Client' */
  ...
  B_CoreSubsys_QD2_MissionCtr_c_T CoreSubsys_p[2];/* '<S14>/For Each Subsystem' */
} B_QD2_MissionCtrl_ManualPC_20_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  t_vrpn_client_tracker VRPNClient_TrackerData;/* '<S10>/VRPN Client' */
  t_game_controller_states HostGameController_ControllerSt;/* '<S9>/Host Game Controller' */
  qthread_section_t HostGameController_Lock;/* '<S9>/Host Game Controller' */
  t_timeout Time_Timeout;              /* '<S5>/Time' */
  t_timeout Time_Timeout_m;            /* '<S2>/Time' */
  t_timeout Time_Timeout_f;            /* '<S12>/Time' */
  ...
  real_T RateTransition2_Buffer0[7];   /* '<S10>/Rate Transition2' */
  real_T Unwrapoptitrackmeasurement_Prev;
                                      /* '<S11>/Unwrap optitrack measurement' */
  real_T Unwrapoptitrackmeasurement_Revo;
                                      /* '<S11>/Unwrap optitrack measurement' */
  real_T Memory1_PreviousInput;        /* '<S14>/Memory1' */
  real_T RateTransition6_Buffer0[9];   /* '<S10>/Rate Transition6' */
  real_T RateTransition7_Buffer0[9];   /* '<S10>/Rate Transition7' */
  real_T RateTransition8_Buffer0[9];   /* '<S10>/Rate Transition8' */
  real_T Memory_PreviousInput;         /* '<S13>/Memory' */
  real_T State;                        /* '<S12>/MATLAB Function' */
  t_pstream StreamServer_Stream;       /* '<S1>/Stream Server' */
  t_extmode_svr_connected_handle HostInitialize_ConnectedHandle;/* '<S9>/Host Initialize' */
  t_vrpn_client_properties VRPNClient_VRPNClient;/* '<S10>/VRPN Client' */
  t_uint64 ToHostFile_PointsWritten;   /* '<S2>/To Host File' */
  struct {
    void *LoggedData[4];
  } ManualWaypointCommands_PWORK;      /* '<S2>/Manual Waypoint Commands' */
  ...
  struct {
    void *LoggedData;
  } NewData_PWORK;                     /* '<S10>/New Data' */

  int32_T sfEvent;                     /* '<S12>/MATLAB Function' */
  int32_T sfEvent_n;                   /* '<S5>/MATLAB Function' */
  ...
  boolean_T Delay_DSTATE[6000];        /* '<S12>/Delay' */
  boolean_T Delay1_DSTATE[2000];       /* '<S12>/Delay1' */
  ...
  int8_T InitializationandConditioning_S;
                                    /* '<S9>/Initialization and Conditioning' */
  int8_T FrSKYMapping_SubsysRanBC;     /* '<S9>/FrSKYMapping' */
  ...
  boolean_T HostGameController_NewData;/* '<S9>/Host Game Controller' */
  ...
  boolean_T Time_Owner_p;              /* '<S12>/Time' */
  boolean_T Memory_PreviousInput_h[2]; /* '<S14>/Memory' */
  boolean_T doneDoubleBufferReInit;    /* '<S12>/MATLAB Function' */
  boolean_T State_not_empty;           /* '<S12>/MATLAB Function' */
  boolean_T doneDoubleBufferReInit_k;  /* '<S5>/MATLAB Function' */
  boolean_T FrSKYMapping_MODE;         /* '<S9>/FrSKYMapping' */
  boolean_T EnabledSubsystem_MODE;     /* '<S8>/Enabled Subsystem' */
  DW_CoreSubsys_QD2_MissionCt_f_T CoreSubsys_p[2];/* '<S14>/For Each Subsystem' */
  DW_CoreSubsys_QD2_MissionCtrl_T CoreSubsys[1];
  /* '<S10>/For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1' */
} DW_QD2_MissionCtrl_ManualPC_2_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE[2];         /* '<S14>/Integrator' */
  real_T Integrator2_CSTATE;           /* '<S14>/Integrator2' */
} X_QD2_MissionCtrl_ManualPC_20_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Integrator_CSTATE[2];         /* '<S14>/Integrator' */
  real_T Integrator2_CSTATE;           /* '<S14>/Integrator2' */
} XDot_QD2_MissionCtrl_ManualPC_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[2];      /* '<S14>/Integrator' */
  boolean_T Integrator2_CSTATE;        /* '<S14>/Integrator2' */
} XDis_QD2_MissionCtrl_ManualPC_T;
...
#define rtB                            QD2_MissionCtrl_ManualPC_2021_B
#define BlockIO                        B_QD2_MissionCtrl_ManualPC_20_T
#define rtX                            QD2_MissionCtrl_ManualPC_2021_X
#define ContinuousStates               X_QD2_MissionCtrl_ManualPC_20_T
#define rtXdot                         QD2_MissionCtrl_ManualPC_2_XDot
#define StateDerivatives               XDot_QD2_MissionCtrl_ManualPC_T
#define tXdis                          QD2_MissionCtrl_ManualPC_2_XDis
#define StateDisabled                  XDis_QD2_MissionCtrl_ManualPC_T
#define rtP                            QD2_MissionCtrl_ManualPC_2021_P
#define Parameters                     P_QD2_MissionCtrl_ManualPC_20_T
#define rtDWork                        QD2_MissionCtrl_ManualPC_202_DW
#define D_Work                         DW_QD2_MissionCtrl_ManualPC_2_T
#define ConstParam                     ConstP_QD2_MissionCtrl_Manual_T
#define rtcP                           QD2_MissionCtrl_ManualPC_ConstP
#define rtPrevZCSigState               QD2_MissionCtrl_ManualP_PrevZCX
#define PrevZCSigStates                PrevZCX_QD2_MissionCtrl_Manua_T

/* Parameters for system: '<S10>/For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1' */
struct P_CoreSubsys_QD2_MissionCtrl__T_ {
  ...
  int8_T Bias2_Bias;                   /* Computed Parameter: Bias2_Bias
                                        ...
                                        */
  int8_T Bias1_Bias_m;                 /* Computed Parameter: Bias1_Bias_m
                                        * Referenced by: '<S33>/Bias1'
                                        */
  int8_T Bias_Bias_d;                  /* Computed Parameter: Bias_Bias_d
                                        * Referenced by: '<S33>/Bias'
                                        */
  int8_T Constant_Value_iu;            /* Computed Parameter: Constant_Value_iu
                                        * Referenced by: '<S34>/Constant'
                                        */
  int8_T Bias_Bias_f;                  /* Computed Parameter: Bias_Bias_f
                                        * Referenced by: '<S34>/Bias'
                                        */
  int8_T Constant_Value_i2;            /* Computed Parameter: Constant_Value_i2
...
struct P_QD2_MissionCtrl_ManualPC_20_T_ {
  ...
  real_T SubtractRigidBodyReferenceOffse[3];/* Expression: [0 0 -0.07]
                                             * Referenced by: '<S11>/Subtract Rigid Body Reference Offset  (Initial Height)  to get height above the ground'
                                             */
  ...
  real_T Unwrapoptitrackmeasurement_Modu;/* Expression: modulus
                                          * Referenced by: '<S11>/Unwrap optitrack measurement'
                                          */
  real_T CubeLengthm_Value;            /* Expression: 1
                                        * Referenced by: '<S2>/Cube Length (m)'
                                        */
  ...
  real_T Constant_Value_iq;            /* Expression: 0
                                        ...
                                        */
  real_T XVelocityScaling_Gain;        /* Expression: 1
                                        * Referenced by: '<S14>/X Velocity Scaling'
                                        */
  real_T YVelocityScaling_Gain;        /* Expression: -1
                                        * Referenced by: '<S14>/Y Velocity Scaling'
                                        */
  real_T HeightVelocityScaling_Gain;   /* Expression: 1
                                        * Referenced by: '<S14>/Height Velocity Scaling'
                                        */
  ...
  real_T Switch_Threshold;             /* Expression: 0.5
                                        ...
                                        */
  real_T Homeheightm_Value;            /* Expression: 0.75
                                        * Referenced by: '<S2>/Home height (m)'
                                        */
  real_T Gain2_Gain[4];                /* Expression: [ 1 1 0 1]
                                        * Referenced by: '<S14>/Gain2'
                                        */
  real_T Gain_Gain_f;                  /* Expression: -1
                                        * Referenced by: '<S14>/Gain'
                                        */
  real_T MinimumFlightHeight_Value;    /* Expression: 0.3
                                        * Referenced by: '<S14>/Minimum Flight Height'
                                        */
  ...
  real_T DummyTranslation_Value[3];    /* Expression: [0 0 0]'
                                        * Referenced by: '<S10>/Dummy Translation'
                                        */
  real_T Constant1_Value_a[2];         /* Expression: [-1 -1]
                                        * Referenced by: '<S14>/Constant1'
                                        */
  real_T Constant2_Value[2];           /* Expression: [ 1 1]
                                        * Referenced by: '<S14>/Constant2'
                                        */
  real_T Constant3_Value[2];
                          /* Expression: [1/qc_get_step_size 1/qc_get_step_size]
  ...
  real_T Switch_Threshold_k;           /* Expression: 0
                                        ...
                                        */
  real_T YawVelocityScaling_Gain;      /* Expression: 1
                                        * Referenced by: '<S14>/Yaw Velocity Scaling'
                                        */
  ...
  int32_T HostInitialize_SendBufferSize;
                             ...
                             * Referenced by: '<S9>/Host Initialize'
                             */
  ...
  int32_T HostGameController_BufferSize;
                             ...
                             * Referenced by: '<S9>/Host Game Controller'
                             */
  ...
  boolean_T CommunicationIssue01_Y0;
                                   ...
                                   * Referenced by: '<S13>/Communication Issue (0,1)'
                                   */
  ...
  boolean_T Delay1_InitialCondition;
                                   ...
                                   */
  boolean_T Memory_InitialCondition_m[2];
  ...
  uint8_T ToHostFile_FileFormat;    /* Computed Parameter: ToHostFile_FileFormat
                                     * Referenced by: '<S2>/To Host File'
                                     */
  uint8_T ToHostFile_file_name[82];    /* Expression: file_name_argument
                                        * Referenced by: '<S2>/To Host File'
                                        */
  P_CoreSubsys_QD2_MissionCtr_g_T CoreSubsys_p;/* '<S14>/For Each Subsystem' */
...
extern P_QD2_MissionCtrl_ManualPC_20_T QD2_MissionCtrl_ManualPC_2021_P;

/* Block signals (default storage) */
extern B_QD2_MissionCtrl_ManualPC_20_T QD2_MissionCtrl_ManualPC_2021_B;

/* Continuous states (default storage) */
extern X_QD2_MissionCtrl_ManualPC_20_T QD2_MissionCtrl_ManualPC_2021_X;

/* Disabled states (default storage) */
extern XDis_QD2_MissionCtrl_ManualPC_T QD2_MissionCtrl_ManualPC_2_XDis;

/* Block states (default storage) */
extern DW_QD2_MissionCtrl_ManualPC_2_T QD2_MissionCtrl_ManualPC_202_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_QD2_MissionCtrl_Manua_T QD2_MissionCtrl_ManualP_PrevZCX;

/* Constant parameters (default storage) */
extern const ConstP_QD2_MissionCtrl_Manual_T QD2_MissionCtrl_ManualPC_ConstP;
...
extern void QD2_MissionCtrl_ManualPC_2021a_initialize(void);
extern void QD2_MissionCtrl_ManualPC_2021a_output0(void);
extern void QD2_MissionCtrl_ManualPC_2021a_update0(void);
extern void QD2_MissionCtrl_ManualPC_2021a_output2(void);
extern void QD2_MissionCtrl_ManualPC_2021a_update2(void);
extern void QD2_MissionCtrl_ManualPC_2021a_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern QD2_MissionCtrl_ManualPC_2021a_rtModel *QD2_MissionCtrl_ManualPC_2021a
  (void);
...
extern RT_MODEL_QD2_MissionCtrl_Manu_T *const QD2_MissionCtrl_ManualPC_202_M;
 ...
 *
 * '<Root>' : 'QD2_MissionCtrl_ManualPC_2021a'
 * '<S1>'   : 'QD2_MissionCtrl_ManualPC_2021a/Communication'
 * '<S2>'   : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL'
 * '<S3>'   : 'QD2_MissionCtrl_ManualPC_2021a/Powered by QUARC'
 * '<S4>'   : 'QD2_MissionCtrl_ManualPC_2021a/Quanser'
 * '<S5>'   : 'QD2_MissionCtrl_ManualPC_2021a/Communication/Detect Communication loss'
 * '<S6>'   : 'QD2_MissionCtrl_ManualPC_2021a/Communication/Detect Communication loss/MATLAB Function'
 * '<S7>'   : 'QD2_MissionCtrl_ManualPC_2021a/Communication/Detect Communication loss/Threshold'
 * '<S8>'   : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Calculate Home Pose'
 * '<S9>'   : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY'
 * '<S10>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) '
 * '<S11>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Measurement Conditioning'
 * '<S12>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem'
 * '<S13>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Triggered Subsystem'
 * '<S14>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Waypoint Trajectories'
 * '<S15>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Calculate Home Pose/Compare To Constant'
 * '<S16>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Calculate Home Pose/Enabled Subsystem'
 * '<S17>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Calculate Home Pose/One Shot'
 * '<S18>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping'
 * '<S19>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/Initialization and Conditioning'
 * '<S20>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check'
 * '<S21>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/Threshold'
 * '<S22>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping/Compare To Constant'
 * '<S23>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/FrSKYMapping/Threshold'
 * '<S24>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check/pulse count '
 * '<S25>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/JOYSTICK_FRSKY/Pulse Check/pulse count /Increment Stored Integer'
 * '<S26>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1'
 * '<S27>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /Radians to Degrees'
 * '<S28>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix'
 * '<S29>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion to Rotation Matrix'
 * '<S30>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs'
 * '<S31>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 > 0'
 * '<S32>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0'
 * '<S33>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0'
 * '<S34>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 ~ 0'
 * '<S35>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0/Compare To Zero'
 * '<S36>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 > 0/Compare To Zero1'
 * '<S37>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Localization Data Server (VRPN) /For Each Subsystem (Convention Correction:  Motive Frame to Research Studio Frame)1/Quaternion from Rotation Matrix/Compute Signs/q0 ~ 0/q1 ~ 0/Compare To Zero'
 * '<S38>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem/Compare To Constant'
 * '<S39>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem/Compare To Constant1'
 * '<S40>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem/MATLAB Function'
 * '<S41>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem/Stop with Message'
 * '<S42>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Subsystem/Stop with Message/Compare'
 * '<S43>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Triggered Subsystem/Compare To Constant'
 * '<S44>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Waypoint Trajectories/For Each Subsystem'
 * '<S45>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Waypoint Trajectories/Height Saturation'
 * '<S46>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Waypoint Trajectories/X,Y saturation'
 * '<S47>'  : 'QD2_MissionCtrl_ManualPC_2021a/MISSION CONTROL QDRONE MANUAL POSITION CONTROL/Waypoint Trajectories/For Each Subsystem/One Shot'
 */
#endif                                 /* QD2_MissionCtrl_ManualPC_2021a_h_ */
