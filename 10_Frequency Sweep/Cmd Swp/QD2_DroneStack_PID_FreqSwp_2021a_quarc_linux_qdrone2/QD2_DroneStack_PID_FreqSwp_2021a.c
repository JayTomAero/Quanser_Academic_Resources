/*
 * QD2_DroneStack_PID_FreqSwp_2021a.c
 *
...
#include "QD2_DroneStack_PID_FreqSwp_2021a.h"
#include "rtwtypes.h"
#include "QD2_DroneStack_PID_FreqSwp_2021a_types.h"
#include "QD2_DroneStack_PID_FreqSwp_2021a_private.h"
#include <math.h>
...
#include "QD2_DroneStack_PID_FreqSwp_2021a_dt.h"

/* Named constants for MATLAB Function: '<S1>/STATE MACHINE LOGIC' */
#define QD2_DroneStack_PID_F_CALL_EVENT (-1)

/* Block signals (default storage) */
B_QD2_DroneStack_PID_FreqSwp__T QD2_DroneStack_PID_FreqSwp_20_B;

/* Continuous states */
X_QD2_DroneStack_PID_FreqSwp__T QD2_DroneStack_PID_FreqSwp_20_X;

/* Disabled State Vector */
XDis_QD2_DroneStack_PID_FreqS_T QD2_DroneStack_PID_FreqSwp_XDis;

/* Block states (default storage) */
DW_QD2_DroneStack_PID_FreqSwp_T QD2_DroneStack_PID_FreqSwp_2_DW;

/* Previous zero-crossings (trigger) states */
PrevZCX_QD2_DroneStack_PID_Fr_T QD2_DroneStack_PID_Freq_PrevZCX;

/* Real-time model */
static RT_MODEL_QD2_DroneStack_PID_F_T QD2_DroneStack_PID_FreqSwp_2_M_;
RT_MODEL_QD2_DroneStack_PID_F_T *const QD2_DroneStack_PID_FreqSwp_2_M =
  &QD2_DroneStack_PID_FreqSwp_2_M_;
...
{
  rtmSampleHitPtr[1] = rtmStepTask(QD2_DroneStack_PID_FreqSwp_2_M, 1);
  rtmSampleHitPtr[2] = rtmStepTask(QD2_DroneStack_PID_FreqSwp_2_M, 2);
  rtmSampleHitPtr[3] = rtmStepTask(QD2_DroneStack_PID_FreqSwp_2_M, 3);
  rtmSampleHitPtr[4] = rtmStepTask(QD2_DroneStack_PID_FreqSwp_2_M, 4);
...
static void rate_monotonic_scheduler(void)
{
  ...
  if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[1] == 0) {
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_2 =
      (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[2] == 0);

    /* update PerTaskSampleHits matrix for non-inline sfcn */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.perTaskSampleHits[7] =
      QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_2;
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_3 =
      (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[3] == 0);

    /* update PerTaskSampleHits matrix for non-inline sfcn */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.perTaskSampleHits[8] =
      QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_3;
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_4 =
      (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[4] == 0);

    /* update PerTaskSampleHits matrix for non-inline sfcn */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.perTaskSampleHits[9] =
      QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_4;
  }
   ...
   */
  (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[2])++;
  if ((QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[2]) > 1) {/* Sample time: [0.002s, 0.0s] */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[2] = 0;
  }

  (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[3])++;
  if ((QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[3]) > 9) {/* Sample time: [0.01s, 0.0s] */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[3] = 0;
  }

  (QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[4])++;
  if ((QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[4]) > 39) {/* Sample time: [0.04s, 0.0s] */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.TaskCounters.TID[4] = 0;
  }
}
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  rtsiSetdX(si, f0);
  QD2_DroneStack_PID_FreqSwp_2021a_derivatives();
  rtsiSetT(si, tnew);
  for (i = 0; i < nXc; ++i) {
    x[i] += h * f0[i];
  }
 ...
 *    '<S51>/Use desired Y  when enabled'
 */
void Usedesiredheightwhenenabled(RT_MODEL_QD2_DroneStack_PID_F_T * const
  QD2_DroneStack_PID_FreqSwp_2_M, real_T rtu_Enable, real_T rtu_h_dm1,
  ...
  *localDW, P_Usedesiredheightwhenenabled_T *localP)
{
   ...
   */
  if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
    if (rtu_Enable > 0.0) {
...
void QD2_DroneStack_PID_FreqSwp_2021a_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  /* local block i/o variables */
  real_T rtb_Time;
  real_T rtb_Product1;
  ...
  boolean_T pt_ARM_to_TAKEOFF_THROTTLE;
  boolean_T pt_AUTOLAND_TO_DISABLE;
  boolean_T pt_EMERGENCY_ABORT_TO_DISABLE;
  boolean_T pt_EMERGENCY_STOP_TO_DISABLE;
  boolean_T pt_FLIGHT_TO_AUTOLAND;
  boolean_T pt_TAKEOFF_THROTTLE_TO_TAKEOFF_;
  boolean_T pt_TAKE_OFF_HEIGHT_TO_AUTOLAND;
  boolean_T pt_TAKE_OFF_HEIGHT_TO_FLIGHT;
  boolean_T rtb_AND3;
  boolean_T rtb_Compare_gx;
  boolean_T rtb_Compare_k;
  boolean_T rtb_DataTypeConversion3_k;
  boolean_T rtb_OR1;
  boolean_T rtb_Relation;
  boolean_T rtb_Relation_a;
  boolean_T rtb_Relation_cv;
  boolean_T rtb_Relation_e;
  boolean_T rtb_Relation_f;
  boolean_T rtb_Relation_h;
  boolean_T rtb_Relation_js;
  boolean_T rtb_Relation_k;
  boolean_T rtb_Relation_kg;
  boolean_T rtb_Relation_mo;
  boolean_T rtb_Relation_n;
  boolean_T rtb_Relation_ol;
  boolean_T rtb_Relation_p;
  boolean_T rtb_RelationalOperator;
  ZCEventType zcEvent;
  if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
    /* set solver stop time */
    if (!(QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                            ((QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH0
        + 1) * QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                            ((QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick0
        + 1) * QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize0 +
        QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH0 *
        QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize0 * 4294967296.0));
    }
  ...
  if (rtmIsMinorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[0] = rtsiGetT
      (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo);
  }

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_DroneStack_PID_FreqSwp_2_DW.TriggeredSubsystem_SubsysRanBC);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_DroneStack_PID_FreqSwp_2_DW.LatchEStop_SubsysRanBC);
  ...
  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_DroneStack_PID_FreqSwp_2_DW.EnabledSubsystemWriteESCCommand);

  /* Reset subsysRan breadcrumbs */
  srClearBC(QD2_DroneStack_PID_FreqSwp_2_DW.TriggeredSubsystemLatchingFlag_);

  /* RateTransition: '<S5>/Rate Transition6' */
  rtb_Compare_gx = rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M);
  if (rtb_Compare_gx) {
    /* S-Function (hil_read_block): '<S5>/HIL Read' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/HIL Read (hil_read_block) */
    {
      t_error result = hil_read
        (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
         QD2_DroneStack_PID_FreqSwp_20_P.HILRead_analog_channels, 3U,
         NULL, 0U,
         NULL, 0U,
         QD2_DroneStack_PID_FreqSwp_20_P.HILRead_other_channels, 23U,
         &QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[0],
         NULL,
         NULL,
         &QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[0]
         );
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M, _rt_error_message);
      }
    }

    /* S-Function (time_block): '<S5>/Time' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Time (time_block) */
    {
      t_error result;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/Communication/Stream Client (stream_client_block) */
    {
      t_pstream_state state;
      t_error send_result;
      t_error receive_result;
      if (!QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Connected) {
        ...
        options.flags = QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_Endian &
          PSTREAM_FLAG_ENDIAN_MASK;
        if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_Implementation ==
            STREAM_CLIENT_IMPLEMENTATION_THREAD) {
          options.flags |= PSTREAM_FLAG_MULTITHREADED;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_Optimize ==
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_SndPriority <
            min_priority) {
          scheduling_parameters.sched_priority = min_priority;
        } else if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_SndPriority >
                   max_priority) {
        ...
        if (result == 0) {
          ...
          if (result == 0) {
            ...
            if (result < 0) {
              rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M,
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_RcvPriority <
            min_priority) {
          scheduling_parameters.sched_priority = min_priority;
        } else if (QD2_DroneStack_PID_FreqSwp_20_P.StreamClient_RcvPriority >
                   max_priority) {
          scheduling_parameters.sched_priority = max_priority;
        } else {
          scheduling_parameters.sched_priority =
        ...
        if (result == 0) {
          ...
          if (string_length((char *)
                            &QD2_DroneStack_PID_FreqSwp_20_B.ModelArgument[0],
                            80) == 80) {
            rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M,
            ...
            result = pstream_connect((char *)
              &QD2_DroneStack_PID_FreqSwp_20_B.ModelArgument[0], &options,
        ...
        QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Connected = true;
      }

      if (QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_d) {
      ...
      receive_result = pstream_receive
        (QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream,
         &QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[0]);
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o2 = 0;
      if (send_result < 0 && send_result != -QERR_WOULD_BLOCK) {
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o2 = send_result;
      } else if (receive_result < 0 && receive_result != -QERR_WOULD_BLOCK) {
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o2 = receive_result;
      }

      pstream_get_state(QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream,
                        &state);
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o1 = state;
    }

    /* DataTypeConversion: '<S10>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[0] =
      (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[0] != 0.0);
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[1] =
      (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[1] != 0.0);
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[2] =
      (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[2] != 0.0);
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3] =
      (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[3] != 0.0);
     ...
     */
    if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
      if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[2] &&
          (QD2_DroneStack_PID_Freq_PrevZCX.LatchEStop_Trig_ZCE != POS_ZCSIG)) {
        /* SignalConversion generated from: '<S20>/Input' */
        QD2_DroneStack_PID_FreqSwp_20_B.Input =
          QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[2];
        QD2_DroneStack_PID_FreqSwp_2_DW.LatchEStop_SubsysRanBC = 4;
      }

      QD2_DroneStack_PID_Freq_PrevZCX.LatchEStop_Trig_ZCE =
        QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[2];
    }
     ...
     */
    rtb_Relation_e = (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22 &&
                      !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24);

    /* DataTypeConversion: '<S1>/Data Type Conversion1' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1 = rtb_Relation_e;

    /* MATLAB Function: '<S5>/MATLAB Function' incorporates:
     *  Memory: '<S5>/Memory'
     *  Memory: '<S5>/Memory1'
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_p = QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    /* '<S76>:1:48' */
    /* '<S76>:1:49' */
    QD2_DroneStack_PID_FreqSwp_20_B.cmd[0] = 0.0;
    QD2_DroneStack_PID_FreqSwp_20_B.cmd[1] = 0.0;
    QD2_DroneStack_PID_FreqSwp_20_B.cmd[2] = 0.0;
    QD2_DroneStack_PID_FreqSwp_20_B.cmd[3] = 0.0;

    /* '<S76>:1:50' */
    QD2_DroneStack_PID_FreqSwp_20_B.tele_enable = 0.0;

    /* '<S76>:1:51' */
    QD2_DroneStack_PID_FreqSwp_20_B.cmd_enable = 0.0;

    /* '<S76>:1:52' */
    /* '<S76>:1:53' */
    QD2_DroneStack_PID_FreqSwp_20_B.esc_ready = 0.0;
    if (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[2] != 0.0) {
      /* '<S76>:1:58' */
      sigmoid = 99.0;
    } else {
      switch ((int32_T)QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_f) {
       case 0:
        /* '<S76>:1:63' */
        QD2_DroneStack_PID_FreqSwp_2_DW.state_counter--;
        if (QD2_DroneStack_PID_FreqSwp_2_DW.state_counter <= 0.0) {
          /* '<S76>:1:64' */
          /* '<S76>:1:66' */
          sigmoid = 1.0;

          /* '<S76>:1:67' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter = 10000.0;
        } else {
          /* '<S76>:1:70' */
          sigmoid = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_f;
        }
        break;
       ...
       case 1:
        ...
        if (QD2_DroneStack_PID_FreqSwp_2_DW.state_counter <= 0.0) {
          ...
          /* '<S76>:1:81' */
          QD2_DroneStack_PID_FreqSwp_2_DW.esc_timeout_state = 1.0;
        } else if (QD2_DroneStack_PID_FreqSwp_2_DW.Memory1_PreviousInput) {
          /* '<S76>:1:85' */
          /* '<S76>:1:87' */
          sigmoid = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_f;
        } else {
          ...
          /* '<S76>:1:91' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter = 1000.0;

          /* '<S76>:1:92' */
          QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause = 3.0;

          /* '<S76>:1:93' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_after_pause = 60.0;
        }
        break;
       ...
       case 3:
        ...
        if (QD2_DroneStack_PID_FreqSwp_2_DW.state_counter <= 0.0) {
          ...
          /* '<S76>:1:104' */
          QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause = 4.0;

          /* '<S76>:1:105' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_after_pause = 120.0;
        } else {
          /* '<S76>:1:111' */
          sigmoid = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_f;
        }
       ...
       case 4:
        ...
        if (QD2_DroneStack_PID_FreqSwp_2_DW.state_counter <= 0.0) {
          ...
          /* '<S76>:1:120' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter = 500.0;

          /* '<S76>:1:121' */
          QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause = 2.0;

          /* '<S76>:1:122' */
          QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_after_pause = 1000.0;
        } else {
          /* '<S76>:1:125' */
          sigmoid = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_f;
        }
       ...
       case 2:
        if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1 != 0.0) {
          /* '<S76>:1:132' */
          sigmoid = 5.0;
        } else {
          /* '<S76>:1:135' */
       ...
       case 88:
        ...
        if (QD2_DroneStack_PID_FreqSwp_2_DW.state_counter <= 0.0) {
          /* '<S76>:1:158' */
          /* '<S76>:1:160' */
          sigmoid = QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause;
    ...
    switch ((int32_T)sigmoid) {
     case 0:
      ...
      /* '<S76>:1:191' */
      QD2_DroneStack_PID_FreqSwp_20_B.tele_enable = 1.0;

      /* '<S76>:1:192' */
      QD2_DroneStack_PID_FreqSwp_20_B.cmd_enable = 1.0;
     ...
     case 3:
      /* '<S76>:1:206' */
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[0] = 3.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[1] = 3.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[2] = 3.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[3] = 3.0;
     ...
     case 4:
      /* '<S76>:1:218' */
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[0] = 20.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[1] = 21.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[2] = 21.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[3] = 20.0;
     ...
     case 2:
      ...
      /* '<S76>:1:236' */
      /* '<S76>:1:237' */
      QD2_DroneStack_PID_FreqSwp_20_B.esc_ready = 1.0;
      break;

     case 5:
      /* '<S76>:1:241' */
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[0] = 48.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[1] = 48.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[2] = 48.0;
      QD2_DroneStack_PID_FreqSwp_20_B.cmd[3] = 48.0;
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.state = sigmoid;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/THROTTLE SWITCHBOX /Continuous Sigmoid (continuous_sigmoid_block) */
    {
      if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
        {
          real_T* params;
          ...
          params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Sigmoid[0 *
          ...
          /*  Check if the target position has changed or if it is the first
             ...
             trajectory. */
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag == 1 ||
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time == 0) {
            ...
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag = 0;
            ...
            if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time == 0) {
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time = 0.001;
            }
          ...
          QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o4 = 0;
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time <
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1 =
              ...
              * params[SIGMOID_PARAMETER_AP] *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time) *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time;
          } else if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time <
                     params[SIGMOID_PARAMETER_T2]) {
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o2 =
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o2 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1 =
            ...
            if ((QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time -
              ...
              QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o4 = 1;/* Assert Done signal */
          }
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_np = QD2_DroneStack_PID_F_CALL_EVENT;
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_m = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'COMMANDER (ANGLE MODE)/THROTTLE SWITCHBOX /Hover Throttle Sigmoid Parameters': '<S40>:1' */
    /* '<S40>:1:8' */
    QD2_DroneStack_PID_FreqSwp_20_B.enable_d = 0.0;

    /* '<S40>:1:9' */
    QD2_DroneStack_PID_FreqSwp_20_B.throttle_ref = 0.0;

    /* '<S40>:1:10' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel = 0.0;

    /* '<S40>:1:11' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_accel = 0.0;
    switch ((int32_T)sigmoid) {
     case 1:
      /* '<S40>:1:16' */
      /* '<S40>:1:17' */
     ...
     case 2:
      /* '<S40>:1:23' */
      QD2_DroneStack_PID_FreqSwp_20_B.enable_d = 1.0;
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value[0];

      /* '<S40>:1:26' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value[1];
      break;
     ...
     case 4:
      ...
      /* '<S40>:1:38' */
      if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o2 > 0.0) {
        /* '<S40>:1:39' */
        /* '<S40>:1:40' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value[0];
        ...
        /* '<S40>:1:43' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant3_Value[0];

        /* '<S40>:1:44' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_accel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant3_Value[1];
      }
      break;
     ...
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.enable_d >
        QD2_DroneStack_PID_FreqSwp_20_P.Switch1_Threshold) {
      sigmoid = QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1;
    } else {
      sigmoid = QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value;
    }
    ...
    if (sigmoid > rtb_DataTypeConversion3) {
      /* Switch: '<S44>/Switch2' */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2 = rtb_DataTypeConversion3;
    } else if (sigmoid < QD2_DroneStack_PID_FreqSwp_20_P.Constant4_Value) {
       ...
       *  Switch: '<S44>/Switch'
       */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2 = sigmoid;
    }
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Integrator1 =
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE;
  if (rtb_Compare_gx) {
    /* S-Function (euler_angles_to_rotation_matrix_block): '<S3>/Euler Angles to Rotation Matrix1' incorporates:
     *  Constant: '<S3>/Constant'
     */
    {
      t_double sin_phi = sin(QD2_DroneStack_PID_FreqSwp_20_B.Integrator1);
      t_double cos_phi = cos(QD2_DroneStack_PID_FreqSwp_20_B.Integrator1);
      t_double sin_theta = sin(QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_l);
      t_double cos_theta = cos(QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_l);
      t_double sin_psi = sin(QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_l);
      t_double cos_psi = cos(QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_l);
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid (continuous_sigmoid_block) */
    {
      if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
        {
          real_T* params;
          ...
          /* Determine the correct step size for the output ports */
          params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Sigmoid_l
            [0 * NUMBER_OF_SIGMOID_PARAMETERS];

          /*  Check if the target position has changed or if it is the first
             simulation step, in which case we need to compute the initial
             trajectory. */
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h == 1 ||
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c == 0) {
            /*  Read the new position and reset the flag */
            params[SIGMOID_PARAMETER_XD] =
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Target_d;
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h = 0;

            /*  Calculate a single step using the new trajectory to account for the target
               change that occured at the previous sample (i.e., there is a one sample delay
               between the point where the target position changes and the trajectory changes
               based on the new target)    */
            if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c == 0) {
              /*  Do not update the trajectory since we are at time 0 in simulation
                 (leave t = 0)   */
            } else {
              /*  Set the relative time to one step size so that a single step
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c = 0.001;
            }
          ...
          /* Mark the target as not reached */
          QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o4_m = 0;
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c <
              params[SIGMOID_PARAMETER_T1]) {
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a =
              ...
              * params[SIGMOID_PARAMETER_AP] *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c) *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c;
          } else if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c <
                     params[SIGMOID_PARAMETER_T2]) {
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o3_b = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o2_l =
              params[SIGMOID_PARAMETER_VP];
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a =
              params[SIGMOID_PARAMETER_X1] + params[SIGMOID_PARAMETER_VP] *
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o3_b = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o2_l = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a =
              params[SIGMOID_PARAMETER_XD];/* always attainable */
            ...
            if ((QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Time_c -
                 params[SIGMOID_PARAMETER_T3]) >=
                params[SIGMOID_PARAMETER_HOLD_OFF])
              QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o4_m = 1;/* Assert Done signal */
          }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid1 (continuous_sigmoid_block) */
    {
      if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
        {
          real_T* params;
          ...
          /* Determine the correct step size for the output ports */
          params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Sigmoid[0
            * NUMBER_OF_SIGMOID_PARAMETERS];

          /*  Check if the target position has changed or if it is the first
             simulation step, in which case we need to compute the initial
             trajectory. */
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag == 1 ||
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time == 0) {
            /*  Read the new position and reset the flag */
            params[SIGMOID_PARAMETER_XD] =
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Target;
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag = 0;

            /*  Calculate a single step using the new trajectory to account for the target
               change that occured at the previous sample (i.e., there is a one sample delay
               between the point where the target position changes and the trajectory changes
               based on the new target)    */
            if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time == 0) {
              /*  Do not update the trajectory since we are at time 0 in simulation
                 (leave t = 0)   */
            } else {
              /*  Set the relative time to one step size so that a single step
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time = 0.001;
            }
          ...
          /* Mark the target as not reached */
          QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o4 = 0;
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time <
              params[SIGMOID_PARAMETER_T1]) {
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 =
              ...
              * params[SIGMOID_PARAMETER_AP] *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time) *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time;
          } else if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time <
                     params[SIGMOID_PARAMETER_T2]) {
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o2 =
              params[SIGMOID_PARAMETER_VP];
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 =
              params[SIGMOID_PARAMETER_X1] + params[SIGMOID_PARAMETER_VP] *
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o2 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 =
              params[SIGMOID_PARAMETER_XD];/* always attainable */
            ...
            if ((QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Time -
                 params[SIGMOID_PARAMETER_T3]) >=
                params[SIGMOID_PARAMETER_HOLD_OFF])
              QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o4 = 1;/* Assert Done signal */
          }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid2 (continuous_sigmoid_block) */
    {
      if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
        {
          real_T* params;
          ...
          /* Determine the correct step size for the output ports */
          params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Sigmoid[0
            * NUMBER_OF_SIGMOID_PARAMETERS];

          /*  Check if the target position has changed or if it is the first
             simulation step, in which case we need to compute the initial
             trajectory. */
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag == 1 ||
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time == 0) {
            /*  Read the new position and reset the flag */
            params[SIGMOID_PARAMETER_XD] =
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Target;
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag = 0;

            /*  Calculate a single step using the new trajectory to account for the target
               change that occured at the previous sample (i.e., there is a one sample delay
               between the point where the target position changes and the trajectory changes
               based on the new target)    */
            if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time == 0) {
              /*  Do not update the trajectory since we are at time 0 in simulation
                 (leave t = 0)   */
            } else {
              /*  Set the relative time to one step size so that a single step
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time = 0.001;
            }
          ...
          /* Mark the target as not reached */
          QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o4 = 0;
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time <
              params[SIGMOID_PARAMETER_T1]) {
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 =
              ...
              * params[SIGMOID_PARAMETER_AP] *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time) *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time;
          } else if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time <
                     params[SIGMOID_PARAMETER_T2]) {
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o2 =
              params[SIGMOID_PARAMETER_VP];
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 =
              params[SIGMOID_PARAMETER_X1] + params[SIGMOID_PARAMETER_VP] *
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o2 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 =
              params[SIGMOID_PARAMETER_XD];/* always attainable */
            ...
            if ((QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Time -
                 params[SIGMOID_PARAMETER_T3]) >=
                params[SIGMOID_PARAMETER_HOLD_OFF])
              QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o4 = 1;/* Assert Done signal */
          }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid3 (continuous_sigmoid_block) */
    {
      if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
        {
          real_T* params;
          ...
          /* Determine the correct step size for the output ports */
          params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Sigmoid[0
            * NUMBER_OF_SIGMOID_PARAMETERS];

          /*  Check if the target position has changed or if it is the first
             simulation step, in which case we need to compute the initial
             trajectory. */
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag == 1 ||
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time == 0) {
            /*  Read the new position and reset the flag */
            params[SIGMOID_PARAMETER_XD] =
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Target;
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag = 0;

            /*  Calculate a single step using the new trajectory to account for the target
               change that occured at the previous sample (i.e., there is a one sample delay
               between the point where the target position changes and the trajectory changes
               based on the new target)    */
            if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time == 0) {
              /*  Do not update the trajectory since we are at time 0 in simulation
                 (leave t = 0)   */
            } else {
              /*  Set the relative time to one step size so that a single step
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time = 0.001;
            }
          ...
          /* Mark the target as not reached */
          QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o4 = 0;
          if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time <
              params[SIGMOID_PARAMETER_T1]) {
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 =
              ...
              * params[SIGMOID_PARAMETER_AP] *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time) *
              QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time;
          } else if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time <
                     params[SIGMOID_PARAMETER_T2]) {
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o2 =
              params[SIGMOID_PARAMETER_VP];
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 =
              params[SIGMOID_PARAMETER_X1] + params[SIGMOID_PARAMETER_VP] *
            ...
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o3 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o2 = 0;
            QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 =
              params[SIGMOID_PARAMETER_XD];/* always attainable */
            ...
            if ((QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Time -
                 params[SIGMOID_PARAMETER_T3]) >=
                params[SIGMOID_PARAMETER_HOLD_OFF])
              QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o4 = 1;/* Assert Done signal */
          }
     ...
     */
    rtb_KiradsmradsmNsmradsrads[0] = QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain[0]
      * QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[0];
    rtb_KiradsmradsmNsmradsrads[1] = QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain[1]
      * QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[1];
    rtb_KiradsmradsmNsmradsrads[2] = QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain[2]
      * QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[2];
    rtb_KiradsmradsmNsmradsrads[3] = QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain[3]
     ...
     *  Switch: '<S57>/Switch'
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a >
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[0]) {
      /* Switch: '<S57>/Switch2' */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[0];
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a <
    ...
    if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 >
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[1]) {
      /* Switch: '<S57>/Switch2' */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[1];
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 <
    ...
    if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 >
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[2]) {
      /* Switch: '<S57>/Switch2' */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.PositionSafetyThresholdm3_Value[2];
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 <
    ...
    if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 >
        QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_j) {
      /* Switch: '<S57>/Switch2' */
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_j;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 <
    ...
    /* Sum: '<S3>/Sum' */
    rtb_KiradsmradsmNsmradsrads[3] = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[3]
      - QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[10];
    rtb_KiradsmradsmNsmradsrads[0] = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[0]
      - QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[5];

    /* Product: '<S3>/Matrix Multiply' */
    rtb_Product_h_idx_0 = 0.0;

    /* Sum: '<S3>/Sum' */
    rtb_KiradsmradsmNsmradsrads[1] = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[1]
      - QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[6];

    /* Product: '<S3>/Matrix Multiply' */
    rtb_Product_h_idx_1 = 0.0;

    /* Sum: '<S3>/Sum' */
    rtb_KiradsmradsmNsmradsrads[2] = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2]
      - QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7];
     ...
     */
    QD2_DroneStack_PID_FreqSwp_20_B.Gain[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.KpradmradmNmradsrad_Gain[0] *
      rtb_Product_h_idx_0 * QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_l[0];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.KpradmradmNmradsrad_Gain[1] *
      rtb_Product_h_idx_1 * QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_l[1];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.KpradmradmNmradsrad_Gain[2] *
      rtb_Product_h_idx_2 * QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_l[2];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.KpradmradmNmradsrad_Gain[3] *
      rtb_KiradsmradsmNsmradsrads[3] *
      QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_l[3];
  ...
  /* Limited  Integrator  */
  if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
    rtb_Relation_k = (QD2_DroneStack_PID_FreqSwp_20_B.Compare &&
                      (QD2_DroneStack_PID_Freq_PrevZCX.Integrator1_Reset_ZCE !=
                       POS_ZCSIG));
    QD2_DroneStack_PID_Freq_PrevZCX.Integrator1_Reset_ZCE =
      QD2_DroneStack_PID_FreqSwp_20_B.Compare;
    ...
    if (rtb_Relation_k) {
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] =
  ...
  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] >=
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[0]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[0];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] <=
             QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[0]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[0];
  }

  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] >=
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[1]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[1];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] <=
             QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[1]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[1];
  }

  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] >=
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[2]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[2];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] <=
             QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[2]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[2];
  }

  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] >=
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[3]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[3];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] <=
             QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[3]) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[3];
  }
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[2] = rtb_Integrator7_idx_0;
  QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[1] = data_loss;
  QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[0] = sigmoid;
  ...
  for (ForEach_itr_a = 0; ForEach_itr_a < 2; ForEach_itr_a++) {
    ...
    for (i = 0; i < 6; i++) {
      rtb_MultiportSwitch[i] = (&QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[0])
        [6 * ForEach_itr_a + i];
    }
     ...
     *  Integrator: '<S85>/Integrator1'
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys_pn[ForEach_itr_a].sfEvent =
      QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    /* Integrator: '<S84>/Integrator1' */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Integrator1[0] =
      QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
     ...
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1[0] =
     ...
     *  Sum: '<S84>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product[0] =
     ...
     *  Sum: '<S85>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product_i[0] =
     ...
     *  Integrator: '<S85>/Integrator2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1_i[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.CoreSubsys_pn.AccelerometerFilterCutoffFreque
      * QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
      Integrator2_CSTATE_k[0];

    /* Integrator: '<S84>/Integrator1' */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Integrator1[1] =
      QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
     ...
     *  Integrator: '<S84>/Integrator2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.CoreSubsys_pn.GyroFilterCutoffFrequencyrads_V
      * QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
     ...
     *  Sum: '<S84>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product[1] =
     ...
     *  Sum: '<S85>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product_i[1] =
     ...
     *  Integrator: '<S85>/Integrator2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1_i[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.CoreSubsys_pn.AccelerometerFilterCutoffFreque
      * QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
      Integrator2_CSTATE_k[1];

    /* Integrator: '<S84>/Integrator1' */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Integrator1[2] =
      QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
     ...
     *  Integrator: '<S84>/Integrator2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.CoreSubsys_pn.GyroFilterCutoffFrequencyrads_V
      * QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
     ...
     *  Sum: '<S84>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product[2] =
     ...
     *  Sum: '<S85>/Sum1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product_i[2] =
     ...
     *  Integrator: '<S85>/Integrator2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Product1_i[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.CoreSubsys_pn.AccelerometerFilterCutoffFreque
      * QD2_DroneStack_PID_FreqSwp_20_X.CoreSubsys_pn[ForEach_itr_a].
      Integrator2_CSTATE_k[2];
  ...
  for (i = 0; i < 9; i++) {
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.SelectDataforIMU0[i] = sigmoid;
  ...
  if (rtb_Compare_gx) {
    /* S-Function (euler_angles_to_rotation_matrix_block): '<S3>/Euler Angles to Rotation Matrix2' */
    {
      t_double sin_phi = sin(QD2_DroneStack_PID_FreqSwp_20_B.Integrator1);
      t_double cos_phi = cos(QD2_DroneStack_PID_FreqSwp_20_B.Integrator1);
      t_double sin_theta = sin(QD2_DroneStack_PID_FreqSwp_20_B.Reshape[1]);
      t_double cos_theta = cos(QD2_DroneStack_PID_FreqSwp_20_B.Reshape[1]);
      t_double sin_psi = sin(QD2_DroneStack_PID_FreqSwp_20_B.Reshape[0]);
      t_double cos_psi = cos(QD2_DroneStack_PID_FreqSwp_20_B.Reshape[0]);
      rtb_BFToIFrotationmatrix[0] = cos_phi * cos_theta;
      rtb_BFToIFrotationmatrix[1] = sin_phi * cos_theta;
      rtb_BFToIFrotationmatrix[2] = -sin_theta;
      rtb_BFToIFrotationmatrix[3] = -sin_phi * cos_psi + cos_phi * sin_theta *
    ...
    for (i = 0; i < 6; i++) {
       ...
       *  Sum: '<S5>/Sum1'
       */
      QD2_DroneStack_PID_FreqSwp_20_B.Product4[i] =
        (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[i + 6] +
         QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[i]) /
        QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_k;
    }
   ...
   *  Integrator: '<S1>/Integrator1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[0] =
    (QD2_DroneStack_PID_FreqSwp_20_B.Gain[0] +
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0]) -
    QD2_DroneStack_PID_FreqSwp_20_P.KdradmsradmsNmsradsrads_Gain[0] *
    QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[0] *
    QD2_DroneStack_PID_FreqSwp_20_P.Gain2_Gain[0];
  QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[1] =
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[1] *
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[2] =
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[2] *
    QD2_DroneStack_PID_FreqSwp_20_P.Gain2_Gain[2];
  QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[3] =
    (QD2_DroneStack_PID_FreqSwp_20_B.Gain[3] +
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3]) -
    QD2_DroneStack_PID_FreqSwp_20_B.Product1[2] *
    QD2_DroneStack_PID_FreqSwp_20_P.KdradmsradmsNmsradsrads_Gain[3] *
    QD2_DroneStack_PID_FreqSwp_20_P.Gain2_Gain[3];

  /* Integrator: '<S39>/Integrator1' */
  if (QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[0];
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[1];
  }

  /* Integrator: '<S39>/Integrator1' */
  QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[0] =
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0];
  QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[1] =
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1];

  /* Saturate: '<S1>/Saturate Stabilization Command' incorporates:
   *  Integrator: '<S39>/Integrator1'
   */
  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[0]) {
    Duty_Cycle[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[0];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[0])
  {
    Duty_Cycle[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[0];
  } else {
    Duty_Cycle[0] = QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0];
  }

  /* Product: '<S1>/ ' */
  QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[0] = 0.0;

  /* Saturate: '<S1>/Saturate Stabilization Command' incorporates:
   *  Integrator: '<S39>/Integrator1'
   */
  if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[1]) {
    Duty_Cycle[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[1];
  } else if (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[1])
  {
    Duty_Cycle[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[1];
  } else {
    Duty_Cycle[1] = QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1];
  }

  /* Product: '<S1>/ ' */
  QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[1] = 0.0;

  /* Saturate: '<S1>/Saturate Stabilization Command' */
  if (QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[2] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[2]) {
    Duty_Cycle[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[2];
  } else if (QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[2] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[2])
  {
    Duty_Cycle[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[2];
  } else {
  ...
  /* Product: '<S1>/ ' */
  QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[2] = 0.0;

  /* Saturate: '<S1>/Saturate Stabilization Command' */
  if (QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[3] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[3]) {
    Duty_Cycle[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Up[3];
  } else if (QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[3] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[3])
  {
    Duty_Cycle[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand_Lo[3];
  } else {
  ...
  if (QD2_DroneStack_PID_FreqSwp_2_DW.LastMajorTime == (rtInf)) {
    /* RateLimiter: '<S13>/Rate Limiter (N//s)' */
    QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs =
      QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[0];
  } else {
    rtb_DataTypeConversion3 = QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[0];
    sigmoid = rtb_DataTypeConversion3 -
      QD2_DroneStack_PID_FreqSwp_2_DW.LastMajorTime;
    if (QD2_DroneStack_PID_FreqSwp_2_DW.LastMajorTime == rtb_DataTypeConversion3)
    {
      if (QD2_DroneStack_PID_FreqSwp_2_DW.PrevLimited) {
        /* RateLimiter: '<S13>/Rate Limiter (N//s)' */
        QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs =
      ...
      if (rtb_DataTypeConversion3 > data_loss) {
        /* RateLimiter: '<S13>/Rate Limiter (N//s)' */
        QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs =
          QD2_DroneStack_PID_FreqSwp_2_DW.PrevY + data_loss;
        rtb_Relation_k = true;
      } else {
        sigmoid *= QD2_DroneStack_PID_FreqSwp_20_P.RateLimiterNs_FallingLim;
        if (rtb_DataTypeConversion3 < sigmoid) {
          /* RateLimiter: '<S13>/Rate Limiter (N//s)' */
          QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs =
            QD2_DroneStack_PID_FreqSwp_2_DW.PrevY + sigmoid;
          rtb_Relation_k = true;
        } else {
          /* RateLimiter: '<S13>/Rate Limiter (N//s)' */
          QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs =
            QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[0];
          rtb_Relation_k = false;
        }
      }

      if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo))
      {
        QD2_DroneStack_PID_FreqSwp_2_DW.PrevLimited = rtb_Relation_k;
      }
    }
  }
  ...
  switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.Memory) {
   case 1:
    sigmoid = QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value;
    break;
   ...
   case 6:
    sigmoid = QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs;
    break;
  ...
  if (rtb_Compare_gx) {
    ...
    /* Switch: '<S7>/Switch' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.SpecifyAngleModeforStabilizerDO >
        QD2_DroneStack_PID_FreqSwp_20_P.Switch_Threshold_l) {
      /* Switch: '<S7>/Switch' incorporates:
       *  Constant: '<Root>/zero reference torque commands'
       */
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.zeroreferencetorquecommands_Val[0];
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.zeroreferencetorquecommands_Val[1];
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.zeroreferencetorquecommands_Val[2];
    } else {
      /* Switch: '<S7>/Switch' incorporates:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.ZeroTorqueCommand_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[2] =
     ...
     */
    rtb_Relation_e = ((QD2_DroneStack_PID_FreqSwp_20_B.Memory ==
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_k = rtb_Relation_e;
  }
  ...
  if (rtb_Integrator7_idx_0 >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__o[0]) {
    /* Saturate: '<S7>/Saturate Stabilization Command' */
    rtb_Integrator7_idx_0 =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__o[0];
  } else if (rtb_Integrator7_idx_0 <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__g[0])
  {
    /* Saturate: '<S7>/Saturate Stabilization Command' */
    rtb_Integrator7_idx_0 =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__g[0];
  ...
  /* Saturate: '<S7>/Saturate Stabilization Command' */
  QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[0] =
    rtb_Integrator7_idx_0;
   ...
   *  Sum: '<S7>/Sum'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Sum1[0] = (rtb_Integrator7_idx_0 -
    QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain[0] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[0]) *
    QD2_DroneStack_PID_FreqSwp_20_P.K_p_angleradsrad_Gain[0] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale_Gain[0] -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_angleradsrads_Gain[0] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[3] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale1_Gain[0];
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Sum6[0] = ((rtb_Integrator7_idx_0 -
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[0]) -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_speedNmradss1_Gain[0] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[6] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale4_Gain[0];

  /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
  if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[0] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[0]) {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[0];
  } else if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[0] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[0])
  {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[0];
    ...
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[0];
  }

  /* Saturate: '<S7>/Saturate Stabilization Command' */
  if (data_loss >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__o[1]) {
    /* Saturate: '<S7>/Saturate Stabilization Command' */
    rtb_Integrator7_idx_0 =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__o[1];
  } else if (data_loss <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__g[1])
  {
    /* Saturate: '<S7>/Saturate Stabilization Command' */
    rtb_Integrator7_idx_0 =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturateStabilizationCommand__g[1];
    ...
    /* Saturate: '<S7>/Saturate Stabilization Command' */
    rtb_Integrator7_idx_0 = data_loss;
  }

  /* Saturate: '<S7>/Saturate Stabilization Command' */
  QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[1] =
    rtb_Integrator7_idx_0;
   ...
   *  Sum: '<S7>/Sum'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Sum1[1] = (rtb_Integrator7_idx_0 -
    QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain[1] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[1]) *
    QD2_DroneStack_PID_FreqSwp_20_P.K_p_angleradsrad_Gain[1] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale_Gain[1] -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_angleradsrads_Gain[1] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[4] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale1_Gain[1];
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Sum6[1] = ((rtb_Integrator7_idx_0 -
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[1]) -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_speedNmradss1_Gain[1] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[7] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale4_Gain[1];

  /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
  if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[1] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[1]) {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[1];
  } else if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[1] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[1])
  {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[1];
    ...
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[1];
  }
  ...
  /* Saturate: '<S7>/Saturate Stabilization Command' */
  QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[2] =
    rtb_Integrator7_idx_0;
   ...
   *  Sum: '<S7>/Sum'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Sum1[2] = (rtb_Integrator7_idx_0 -
    QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain[2] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[2]) *
    QD2_DroneStack_PID_FreqSwp_20_P.K_p_angleradsrad_Gain[2] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale_Gain[2] -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_angleradsrads_Gain[2] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[5] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale1_Gain[2];
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Sum6[2] = ((rtb_Integrator7_idx_0 -
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[2]) -
    QD2_DroneStack_PID_FreqSwp_20_P.K_d_speedNmradss1_Gain[2] *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[8] *
    QD2_DroneStack_PID_FreqSwp_20_P.Scale4_Gain[2];

  /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
  if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[2] >
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[2]) {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_U[2];
  } else if (QD2_DroneStack_PID_FreqSwp_20_B.Sum6[2] <
             QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[2])
  {
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.SaturationCommandAuthorityNm1_L[2];
    ...
    /* Saturate: '<S7>/Saturation Command  Authority (Nm)1' */
    QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[2];
  }
  ...
  /* Clock: '<S7>/Clock' */
  QD2_DroneStack_PID_FreqSwp_20_B.SimTimes = rtb_Integrator7_idx_0;
  ...
  if (rtb_Compare_gx) {
     ...
     */
    rtb_rads = QD2_DroneStack_PID_FreqSwp_20_P.Gain2_Gain_c *
      QD2_DroneStack_PID_FreqSwp_20_P.StartFreq_Value;

    /* Gain: '<S7>/Gain3' incorporates:
     *  Constant: '<S7>/End Freq'
     */
    rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_P.Gain3_Gain *
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_l = QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    /* '<S48>:1:9' */
    data_loss = 0.0;
    if (QD2_DroneStack_PID_FreqSwp_20_B.Clock1 > 3.0) {
      /* '<S48>:1:10' */
      if ((QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o1 != 2) &&
          (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o2 < 0)) {
        /* '<S48>:1:11' */
        /* '<S48>:1:13' */
        rtb_DataTypeConversion3 = 1.0;
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[15] ==
           QD2_DroneStack_PID_FreqSwp_2_DW.ms_time_prev) &&
          (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[15] > 0.0)) {
        /* '<S48>:1:16' */
        /* '<S48>:1:18' */
        data_loss = 1.0;
      }
    ...
    /* '<S48>:1:22' */
    QD2_DroneStack_PID_FreqSwp_2_DW.ms_time_prev =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[15];
     ...
     */
    rtb_Relation_e = (rtb_DataTypeConversion3 >=
                      QD2_DroneStack_PID_FreqSwp_20_P.Threshold1_threshold);

    /* Logic: '<S49>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator = !rtb_Relation_e;

    /* DiscreteIntegrator: '<S49>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRese != 0))
    {
     ...
     */
    rtb_Relation = (data_loss >=
                    QD2_DroneStack_PID_FreqSwp_20_P.Threshold2_threshold);

    /* Logic: '<S50>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_f = !rtb_Relation;

    /* DiscreteIntegrator: '<S50>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_f ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_g != 0))
    {
    ...
    rtb_Relation_mo = (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[4] != 0.0);

    /* Logic: '<S10>/Logical Operator3' incorporates:
     *  DataTypeConversion: '<S10>/Data Type Conversion1'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator3 =
      !(QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[4] != 0.0);
   ...
   */
  rtb_Compare_k = (rtb_DataTypeConversion3 <=
   ...
   */
  rtb_Relation_k = ((QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator3 &&
                     (rtb_DataTypeConversion3 >
                      QD2_DroneStack_PID_FreqSwp_20_P.CompareToConstant2_const_l)
                     && (QD2_DroneStack_PID_FreqSwp_20_B.UnitDelay != 0.0)) >=
                    QD2_DroneStack_PID_FreqSwp_20_P.Threshold_threshold);

  /* Logic: '<S21>/Logical Operator' */
  QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_a = !rtb_Relation_k;

  /* Abs: '<S22>/Abs' incorporates:
   *  Sum: '<S22>/Subtract'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Abs = fabs
    (QD2_DroneStack_PID_FreqSwp_20_B.NetThrottle -
     QD2_DroneStack_PID_FreqSwp_20_B.Product);
  if (rtb_Compare_gx) {
    /* DiscreteIntegrator: '<S21>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_a ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_d != 0))
    {
     ...
     */
    rtb_Relation_mo = ((QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[0] >
    ...
    rtb_DataTypeConversion3 = rtb_Relation_mo;

    /* RelationalOperator: '<S96>/Relation' incorporates:
     *  Constant: '<S77>/Constant'
     */
    rtb_OR1 = (rtb_DataTypeConversion3 >=
               QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_i);

    /* Logic: '<S96>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_h = !rtb_OR1;

    /* DiscreteIntegrator: '<S96>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_h ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_o != 0))
    {
    ...
    if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
      if (rtb_RelationalOperator &&
          (QD2_DroneStack_PID_Freq_PrevZCX.TriggeredSubsystemLatchingFlag_ !=
           POS_ZCSIG)) {
        ...
        QD2_DroneStack_PID_FreqSwp_2_DW.TriggeredSubsystemLatchingFlag_ = 4;
      }
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4_fx =
      (QD2_DroneStack_PID_FreqSwp_20_B.OutportBufferForOut1 != 0.0);
    ...
    /* S-Function (compare_block): '<S22>/Compare' */
    {
      QD2_DroneStack_PID_FreqSwp_20_B.Compare_c =
        (QD2_DroneStack_PID_FreqSwp_20_B.Abs <= rtb_Product1);
    }
    ...
    /* S-Function (compare_block): '<S22>/Compare1' */
    {
      QD2_DroneStack_PID_FreqSwp_20_B.Compare1 =
        (QD2_DroneStack_PID_FreqSwp_20_B.NetThrottle <= rtb_Product);
    }
  }

  /* Abs: '<S22>/Abs1' */
  QD2_DroneStack_PID_FreqSwp_20_B.Abs1 = fabs(sigmoid);
  if (rtb_Compare_gx) {
    ...
    /* S-Function (compare_block): '<S22>/Compare2' */
    {
      QD2_DroneStack_PID_FreqSwp_20_B.Compare2 =
        (QD2_DroneStack_PID_FreqSwp_20_B.Abs1 <= rtb_Product2);
    }

    /* Sum: '<S19>/Subtract' */
    rtb_DataTypeConversion3 = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2] -
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7];
     ...
     */
    rtb_Relation_mo = (rtb_DataTypeConversion3 <=
                       QD2_DroneStack_PID_FreqSwp_20_P.Thresholdtodetectifthedroneiscl);

    /* Sum: '<S19>/Subtract1' */
    rtb_DataTypeConversion3 = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2] -
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[13];
    ...
    /* Sum: '<S19>/Subtract2' */
    rtb_Subtract2 = QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2] -
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7];

    /* RelationalOperator: '<S31>/Compare' incorporates:
     *  Constant: '<S31>/Constant'
     */
    rtb_Relation_kg = (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7] <=
     ...
     *  Sum: '<S19>/Subtract2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator2 = (((rtb_Subtract2 >=
      QD2_DroneStack_PID_FreqSwp_20_P.Ifthemeasuredheightismorethan02) &&
      rtb_Relation_kg && (QD2_DroneStack_PID_FreqSwp_20_B.Memory ==
                          QD2_DroneStack_PID_FreqSwp_20_P.FlightState_const)) ||
      (rtb_Relation_kg && (rtb_Subtract2 >= rtb_u5ofCommandedHeight) &&
       (QD2_DroneStack_PID_FreqSwp_20_B.Memory ==
     ...
     */
    rtb_Relation_kg = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[0] ==
                       QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S98>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_b = !rtb_Relation_kg;

    /* DiscreteIntegrator: '<S98>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_b ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_p != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_mo = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[1] ==
                       QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S99>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_az = !rtb_Relation_mo;

    /* DiscreteIntegrator: '<S99>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_az ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_gh != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_f = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[2] ==
                      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S102>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bu = !rtb_Relation_f;

    /* DiscreteIntegrator: '<S102>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bu ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oz != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_cv = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[3] ==
                       QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S103>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_mf = !rtb_Relation_cv;

    /* DiscreteIntegrator: '<S103>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_mf ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oi != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_ol = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[4] ==
                       QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S104>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_l = !rtb_Relation_ol;

    /* DiscreteIntegrator: '<S104>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_l ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_e != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_h = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[5] ==
                      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S105>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_l3 = !rtb_Relation_h;

    /* DiscreteIntegrator: '<S105>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_l3 ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_n != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_a = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[6] ==
                      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S106>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_o = !rtb_Relation_a;

    /* DiscreteIntegrator: '<S106>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_o ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_p5 != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_n = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[7] ==
                      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S107>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_ms = !rtb_Relation_n;

    /* DiscreteIntegrator: '<S107>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_ms ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_dl != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_p = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[8] ==
                      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S108>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_og = !rtb_Relation_p;

    /* DiscreteIntegrator: '<S108>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_og ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_nn != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_AND3 = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[9] ==
                QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S109>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_on = !rtb_AND3;

    /* DiscreteIntegrator: '<S109>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_on ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_eu != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_DataTypeConversion3_k = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[10] ==
      QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S100>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_lm =
      !rtb_DataTypeConversion3_k;

    /* DiscreteIntegrator: '<S100>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_lm ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_gx != 0))
    {
     ...
     *  Constant: '<S79>/Constant2'
     */
    rtb_Relation_js = (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[11] ==
                       QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_d);

    /* Logic: '<S101>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_i = !rtb_Relation_js;

    /* DiscreteIntegrator: '<S101>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_i ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_f != 0))
    {
     ...
     *  S-Function (time_block): '<S5>/Time'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.OR = (((rtb_Time >=
      ...
      ((QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTATE_o >=
       ...
       (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTATE_a >=
        QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_p))) ||
      (QD2_DroneStack_PID_FreqSwp_20_B.esc_timeout != 0.0));
  }

  /* MATLAB Function: '<S1>/STATE MACHINE LOGIC' */
  QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_cx = QD2_DroneStack_PID_F_CALL_EVENT;
  ...
  /* '<S9>:1:50' */
  pt_ARM_to_TAKEOFF_THROTTLE = false;

  /* '<S9>:1:51' */
  pt_TAKEOFF_THROTTLE_TO_TAKEOFF_ = false;

  /* '<S9>:1:52' */
  pt_TAKE_OFF_HEIGHT_TO_AUTOLAND = false;

  /* '<S9>:1:53' */
  pt_TAKE_OFF_HEIGHT_TO_FLIGHT = false;

  /* '<S9>:1:54' */
  pt_FLIGHT_TO_AUTOLAND = false;

  /* '<S9>:1:55' */
  pt_AUTOLAND_TO_DISABLE = false;

  /* '<S9>:1:56' */
  pt_EMERGENCY_STOP_TO_DISABLE = false;
   ...
   */
  /* '<S9>:1:58' */
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion3 = 0.0;

  /* MATLAB Function: '<S1>/STATE MACHINE LOGIC' */
  switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.Memory) {
   case 1:
    if ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) ||
        QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3] ||
        QD2_DroneStack_PID_FreqSwp_20_B.RelationalOperator_g ||
        QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4_fx ||
        QD2_DroneStack_PID_FreqSwp_20_B.OR ||
        (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22 && rtb_Compare_k) ||
        QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23 ||
        !QD2_DroneStack_PID_FreqSwp_20_B.Compare2) {
      /* '<S9>:1:64' */
      /* '<S9>:1:65' */
      ...
      /* '<S9>:1:72' */
      sigmoid = 1.0;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22) {
      /* '<S9>:1:73' */
      /* '<S9>:1:74' */
   ...
   case 2:
    ...
    if ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) ||
      ...
      /* '<S9>:1:87' */
      /* '<S9>:1:88' */
      pt_ARM_to_TAKEOFF_THROTTLE = true;
    }
    break;
   ...
   case 3:
    if ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) ||
      ...
      /* '<S9>:1:101' */
      sigmoid = 1.0;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.Compare_c) {
      /* '<S9>:1:102' */
      /* '<S9>:1:103' */
      pt_TAKEOFF_THROTTLE_TO_TAKEOFF_ = true;
    }
    break;
   ...
   case 4:
    if ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) ||
      ...
      /* '<S9>:1:115' */
      sigmoid = 1.0;
    } else if (!QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23 ||
               QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4_fx) {
      /* '<S9>:1:116' */
      /* '<S9>:1:117' */
      pt_TAKE_OFF_HEIGHT_TO_AUTOLAND = true;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_m) {
      /* '<S9>:1:118' */
      /* '<S9>:1:119' */
      pt_TAKE_OFF_HEIGHT_TO_FLIGHT = true;
    }
    break;
   ...
   case 6:
    if ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) ||
      ...
      /* '<S9>:1:144' */
      sigmoid = 1.0;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator3_e) {
      /* '<S9>:1:145' */
      /* '<S9>:1:146' */
      pt_AUTOLAND_TO_DISABLE = true;
    }
    break;

   case 7:
    if (QD2_DroneStack_PID_FreqSwp_20_B.Compare1) {
      /* '<S9>:1:150' */
      /* '<S9>:1:151' */
      pt_EMERGENCY_STOP_TO_DISABLE = true;
    }
    break;
   ...
   case 9:
    ...
    /* '<S9>:1:159' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion3 = 1.0;
    break;
  }
  ...
  if (rtb_Compare_gx) {
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Compare_b =
      (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[4] ==
   ...
   */
  QD2_DroneStack_PID_FreqSwp_20_B.SafeFlightTrueFalse =
    (QD2_DroneStack_PID_FreqSwp_20_B.Compare_g &&
     QD2_DroneStack_PID_FreqSwp_20_B.Compare_h &&
     QD2_DroneStack_PID_FreqSwp_20_B.Compare_n &&
     QD2_DroneStack_PID_FreqSwp_20_B.Compare_a &&
  ...
  if (rtb_Compare_gx) {
    ...
    /* MATLAB Function 'STABILIZER - QDRONE 2/MATLAB Function': '<S117>:1' */
    /* '<S117>:1:14' */
    QD2_DroneStack_PID_FreqSwp_20_B.SwpSignal = 0.0;

    /* '<S117>:1:14' */
    QD2_DroneStack_PID_FreqSwp_20_B.activeswp = 0.0;

    /* '<S117>:1:14' */
    QD2_DroneStack_PID_FreqSwp_20_B.AngularFrq = 0.0;

    /* '<S117>:1:16' */
    if (!(QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[16] > 0.5)) {
      /* '<S117>:1:19' */
      /* '<S117>:1:20' */
      QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest = false;

      /* '<S117>:1:21' */
      QD2_DroneStack_PID_FreqSwp_2_DW.aborted = false;
    } else if (!((real_T)QD2_DroneStack_PID_FreqSwp_20_B.SafeFlightTrueFalse >
                 0.5)) {
      /* '<S117>:1:26' */
      /* '<S117>:1:27' */
      QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest = true;

      /* '<S117>:1:28' */
      QD2_DroneStack_PID_FreqSwp_2_DW.aborted = true;
    } else {
      if (!QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest) {
        /* '<S117>:1:33' */
        /* '<S117>:1:34' */
        QD2_DroneStack_PID_FreqSwp_2_DW.tStart =
          QD2_DroneStack_PID_FreqSwp_20_B.SimTimes;
      }

      /* '<S117>:1:37' */
      QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest = true;
      if (!QD2_DroneStack_PID_FreqSwp_2_DW.aborted) {
        /* '<S117>:1:45' */
        rtb_DataTypeConversion3 = QD2_DroneStack_PID_FreqSwp_20_B.SimTimes -
          QD2_DroneStack_PID_FreqSwp_2_DW.tStart;
        if ((rtb_DataTypeConversion3 >= 0.0) && (rtb_DataTypeConversion3 <=
             QD2_DroneStack_PID_FreqSwp_20_P.Duration_Value) &&
            (QD2_DroneStack_PID_FreqSwp_20_P.Duration_Value > 0.0) && (rtb_rads >
             0.0) && (rtb_rads_b > 0.0)) {
          /* '<S117>:1:49' */
          /* '<S117>:1:50' */
          /* '<S117>:1:55' */
          rtb_rads_b = log(rtb_rads_b / rtb_rads) /
            QD2_DroneStack_PID_FreqSwp_20_P.Duration_Value;
          if (fabs(rtb_rads_b) < 1.0E-9) {
            /* '<S117>:1:57' */
            /* '<S117>:1:58' */
            QD2_DroneStack_PID_FreqSwp_20_B.AngularFrq = rtb_rads;

            /* '<S117>:1:59' */
            rtb_rads *= rtb_DataTypeConversion3;
          } else {
            /* '<S117>:1:61' */
            data_loss = exp(rtb_rads_b * rtb_DataTypeConversion3);

            /* '<S117>:1:62' */
            QD2_DroneStack_PID_FreqSwp_20_B.AngularFrq = rtb_rads * data_loss;

            /* '<S117>:1:63' */
            rtb_rads = rtb_rads / rtb_rads_b * (data_loss - 1.0);
          }

          /* '<S117>:1:68' */
          rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_P.Duration_Value / 2.0;
          if ((QD2_DroneStack_PID_FreqSwp_20_P.RampDuration_Value <= rtb_rads_b)
              || rtIsNaN(rtb_rads_b)) {
            rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_P.RampDuration_Value;
          }

          if ((rtb_rads_b <= 0.0) || rtIsNaN(rtb_rads_b)) {
            rtb_rads_b = 0.0;
          }
          ...
          if (rtb_rads_b > 0.0) {
            /* '<S117>:1:71' */
            if (rtb_DataTypeConversion3 < rtb_rads_b) {
              /* '<S117>:1:72' */
              /* '<S117>:1:73' */
          ...
          /* '<S117>:1:80' */
          QD2_DroneStack_PID_FreqSwp_20_B.SwpSignal =
            QD2_DroneStack_PID_FreqSwp_20_P.Amplitude_Value * data_loss * sin
            (rtb_rads);

          /* '<S117>:1:81' */
          QD2_DroneStack_PID_FreqSwp_20_B.activeswp = 1.0;
        }
      } else {
        /* '<S117>:1:40' */
      }
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Delay =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE[0];
  }
   ...
   */
  QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_n = QD2_DroneStack_PID_F_CALL_EVENT;

  /* MATLAB Function 'QDrone 2 DAQ/Force to percentage Mapping': '<S74>:1' */
  /* '<S74>:1:3' */
  rtb_rads = QD2_DroneStack_PID_FreqSwp_20_P.KT[1] *
    QD2_DroneStack_PID_FreqSwp_20_P.KT[1];
  rtb_rads_b = 4.0 * QD2_DroneStack_PID_FreqSwp_20_P.KT[0];
   ...
   */
  for (i = 0; i < 4; i++) {
    Duty_Cycle_0 = rtb_rads - (rtb_DataTypeConversion3 -
  ...
  if (rtb_Compare_gx) {
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_nd = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'QDrone 2 DAQ/Choose Motor Telemetry/MATLAB Function': '<S86>:1' */
    /* '<S86>:1:11' */
    rtb_rads = QD2_DroneStack_PID_FreqSwp_2_DW.state;
    if (QD2_DroneStack_PID_FreqSwp_20_B.tele_enable != 0.0) {
      /* '<S86>:1:15' */
      QD2_DroneStack_PID_FreqSwp_2_DW.state++;
      if (QD2_DroneStack_PID_FreqSwp_2_DW.state >=
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Selector[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_c[(int32_T)rtb_rads];
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Selector[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_c[(int32_T)rtb_rads + 8];
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Selector[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_c[(int32_T)rtb_rads + 16];
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Selector[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_c[(int32_T)rtb_rads + 24];
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/ESC Output (esc_output_block) */
    {
      t_double saturated_input;
      t_uint16 throttle;
      t_uint16 checksum;
      saturated_input = QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority
        [0];
      ...
      throttle = (throttle << 1) | (QD2_DroneStack_PID_FreqSwp_20_B.Selector[0]
        != 0);
      ...
      throttle = (throttle << 1) | (QD2_DroneStack_PID_FreqSwp_20_B.Selector[1]
        != 0);
      checksum = throttle ^ (throttle >> 4) ^ (throttle >> 8);
      ...
      throttle = (throttle << 1) | (QD2_DroneStack_PID_FreqSwp_20_B.Selector[2]
        != 0);
      checksum = throttle ^ (throttle >> 4) ^ (throttle >> 8);
      ...
      throttle = (throttle << 1) | (QD2_DroneStack_PID_FreqSwp_20_B.Selector[3]
        != 0);
      checksum = throttle ^ (throttle >> 4) ^ (throttle >> 8);
     ...
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.cmd_enable > 0.0) {
      /* S-Function (hil_write_pwm_block): '<S73>/HIL Write PWM' */

      /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Enabled Subsystem -  Write ESC Commands/HIL Write PWM (hil_write_pwm_block) */
      {
        t_error result;
        result = hil_write_pwm
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILWritePWM_channels, 4,
           &rtb_ESCOutput[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
     ...
     */
    switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion) {
     case 0:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.YellowYellow_Value[i];
      }
      break;
     ...
     case 1:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.YellowGreen_Value[i];
      }
      break;
     ...
     case 2:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.BlueBlue_Value[i];
      }
      break;
     ...
     case 3:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.YellowRed_Value[i];
      }
      break;
     ...
     case 4:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.RedYellow_Value[i];
      }
      break;
     ...
     case 5:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.GreenGreen_Value[i];
      }
      break;
     ...
     case 77:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] =
          QD2_DroneStack_PID_FreqSwp_20_P.YellowBlue_Value[i];
      }
      break;

     case 88:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] = QD2_DroneStack_PID_FreqSwp_20_P.RedBlue_Value[i];
      }
      break;

     case 99:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] = QD2_DroneStack_PID_FreqSwp_20_P.RedRed_Value[i];
      }
      break;

     default:
      for (i = 0; i < 6; i++) {
        rtb_MultiportSwitch[i] = QD2_DroneStack_PID_FreqSwp_20_P.LEDOFF_Value[i];
      }
      break;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/HIL Write Digital (hil_write_digital_block) */
    {
      t_error result;

      {
        ...
        t_boolean *dw_Buffer =
          &QD2_DroneStack_PID_FreqSwp_2_DW.HILWriteDigital_Buffer[0];
        for (i1=0; i1 < 6; i1++) {
      ...
      result = hil_write_digital
        (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
         QD2_DroneStack_PID_FreqSwp_20_P.HILWriteDigital_channels, 6,
         &QD2_DroneStack_PID_FreqSwp_2_DW.HILWriteDigital_Buffer[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
    ...
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_3) {
      /* RateTransition: '<S5>/Rate Transition7' */
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition7[0] =
        QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition7_Buffer0[0];
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition7[1] =
        QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition7_Buffer0[1];
    }
     ...
     */
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_4) {
    ...
    rtb_rads = QD2_DroneStack_PID_FreqSwp_20_P.Multiplebyresolutionsupposedtob *
      rtb_DataTypeConversion3;
    ...
    switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[21]) {
     case 0:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor0_Value[0];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor0_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor0_Value[2];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor0_Value[3];
      break;
     ...
     case 1:
       ...
       */
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor1_Value[0];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor1_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor1_Value[2];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor1_Value[3];
      break;
     ...
     case 2:
       ...
       */
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor2_Value[0];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor2_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor2_Value[2];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor2_Value[3];
      break;
     ...
     case 3:
       ...
       */
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor3_Value[0];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor3_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor3_Value[2];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Motor3_Value[3];
      break;
     ...
     default:
       ...
       */
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Noselection_Value[0];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Noselection_Value[1];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] =
        QD2_DroneStack_PID_FreqSwp_20_P.Noselection_Value[2];
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] =
        QD2_DroneStack_PID_FreqSwp_20_P.Noselection_Value[3];
      break;
    }
    ...
    /* Product: '<S5>/Product' */
    rtb_Product_g[3] = rtb_rads *
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3];

    /* Memory: '<S67>/Memory' */
    rtb_Memory_e[3] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[3];

    /* Outputs for Iterator SubSystem: '<S67>/For Each Subsystem -  Construct ESC Signal' */
    ForEachSubsystemConstructES(4, rtb_Product_g,
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[21], rtb_Memory_e,
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOu_kc);

    /* End of Outputs for SubSystem: '<S67>/For Each Subsystem -  Construct ESC Signal' */

    /* Saturate: '<S5>/Saturation' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[20] >
        QD2_DroneStack_PID_FreqSwp_20_P.Saturation_UpperSat_h) {
      rtb_DataTypeConversion3 =
        QD2_DroneStack_PID_FreqSwp_20_P.Saturation_UpperSat_h;
    } else if (QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[20] <
               QD2_DroneStack_PID_FreqSwp_20_P.Saturation_LowerSat_d) {
      rtb_DataTypeConversion3 =
        QD2_DroneStack_PID_FreqSwp_20_P.Saturation_LowerSat_d;
    } else {
      rtb_DataTypeConversion3 = QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[20];
    }

    /* End of Saturate: '<S5>/Saturation' */

    /* Product: '<S5>/Product1' */
    rtb_Product1_m[0] = rtb_DataTypeConversion3 *
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0];

    /* Memory: '<S69>/Memory' */
    rtb_Memory_i[0] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[0];

    /* Product: '<S5>/Product1' */
    rtb_Product1_m[1] = rtb_DataTypeConversion3 *
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1];

    /* Memory: '<S69>/Memory' */
    rtb_Memory_i[1] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[1];

    /* Product: '<S5>/Product1' */
    rtb_Product1_m[2] = rtb_DataTypeConversion3 *
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2];

    /* Memory: '<S69>/Memory' */
    rtb_Memory_i[2] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[2];

    /* Product: '<S5>/Product1' */
    rtb_Product1_m[3] = rtb_DataTypeConversion3 *
      QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3];

    /* Memory: '<S69>/Memory' */
    rtb_Memory_i[3] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[3];

    /* Outputs for Iterator SubSystem: '<S69>/For Each Subsystem -  Construct ESC Signal' */
    ForEachSubsystemConstructES(4, rtb_Product1_m,
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[21], rtb_Memory_i,
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Computation Time (computation_time_block) */
    {
      QD2_DroneStack_PID_FreqSwp_20_B.ComputationTime =
        QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime_ComputationTime.seconds
        + QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime_ComputationTime.nanoseconds
        * 1e-9;
    }

    /* S-Function (sample_time_block): '<S81>/Sample Time' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Sample Time (sample_time_block) */
    {
      t_error result;
      t_timeout current_time;
      t_timeout time_difference;
      ...
      if (result >= 0) {
        ...
        QD2_DroneStack_PID_FreqSwp_20_B.SampleTime = time_difference.seconds +
          time_difference.nanoseconds * 1e-9;
        memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.SampleTime_PreviousTime,
    ...
    /* RateTransition: '<S5>/Rate Transition6' */
    memcpy(&QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[0],
           &QD2_DroneStack_PID_FreqSwp_20_B.SelectDataforIMU0[0], 9U * sizeof
           (real_T));
    memcpy(&QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[9],
           &QD2_DroneStack_PID_FreqSwp_20_B.SelectDataforIMU1[0], 9U * sizeof
           (real_T));
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[18] =
      QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[0];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[19] =
      QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[1];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[20] =
      QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[2];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[21] =
      QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[3];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[22] =
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[23] =
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[1];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[24] =
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[2];
    memcpy(&QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[25],
           &QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[0], 12U * sizeof(real_T));
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[37] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition7[0];
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[38] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition7[1];
    for (i = 0; i < 7; i++) {
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[i + 39] =
        QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[i + 12];
    }

    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[46] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition2;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[47] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition1;
    ...
    /* RateTransition: '<S5>/Rate Transition6' */
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[52] =
      QD2_DroneStack_PID_FreqSwp_20_B.ComputationTime;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[53] =
      QD2_DroneStack_PID_FreqSwp_20_B.SampleTime;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[54] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[55] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition1_n;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[56] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition2_m;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[57] =
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition3;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[58] =
      QD2_DroneStack_PID_FreqSwp_20_B.esc_ready;
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition6[59] =
      QD2_DroneStack_PID_FreqSwp_20_B.esc_timeout;
     ...
     */
    QD2_DroneStack_PID_FreqSwp_20_B.Bias1[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_d *
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[0] +
      QD2_DroneStack_PID_FreqSwp_20_P.Bias1_Bias[0];
    QD2_DroneStack_PID_FreqSwp_20_B.Bias1[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_d *
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[1] +
      QD2_DroneStack_PID_FreqSwp_20_P.Bias1_Bias[1];
    QD2_DroneStack_PID_FreqSwp_20_B.Bias1[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_d *
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[2] +
      QD2_DroneStack_PID_FreqSwp_20_P.Bias1_Bias[2];
    QD2_DroneStack_PID_FreqSwp_20_B.Bias1[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_d *
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[3] +
      QD2_DroneStack_PID_FreqSwp_20_P.Bias1_Bias[3];

    /* Product: '<S5>/Product2' */
    rtb_Product2_h[0] = QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[0] *
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[22];

    /* Memory: '<S68>/Memory' */
    rtb_Memory_ic[0] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[0];

    /* Product: '<S5>/Product2' */
    rtb_Product2_h[1] = QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[1] *
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[22];

    /* Memory: '<S68>/Memory' */
    rtb_Memory_ic[1] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[1];

    /* Product: '<S5>/Product2' */
    rtb_Product2_h[2] = QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[2] *
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[22];

    /* Memory: '<S68>/Memory' */
    rtb_Memory_ic[2] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[2];

    /* Product: '<S5>/Product2' */
    rtb_Product2_h[3] = QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[3] *
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[22];

    /* Memory: '<S68>/Memory' */
    rtb_Memory_ic[3] = QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[3];

    /* Outputs for Iterator SubSystem: '<S68>/For Each Subsystem -  Construct ESC Signal' */
    ForEachSubsystemConstructES(4, rtb_Product2_h,
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[21], rtb_Memory_ic,
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.Delay3 =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay3_DSTATE[0];

    /* Delay: '<S70>/Delay2' */
    QD2_DroneStack_PID_FreqSwp_20_B.Delay2 =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay2_DSTATE[0];

    /* Delay: '<S70>/Delay1' */
    QD2_DroneStack_PID_FreqSwp_20_B.Delay1 =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay1_DSTATE[0];

    /* Delay: '<S70>/Delay' */
    QD2_DroneStack_PID_FreqSwp_20_B.Delay_n =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE_e[0];

    /* SignalConversion generated from: '<S70>/For Each Subsystem' */
    Duty_Cycle[0] = QD2_DroneStack_PID_FreqSwp_20_B.Delay3;
    Duty_Cycle[1] = QD2_DroneStack_PID_FreqSwp_20_B.Delay2;
    Duty_Cycle[2] = QD2_DroneStack_PID_FreqSwp_20_B.Delay1;
    Duty_Cycle[3] = QD2_DroneStack_PID_FreqSwp_20_B.Delay_n;
    ...
    for (ForEach_itr = 0; ForEach_itr < 4; ForEach_itr++) {
      ...
      rtb_ImpSel_InsertedFor_Channe_e =
        QD2_DroneStack_PID_FreqSwp_20_B.ExtractESCChannels[ForEach_itr];
    ...
    /* Logic: '<S70>/AND' */
    QD2_DroneStack_PID_FreqSwp_20_B.AND[0] = (rtb_ImpAsg_InsertedFor_mismatch[0]
      && (QD2_DroneStack_PID_FreqSwp_20_B.tele_enable != 0.0));
    QD2_DroneStack_PID_FreqSwp_20_B.AND[1] = (rtb_ImpAsg_InsertedFor_mismatch[1]
      && (QD2_DroneStack_PID_FreqSwp_20_B.tele_enable != 0.0));
    QD2_DroneStack_PID_FreqSwp_20_B.AND[2] = (rtb_ImpAsg_InsertedFor_mismatch[2]
      && (QD2_DroneStack_PID_FreqSwp_20_B.tele_enable != 0.0));
    QD2_DroneStack_PID_FreqSwp_20_B.AND[3] = (rtb_ImpAsg_InsertedFor_mismatch[3]
      && (QD2_DroneStack_PID_FreqSwp_20_B.tele_enable != 0.0));

    /* MATLAB Function: '<S70>/MATLAB Function' incorporates:
     *  Constant: '<S70>/Constant'
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_c = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'QDrone 2 DAQ/Detect ESC Problems/MATLAB Function': '<S92>:1' */
    if (!QD2_DroneStack_PID_FreqSwp_2_DW.buffer_not_empty) {
      /* '<S92>:1:9' */
      /* '<S92>:1:10' */
      i = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[0] *
        QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1];
      QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[0] = 4;
      QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] = (int32_T)
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_k;
      QD2_Dr_emxEnsureCapacity_real_T(QD2_DroneStack_PID_FreqSwp_2_DW.buffer, i);
      firstBlockLength = (int32_T)
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_k << 2;
      if (firstBlockLength - 1 >= 0) {
        memset(&QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[0], 0, (uint32_T)
               firstBlockLength * sizeof(real_T));
      }

      QD2_DroneStack_PID_FreqSwp_2_DW.buffer_not_empty =
        (QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] != 0);
    }

    /* '<S92>:1:17' */
    QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[((int32_T)
      QD2_DroneStack_PID_FreqSwp_2_DW.idx - 1) << 2] =
      QD2_DroneStack_PID_FreqSwp_20_B.AND[0];
    QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[(((int32_T)
      QD2_DroneStack_PID_FreqSwp_2_DW.idx - 1) << 2) + 1] =
      QD2_DroneStack_PID_FreqSwp_20_B.AND[1];
    QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[(((int32_T)
      QD2_DroneStack_PID_FreqSwp_2_DW.idx - 1) << 2) + 2] =
      QD2_DroneStack_PID_FreqSwp_20_B.AND[2];
    QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[(((int32_T)
      QD2_DroneStack_PID_FreqSwp_2_DW.idx - 1) << 2) + 3] =
      QD2_DroneStack_PID_FreqSwp_20_B.AND[3];

    /* '<S92>:1:19' */
    QD2_DroneStack_PID_FreqSwp_2_DW.idx++;
    if (QD2_DroneStack_PID_FreqSwp_2_DW.idx >
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_k) {
      /* '<S92>:1:20' */
      /* '<S92>:1:22' */
      QD2_DroneStack_PID_FreqSwp_2_DW.idx = 1.0;
    }

    /* '<S92>:1:26' */
    if (QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] == 0) {
      QD2_DroneStack_PID_FreqSwp_20_B.n[0] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_B.n[1] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_B.n[2] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_B.n[3] = 0.0;
    } else {
      if (QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] <= 1024) {
        firstBlockLength = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1];
        lastBlockLength = 0;
        i = 1;
      } else {
        firstBlockLength = 1024;
        i = (int32_T)((uint32_T)QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] >>
                      10);
        lastBlockLength = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->size[1] - (i <<
          10);
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.n[0] =
        QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[0];
      QD2_DroneStack_PID_FreqSwp_20_B.n[1] =
        QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[1];
      QD2_DroneStack_PID_FreqSwp_20_B.n[2] =
        QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[2];
      QD2_DroneStack_PID_FreqSwp_20_B.n[3] =
        QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[3];
      for (xblockoffset = 2; xblockoffset <= firstBlockLength; xblockoffset++) {
        xoffset = (xblockoffset - 1) << 2;
        QD2_DroneStack_PID_FreqSwp_20_B.n[0] +=
          QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset];
        QD2_DroneStack_PID_FreqSwp_20_B.n[1] +=
          QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset + 1];
        QD2_DroneStack_PID_FreqSwp_20_B.n[2] +=
          QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset + 2];
        QD2_DroneStack_PID_FreqSwp_20_B.n[3] +=
          QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset + 3];
      }

      for (firstBlockLength = 2; firstBlockLength <= i; firstBlockLength++) {
        xblockoffset = (firstBlockLength - 1) << 12;
        Duty_Cycle[0] = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->
          data[xblockoffset];
        Duty_Cycle[1] = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->
          data[xblockoffset + 1];
        Duty_Cycle[2] = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->
          data[xblockoffset + 2];
        Duty_Cycle[3] = QD2_DroneStack_PID_FreqSwp_2_DW.buffer->
          data[xblockoffset + 3];
        ...
        for (b_k = 2; b_k <= hi; b_k++) {
          ...
          Duty_Cycle[0] += QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset];
          Duty_Cycle[1] += QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset
            + 1];
          Duty_Cycle[2] += QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset
            + 2];
          Duty_Cycle[3] += QD2_DroneStack_PID_FreqSwp_2_DW.buffer->data[xoffset
            + 3];
        }

        QD2_DroneStack_PID_FreqSwp_20_B.n[0] += Duty_Cycle[0];
        QD2_DroneStack_PID_FreqSwp_20_B.n[1] += Duty_Cycle[1];
        QD2_DroneStack_PID_FreqSwp_20_B.n[2] += Duty_Cycle[2];
        QD2_DroneStack_PID_FreqSwp_20_B.n[3] += Duty_Cycle[3];
      }
    }
     ...
     */
    {
      t_double sin_phi = sin(QD2_DroneStack_PID_FreqSwp_20_P.ZeroYaw_Value);
      t_double cos_phi = cos(QD2_DroneStack_PID_FreqSwp_20_P.ZeroYaw_Value);
      t_double sin_theta = sin(QD2_DroneStack_PID_FreqSwp_20_B.Product3[1]);
      t_double cos_theta = cos(QD2_DroneStack_PID_FreqSwp_20_B.Product3[1]);
      t_double sin_psi = sin(QD2_DroneStack_PID_FreqSwp_20_B.Product3[0]);
      t_double cos_psi = cos(QD2_DroneStack_PID_FreqSwp_20_B.Product3[0]);
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_n = rtb_OR1;

    /* RateTransition: '<S5>/Rate Transition' */
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_3) {
      for (i = 0; i < 7; i++) {
        QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition_Buffer[i] =
          QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[i + 12];
      }
    }
     ...
     *  Selector: '<S63>/Select Data for IMU1'
     */
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_2) {
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition10_Buffer[0] =
        QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[0];
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition10_Buffer[1] =
        QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[1];
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition10_Buffer[2] =
        QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[2];
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition10_Buffer[3] =
        QD2_DroneStack_PID_FreqSwp_20_B.MaximumCommandAuthority[3];
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition11_Buffer =
        QD2_DroneStack_PID_FreqSwp_20_B.OutportBufferForOut1;
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition12_Buffer =
        QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[0];
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition15_Buffer[0],
             &QD2_DroneStack_PID_FreqSwp_20_B.SelectDataforIMU0[0], 9U * sizeof
             (real_T));
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition17_Buffer[0],
             &QD2_DroneStack_PID_FreqSwp_20_B.SelectDataforIMU1[0], 9U * sizeof
             (real_T));
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition19_Buffer[0],
             &QD2_DroneStack_PID_FreqSwp_20_B.Product3[0], 9U * sizeof(real_T));
     ...
     */
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_4) {
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition3_Buffer[0],
    ...
    if (QD2_DroneStack_PID_FreqSwp_2_M->Timing.RateInteraction.TID1_2) {
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition8_Buffer[0],
             &QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o2[0], 12U * sizeof(real_T));
    }
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_o = rtb_Relation_kg;

    /* DataTypeConversion: '<S99>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_a = rtb_Relation_mo;
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_d = rtb_Relation_js;

    /* DataTypeConversion: '<S102>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_a2 = rtb_Relation_f;

    /* DataTypeConversion: '<S103>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_p = rtb_Relation_cv;

    /* DataTypeConversion: '<S104>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_b = rtb_Relation_ol;

    /* DataTypeConversion: '<S105>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_nn = rtb_Relation_h;

    /* DataTypeConversion: '<S106>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_h = rtb_Relation_a;

    /* DataTypeConversion: '<S107>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_l = rtb_Relation_n;

    /* DataTypeConversion: '<S108>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_df = rtb_Relation_p;

    /* DataTypeConversion: '<S109>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_hb = rtb_AND3;
     ...
     */
    rtb_Relation_js = (((QD2_DroneStack_PID_FreqSwp_20_B.n[0] >=
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_e = rtb_Relation_js;

    /* Logic: '<S80>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_p = !rtb_Relation_js;

    /* DiscreteIntegrator: '<S80>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_p ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oj != 0))
    {
   ...
   */
  rtb_Relation_mo = (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion3 >=
                     QD2_DroneStack_PID_FreqSwp_20_P.Threshold_threshold_p);

  /* Logic: '<S14>/Logical Operator' */
  QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bd = !rtb_Relation_mo;
  if (rtb_Compare_gx) {
    /* DiscreteIntegrator: '<S14>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bd ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_a != 0))
    {
     ...
     */
    if (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTAT_ja >=
        QD2_DroneStack_PID_FreqSwp_20_P.Threshold_duration_o) {
      rtmSetStopRequested(QD2_DroneStack_PID_FreqSwp_2_M, true);
    }
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion12 = rtb_Compare_k;

  /* DataTypeConversion: '<S1>/Data Type Conversion6' incorporates:
   *  DataTypeConversion: '<S10>/Data Type Conversion14'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[0] =
    (QD2_DroneStack_PID_FreqSwp_20_B.Memory != 0.0);
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[1] =
    (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion12 != 0.0);
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[2] =
    (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion11 != 0.0);
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[3] =
    (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion10 != 0.0);
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[4] =
    (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion2 != 0.0);
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[5] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[6] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[7] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[8] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3];
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[9] =
    QD2_DroneStack_PID_FreqSwp_20_B.Compare_c;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[10] =
    QD2_DroneStack_PID_FreqSwp_20_B.Compare1;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[11] =
    QD2_DroneStack_PID_FreqSwp_20_B.Compare2;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[12] =
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_m;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[13] =
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator2;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[14] =
    QD2_DroneStack_PID_FreqSwp_20_B.checkifmeasuredheightexceedsmax;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[15] =
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator3_e;
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[16] =
    QD2_DroneStack_PID_FreqSwp_20_B.OR;

  /* MATLAB Function: '<S1>/STATE MACHINE TRANSITION' incorporates:
   *  MATLAB Function: '<S1>/STATE MACHINE LOGIC'
   */
  QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_e = QD2_DroneStack_PID_F_CALL_EVENT;

  /* MATLAB Function 'COMMANDER (ANGLE MODE)/STATE MACHINE TRANSITION': '<S11>:1' */
  /* '<S11>:1:29' */
  QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 0.0;
  switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.Memory) {
   case 1:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      /* '<S11>:1:33' */
      /* '<S11>:1:34' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 8.0;
    } else if (sigmoid != 0.0) {
      /* '<S11>:1:36' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 7.0;
    } else if (rtb_RelationalOperator) {
      /* '<S11>:1:37' */
      /* '<S11>:1:38' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 2.0;
    } else {
      /* '<S11>:1:40' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 1.0;
    }
    break;
   ...
   case 2:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      ...
      /* '<S11>:1:49' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 1.0;
    } else if (pt_ARM_to_TAKEOFF_THROTTLE) {
      /* '<S11>:1:50' */
      /* '<S11>:1:51' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 3.0;
    } else {
      /* '<S11>:1:53' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 2.0;
    }
   ...
   case 3:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      ...
      /* '<S11>:1:60' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 7.0;
    } else if (pt_TAKEOFF_THROTTLE_TO_TAKEOFF_) {
      /* '<S11>:1:61' */
      /* '<S11>:1:62' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 4.0;
    } else {
      /* '<S11>:1:64' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 3.0;
    }
   ...
   case 4:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      ...
      /* '<S11>:1:71' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 7.0;
    } else if (pt_TAKE_OFF_HEIGHT_TO_AUTOLAND) {
      /* '<S11>:1:72' */
      /* '<S11>:1:73' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 6.0;
    } else if (pt_TAKE_OFF_HEIGHT_TO_FLIGHT) {
      /* '<S11>:1:74' */
      /* '<S11>:1:75' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 5.0;
    } else {
      /* '<S11>:1:77' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 4.0;
    }
   ...
   case 6:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      ...
      /* '<S11>:1:95' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 7.0;
    } else if (pt_AUTOLAND_TO_DISABLE) {
      /* '<S11>:1:96' */
      /* '<S11>:1:97' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 9.0;
    } else {
      /* '<S11>:1:99' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 6.0;
    }
   ...
   case 7:
    if (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24) {
      ...
      /* '<S11>:1:104' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 8.0;
    } else if (pt_EMERGENCY_STOP_TO_DISABLE) {
      /* '<S11>:1:105' */
      /* '<S11>:1:106' */
      QD2_DroneStack_PID_FreqSwp_20_B.Next_state = 9.0;
    } else {
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion2_l = sigmoid;
  if (rtb_Compare_gx) {
    /* SignalConversion generated from: '<S1>/To Host File' */
    memcpy(&QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[0],
           &QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion6[0], 17U * sizeof
           (real_T));
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[17] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4_a;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[18] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion2_l;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[19] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion3;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[20] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[5];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[21] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[6];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[22] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[23] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[10];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[24] =
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[25] =
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[26] =
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[27] =
      QD2_DroneStack_PID_FreqSwp_20_B.Switch2_m[3];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[28] =
      QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[30] =
      QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[29] =
      QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[31] =
      QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[3];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[32] =
      QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[33] =
      QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[34] =
      QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFile[35] =
      QD2_DroneStack_PID_FreqSwp_20_B.GeneralizedCommandNradradrads4[3];

    /* Gain: '<S1>/Gain1' incorporates:
     *  Gain: '<S1>/Ki (rad s // m, rad s // m, N s//m, rad//s // rad//s)'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.Gain1[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.KiradsmradsmNsmradsrads_Gain[0] *
      rtb_Product_h_idx_0 * QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain_h[0];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain1[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.KiradsmradsmNsmradsrads_Gain[1] *
      rtb_Product_h_idx_1 * QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain_h[1];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain1[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.KiradsmradsmNsmradsrads_Gain[2] *
      rtb_Product_h_idx_2 * QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain_h[2];
    QD2_DroneStack_PID_FreqSwp_20_B.Gain1[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.KiradsmradsmNsmradsrads_Gain[3] *
      rtb_KiradsmradsmNsmradsrads[3] *
      QD2_DroneStack_PID_FreqSwp_20_P.Gain1_Gain_h[3];

    /* DataTypeConversion: '<S10>/Data Type Conversion9' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion9[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22;
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion9[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23;
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion9[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24;
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion9[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3];
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtBooleanEdg[0] =
    rtb_Compare_k;
  QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtBooleanEdg[1] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22;
  QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtBooleanEdg[2] =
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23;
  if (rtb_Compare_gx) {
    /* S-Function (string_constant_block): '<S16>/String Constant16' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Extra Messages for Console/String Constant16 (string_constant_block) */
    {
      size_t length;
      length = 80;
      utf8_string_copy_characters((t_utf8_char*)
        &QD2_DroneStack_PID_FreqSwp_20_B.MatrixConcatenate[0], length, (const
        t_utf8_char*) QD2_DroneStack_PID_FreqSwp_20_P.StringConstant16_Value);
    }

    /* S-Function (string_constant_block): '<S16>/String Constant12' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Extra Messages for Console/String Constant12 (string_constant_block) */
    {
      size_t length;
      length = 80;
      utf8_string_copy_characters((t_utf8_char*)
        &QD2_DroneStack_PID_FreqSwp_20_B.MatrixConcatenate[80], length, (const
        t_utf8_char*) QD2_DroneStack_PID_FreqSwp_20_P.StringConstant12_Value);
    }

    /* S-Function (string_constant_block): '<S16>/String Constant13' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Extra Messages for Console/String Constant13 (string_constant_block) */
    {
      size_t length;
      length = 80;
      utf8_string_copy_characters((t_utf8_char*)
        &QD2_DroneStack_PID_FreqSwp_20_B.MatrixConcatenate[160], length, (const
        t_utf8_char*) QD2_DroneStack_PID_FreqSwp_20_P.StringConstant13_Value);
    }

    /* S-Function (time_block): '<S10>/Time' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Time (time_block) */
    {
      t_error result;
      t_timeout current_time;
      t_timeout time_difference;
  ...
  for (ForEach_itr_b = 0; ForEach_itr_b < 3; ForEach_itr_b++) {
    ...
    for (i = 0; i < 80; i++) {
      rtb_MultiportSwitch_o[i] =
        QD2_DroneStack_PID_FreqSwp_20_B.MatrixConcatenate[80 * ForEach_itr_b + i];
    }
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      ...
      if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo))
      {
        ...
        if (!QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtBooleanEdg[ForEach_itr_b]
            && (QD2_DroneStack_PID_Freq_PrevZCX.CoreSubsys[ForEach_itr_b].
                TriggeredSubsystem1_Trig_ZCE != ZERO_ZCSIG)) {
          /* S-Function (print_block): '<S26>/Print' */

          /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Extra Messages for Console/Boolean Edge-Based Triggered Print/Triggered Subsystem1/Print (print_block) */
          {
            t_error result;
            size_t length;
          ...
          QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys[ForEach_itr_b].
            TriggeredSubsystem1_SubsysRanBC = 4;
        }

        QD2_DroneStack_PID_Freq_PrevZCX.CoreSubsys[ForEach_itr_b].
          TriggeredSubsystem1_Trig_ZCE =
          QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtBooleanEdg[ForEach_itr_b];
  ...
  if (rtb_Compare_gx) {
    ...
    switch ((int32_T)QD2_DroneStack_PID_FreqSwp_20_B.Memory) {
     case 1:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant5_Value[i]);
      }
      break;
     ...
     case 2:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant1_Value[i]);
      }
      break;
     ...
     case 3:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant2_Value[i]);
      }
      break;
     ...
     case 4:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant3_Value[i]);
      }
      break;
     ...
     case 5:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant6_Value[i]);
      }
      break;
     ...
     case 6:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant9_Value[i]);
      }
      break;
     ...
     case 7:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant4_Value[i]);
      }
      break;
     ...
     case 8:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant7_Value[i]);
      }
      break;
     ...
     default:
      for (i = 0; i < 80; i++) {
        rtb_MultiportSwitch_o[i] =
          (QD2_DroneStack_PID_FreqSwp_20_P.StringConstant8_Value[i]);
      }
      break;
    }
     ...
     */
    rtb_Relation_js = (QD2_DroneStack_PID_FreqSwp_20_B.Memory !=
    ...
    if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
      if (rtb_Relation_js &&
          (QD2_DroneStack_PID_Freq_PrevZCX.TriggeredSubsystem_Trig_ZCE_g !=
           POS_ZCSIG)) {
        /* S-Function (print_block): '<S28>/Print' */

        /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate State Messages for Console/Triggered Subsystem/Print (print_block) */
        {
          t_error result;
          size_t length;
          t_error string_result = 0;
          ...
          if (string_result >= 0) {
            result = console_print
              (QD2_DroneStack_PID_FreqSwp_20_P.Print_MaxUnits, &rtb_Print_o1_h,
               "[ %lf ] (s): State %u  => %s \n"
               , (double) rtb_Time_d
               , (unsigned int) QD2_DroneStack_PID_FreqSwp_20_B.Memory
               , &rtb_MultiportSwitch_o[0]
               );
            if (result >= 0) {
              console_flush();
        ...
        QD2_DroneStack_PID_FreqSwp_2_DW.TriggeredSubsystem_SubsysRanBC = 4;
      }
     ...
     *  Logic: '<S24>/NOT1'
     */
    rtb_Relation_js = (!QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion22 &&
                       QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion23);
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion9_m =
      (!QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_f &&
       !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3] && rtb_OR1 &&
       (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion11 != 0.0));
     ...
     *  Logic: '<S24>/NOT3'
     */
    tmpForInput[0] = !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_f;
    tmpForInput[1] = !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3];
    tmpForInput[2] = rtb_OR1;
    tmpForInput[3] = !(QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion11 !=
                       0.0);
    tmpForInput[4] = !QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator2;
    tmpForInput[5] =
      QD2_DroneStack_PID_FreqSwp_20_B.checkifmeasuredheightexceedsmax;
    rtb_Compare_k = tmpForInput[0];
    for (i = 0; i < 5; i++) {
      rtb_Compare_k = (rtb_Compare_k && tmpForInput[i + 1]);
    }

    /* DataTypeConversion: '<S24>/Data Type Conversion11' incorporates:
     *  Logic: '<S24>/AND3'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion11_h = rtb_Compare_k;

    /* Logic: '<S24>/AND2' incorporates:
     *  DataTypeConversion: '<S24>/Data Type Conversion3'
     *  Logic: '<S24>/NOT2'
     */
    tmpForInput_0[0] = !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_f;
    tmpForInput_0[1] = !QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_pb[3];
    tmpForInput_0[2] = rtb_OR1;
    tmpForInput_0[3] = !(QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion11 !=
                         0.0);
    tmpForInput_0[4] = !QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator2;
    tmpForInput_0[5] =
      !QD2_DroneStack_PID_FreqSwp_20_B.checkifmeasuredheightexceedsmax;
    tmpForInput_0[6] = QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion24;
    rtb_Relation_js = tmpForInput_0[0];
    for (i = 0; i < 6; i++) {
      rtb_Relation_js = (rtb_Relation_js && tmpForInput_0[i + 1]);
    }

    /* DataTypeConversion: '<S24>/Data Type Conversion12' incorporates:
     *  Logic: '<S24>/AND2'
     */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion12_i = rtb_Relation_js;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant1 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant2 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant3 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant8 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant4 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant5 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant6 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/String Constant7 (string_constant_block) */
    {
      size_t length;
      length = 80;
    ...
    for (ForEach_itr_h = 0; ForEach_itr_h < 9; ForEach_itr_h++) {
      ...
      if (rtb_TmpSignalConversionAtBoolea[ForEach_itr_h] &&
          (QD2_DroneStack_PID_Freq_PrevZCX.CoreSubsys_p[ForEach_itr_h].
           TriggeredSubsystem_Trig_ZCE != POS_ZCSIG)) {
        /* S-Function (print_block): '<S30>/Print' */

        /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/STATE MACHINE SIGNALS/Generate Warning Messages for Console/Boolean Value-Based Triggered Print/Triggered Subsystem/Print (print_block) */
        {
          t_error result;
          size_t length;
          t_error string_result = 0;
        ...
        QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys_p[ForEach_itr_h].
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_e3 = rtb_Relation_k;
  if (rtb_Compare_gx) {
  }
   ...
   *  Sum: '<S39>/Sum1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product_i[0] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[0] -
      QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[0]) -
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE[0] *
   ...
   *  Integrator: '<S39>/Integrator2'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_m[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_h *
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE[0];
   ...
   *  Sum: '<S39>/Sum1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product_i[1] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.UnsaturatedControllerCommandsNr[1] -
      QD2_DroneStack_PID_FreqSwp_20_B.Integrator1_o[1]) -
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE[1] *
     QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_f *
     QD2_DroneStack_PID_FreqSwp_20_P.Constant4_Value_m) *
    QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_h;
   ...
   *  Integrator: '<S39>/Integrator2'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_m[1] =
    QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_h *
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE[1];
  if (rtb_Compare_gx) {
    /* Outputs for Enabled SubSystem: '<S13>/Use desired height when enabled' */
    Usedesiredheightwhenenabled(QD2_DroneStack_PID_FreqSwp_2_M,
      QD2_DroneStack_PID_FreqSwp_20_B.enable_d,
      QD2_DroneStack_PID_FreqSwp_20_B.throttle_ref,
      &QD2_DroneStack_PID_FreqSwp_20_B.Usedesiredheightwhenenabled_c,
      &QD2_DroneStack_PID_FreqSwp_2_DW.Usedesiredheightwhenenabled_c,
      &QD2_DroneStack_PID_FreqSwp_20_P.Usedesiredheightwhenenabled_c);

    /* End of Outputs for SubSystem: '<S13>/Use desired height when enabled' */
  }

  /* DataTypeConversion: '<S14>/Data Type Conversion' */
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_i = rtb_Relation_mo;
  if (rtb_Compare_gx) {
    /* DataTypeConversion: '<S49>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_ni = rtb_Relation_e;

    /* DataTypeConversion: '<S50>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_l2 = rtb_Relation;
  }
  ...
  if (rtsiIsModeUpdateTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo)) {
    zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
                       &QD2_DroneStack_PID_Freq_PrevZCX.Integrator2_Reset_ZCE,
                       (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[1]));

    /* evaluate zero-crossings */
    if (zcEvent != NO_ZCEVENT) {
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_o =
        QD2_DroneStack_PID_FreqSwp_20_P.Integrator2_IC_g;
    }

    zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
                       &QD2_DroneStack_PID_Freq_PrevZCX.Integrator7_Reset_ZCE,
                       (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[1]));

    /* evaluate zero-crossings */
    if (zcEvent != NO_ZCEVENT) {
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator7_CSTATE[0] =
        QD2_DroneStack_PID_FreqSwp_20_P.Integrator7_IC;
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator7_CSTATE[1] =
        QD2_DroneStack_PID_FreqSwp_20_P.Integrator7_IC;
  ...
  /* Sum: '<S3>/Sum1' */
  sigmoid = QD2_DroneStack_PID_FreqSwp_20_B.Integrator1 -
    QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[10];

  /* Gain: '<S3>/Ki1' */
  QD2_DroneStack_PID_FreqSwp_20_B.Ki1 = QD2_DroneStack_PID_FreqSwp_20_P.Ki1_Gain
    * sigmoid;
   ...
   */
  rtb_rads = QD2_DroneStack_PID_FreqSwp_20_P.wn_Value *
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_c[0];
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_j[0] = rtb_rads;

  /* Sum: '<S3>/Sum8' incorporates:
   *  Integrator: '<S3>/Integrator6'
   */
  rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[0] - rtb_rads;
  rtb_Integrator7_idx_0 = rtb_rads_b;

  /* Gain: '<S3>/Ki3' */
  QD2_DroneStack_PID_FreqSwp_20_B.Ki3[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.Ki3_Gain * rtb_rads_b;
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_j[1] = rtb_rads;

  /* Sum: '<S3>/Sum8' incorporates:
   *  Integrator: '<S3>/Integrator6'
   */
  rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[1] - rtb_rads;
  data_loss = rtb_rads_b;
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_j[2] = rtb_rads;

  /* Sum: '<S3>/Sum8' incorporates:
   *  Integrator: '<S3>/Integrator6'
   */
  rtb_rads_b = QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[2] - rtb_rads;
  ...
  if (rtb_Compare_gx) {
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_o = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/MATLAB Function': '<S53>:1' */
    /* '<S53>:1:8' */
    QD2_DroneStack_PID_FreqSwp_20_B.enable_k = 0.0;

    /* '<S53>:1:9' */
    QD2_DroneStack_PID_FreqSwp_20_B.x_ref = 0.0;

    /* '<S53>:1:10' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel = 0.0;

    /* '<S53>:1:11' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_x_accel = 0.0;
    switch ((int32_T)rtb_rads) {
     case 1:
      /* '<S53>:1:15' */
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant9_Value[0];

      /* '<S53>:1:18' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_x_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant9_Value[1];
      break;
     ...
     case 3:
      ...
      /* '<S53>:1:28' */
      QD2_DroneStack_PID_FreqSwp_20_B.x_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[11];

      /* '<S53>:1:29' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant8_Value[0];

      /* '<S53>:1:30' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_x_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant8_Value[1];
      break;
     ...
     case 4:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.x_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[11];
      if (fabs(QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid_o1_a -
               QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[11]) <= 0.02) {
        /* '<S53>:1:35' */
        /* '<S53>:1:36' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant8_Value[0];
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_iv = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/MATLAB Function1': '<S54>:1' */
    /* '<S54>:1:8' */
    QD2_DroneStack_PID_FreqSwp_20_B.enable_n = 0.0;

    /* '<S54>:1:9' */
    QD2_DroneStack_PID_FreqSwp_20_B.y_ref = 0.0;

    /* '<S54>:1:10' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel = 0.0;
    ...
    switch ((int32_T)rtb_rads) {
     case 1:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_f[0];

      /* '<S54>:1:18' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_y_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant2_Value_f[1];
      break;
     ...
     case 3:
      ...
      /* '<S54>:1:28' */
      QD2_DroneStack_PID_FreqSwp_20_B.y_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[12];

      /* '<S54>:1:29' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_j[0];

      /* '<S54>:1:30' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_y_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_j[1];
      break;
     ...
     case 4:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.y_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[12];
      if (fabs(QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid1_o1 -
               QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[12]) <= 0.02) {
        /* '<S54>:1:35' */
        /* '<S54>:1:36' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant5_Value_j[0];
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_id = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/MATLAB Function2': '<S55>:1' */
    /* '<S55>:1:8' */
    QD2_DroneStack_PID_FreqSwp_20_B.enable_c = 0.0;

    /* '<S55>:1:9' */
    QD2_DroneStack_PID_FreqSwp_20_B.height_ref = 0.0;

    /* '<S55>:1:10' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel = 0.0;
    ...
    switch ((int32_T)rtb_rads) {
     ...
     case 3:
      /* '<S55>:1:27' */
      QD2_DroneStack_PID_FreqSwp_20_B.enable_c = 1.0;
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant3_Value_c[0];

      /* '<S55>:1:30' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_height_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant3_Value_c[1];
      break;
     ...
     case 4:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.height_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[13];
      if ((QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o2 < 0.0) || (fabs
           (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1 -
            QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[13]) <= 0.1) ||
          (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[13] <=
           QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o1)) {
        /* '<S55>:1:35' */
        /* '<S55>:1:36' */
        ...
        /* '<S55>:1:39' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant4_Value_c[0];

        /* '<S55>:1:40' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_height_accel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant4_Value_c[1];
      }
      break;
     ...
     case 5:
      ...
      /* '<S55>:1:44' */
      if (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid2_o2 >= 0.0) {
        /* '<S55>:1:45' */
        /* '<S55>:1:46' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant3_Value_c[0];
     ...
     */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_i = QD2_DroneStack_PID_F_CALL_EVENT;

    /* MATLAB Function 'HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/MATLAB Function4': '<S56>:1' */
    /* '<S56>:1:8' */
    QD2_DroneStack_PID_FreqSwp_20_B.enable = 0.0;

    /* '<S56>:1:9' */
    QD2_DroneStack_PID_FreqSwp_20_B.yaw_ref = 0.0;

    /* '<S56>:1:10' */
    QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel = 0.0;
    ...
    switch ((int32_T)rtb_rads) {
     ...
     case 2:
      /* '<S56>:1:20' */
      QD2_DroneStack_PID_FreqSwp_20_B.enable = 1.0;

      /* '<S56>:1:21' */
      QD2_DroneStack_PID_FreqSwp_20_B.yaw_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[14];

      /* '<S56>:1:22' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant6_Value[0];

      /* '<S56>:1:23' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant6_Value[1];
      break;
     ...
     case 3:
      ...
      /* '<S56>:1:27' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant7_Value[0];

      /* '<S56>:1:28' */
      QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_accel =
        QD2_DroneStack_PID_FreqSwp_20_P.Constant7_Value[1];
      break;
     ...
     case 4:
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.yaw_ref =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[14];
      if ((QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o2 < 0.0) ||
          (QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[14] <
           QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1) || (fabs
           (QD2_DroneStack_PID_FreqSwp_20_B.ContinuousSigmoid3_o1 -
            QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[14]) <= 0.2)) {
        /* '<S56>:1:32' */
        /* '<S56>:1:33' */
        QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel =
          QD2_DroneStack_PID_FreqSwp_20_P.Constant7_Value[0];
    ...
    Usedesiredheightwhenenabled(QD2_DroneStack_PID_FreqSwp_2_M,
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.height_ref,
      &QD2_DroneStack_PID_FreqSwp_20_B.Usedesheightwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_2_DW.Usedesheightwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_20_P.Usedesheightwhenenabled);
    ...
    Usedesiredheightwhenenabled(QD2_DroneStack_PID_FreqSwp_2_M,
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.yaw_ref,
      &QD2_DroneStack_PID_FreqSwp_20_B.Usedesyawwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_2_DW.Usedesyawwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_20_P.Usedesyawwhenenabled);
    ...
    Usedesiredheightwhenenabled(QD2_DroneStack_PID_FreqSwp_2_M,
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.x_ref,
      &QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredXwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_2_DW.UsedesiredXwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_20_P.UsedesiredXwhenenabled);
    ...
    Usedesiredheightwhenenabled(QD2_DroneStack_PID_FreqSwp_2_M,
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.y_ref,
      &QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredYwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_2_DW.UsedesiredYwhenenabled,
      &QD2_DroneStack_PID_FreqSwp_20_P.UsedesiredYwhenenabled);
  ...
  if (QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1_p) {
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[5];
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[6];
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7];
  }
   ...
   *  Sum: '<S52>/Sum1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product_b[0] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[5] -
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[0]) -
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_c[0] *
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Product_b[1] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[6] -
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[1]) -
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_c[1] *
     QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_o *
     QD2_DroneStack_PID_FreqSwp_20_P.zt_Value) *
    QD2_DroneStack_PID_FreqSwp_20_P.wn_Value;
  QD2_DroneStack_PID_FreqSwp_20_B.Product_b[2] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[7] -
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[2]) -
     QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_c[2] *
     QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_o *
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Sum2 =
    (QD2_DroneStack_PID_FreqSwp_20_B.Product4[2] -
     QD2_DroneStack_PID_FreqSwp_20_P.Kp1_Gain * sigmoid) -
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator2_CSTATE_o;
  if (rtb_Compare_gx) {
    /* Bias: '<S3>/gravity correction' */
    QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[0] =
      rtb_Product_h_idx_0 +
      QD2_DroneStack_PID_FreqSwp_20_P.gravitycorrection_Bias[0];
    QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[1] =
      rtb_Product_h_idx_1 +
      QD2_DroneStack_PID_FreqSwp_20_P.gravitycorrection_Bias[1];
    QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[2] =
      rtb_Product_h_idx_2 +
      QD2_DroneStack_PID_FreqSwp_20_P.gravitycorrection_Bias[2];
  }
   ...
   *  Integrator: '<S3>/Integrator7'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Sum9[0] =
    (QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[0] -
     QD2_DroneStack_PID_FreqSwp_20_P.Kp3_Gain * rtb_Integrator7_idx_0) -
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator7_CSTATE[0];

  /* Gain: '<S118>/Gain' */
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[0];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[3] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[0];
   ...
   *  Integrator: '<S3>/Integrator7'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Sum9[1] =
    (QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[1] -
     QD2_DroneStack_PID_FreqSwp_20_P.Kp3_Gain * data_loss) -
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator7_CSTATE[1];

  /* Gain: '<S118>/Gain' */
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[1] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[1];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[4] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[1];
  ...
  QD2_DroneStack_PID_FreqSwp_20_B.Sum9[2] =
    (QD2_DroneStack_PID_FreqSwp_20_B.IFAccelerometerdatamss3[2] -
     QD2_DroneStack_PID_FreqSwp_20_P.Kp3_Gain * rtb_rads_b) -
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator7_CSTATE[2];

  /* Gain: '<S118>/Gain' */
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[2] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[2];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_f[5] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_h *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[2];
  if (rtb_Compare_gx) {
  }
  ...
  /* Gain: '<S119>/Gain' */
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Sum1[0];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[3] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[3];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[1] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Sum1[1];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[4] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[4];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[2] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Sum1[2];
  QD2_DroneStack_PID_FreqSwp_20_B.Gain_k[5] =
    QD2_DroneStack_PID_FreqSwp_20_P.Gain_Gain_c *
    QD2_DroneStack_PID_FreqSwp_20_B.Reshape[5];
  if (rtb_Compare_gx) {
    /* S-Function (sample_time_block): '<S116>/Sample Time' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/STABILIZER - QDRONE 2/FLIGHT SAFETY/Sample Time (sample_time_block) */
    {
      t_error result;
      t_timeout current_time;
      t_timeout time_difference;
      ...
      if (result >= 0) {
        ...
        QD2_DroneStack_PID_FreqSwp_20_B.SampleTime_d = time_difference.seconds +
          time_difference.nanoseconds * 1e-9;
        memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.SampleTime_PreviousTime_d,
               &current_time, sizeof(t_timeout));
      }
    ...
    /* S-Function (computation_time_block): '<S116>/Computation Time' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/STABILIZER - QDRONE 2/FLIGHT SAFETY/Computation Time (computation_time_block) */
    {
      QD2_DroneStack_PID_FreqSwp_20_B.ComputationTime_l =
        QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime_ComputationTi_o.seconds
        + QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime_ComputationTi_o.nanoseconds
        * 1e-9;
    }
  }

  /* RelationalOperator: '<S122>/Relation' incorporates:
   *  Constant: '<S122>/threshold'
   */
  rtb_Relation_mo = (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion3 >=
                     QD2_DroneStack_PID_FreqSwp_20_P.Stopmodel_threshold);

  /* Logic: '<S122>/Logical Operator' */
  QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bx = !rtb_Relation_mo;
  if (rtb_Compare_gx) {
    /* DiscreteIntegrator: '<S122>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_bx ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_df != 0))
    {
     ...
     */
    rtb_DataTypeConversion3 =
      ((QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4 != 0.0) &&
       (QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1 != 0.0));

    /* RelationalOperator: '<S121>/Relation' incorporates:
     *  Constant: '<S121>/threshold'
     */
    rtb_Relation_js = (rtb_DataTypeConversion3 >=
                       QD2_DroneStack_PID_FreqSwp_20_P.Communication_threshold);

    /* Logic: '<S121>/Logical Operator' */
    QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_c = !rtb_Relation_js;

    /* DiscreteIntegrator: '<S121>/Discrete-Time Integrator' */
    if (QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_c ||
        (QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_az != 0))
    {
    ...
    /* S-Function (hil_watchdog_block): '<S116>/HIL Watchdog' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/STABILIZER - QDRONE 2/FLIGHT SAFETY/HIL Watchdog (hil_watchdog_block) */
    {
      t_error result;
      if (QD2_DroneStack_PID_FreqSwp_2_DW.HILWatchdog_IsStarted) {
        ...
        if (result == 0) {
          QD2_DroneStack_PID_FreqSwp_2_DW.HILWatchdog_IsStarted = true;
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.HILWatchdog = (result == 0);
    }
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.SampleTime_d;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.ComputationTime_l;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion4_f;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1_i;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[4] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion5;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[5] =
      QD2_DroneStack_PID_FreqSwp_20_B.SpecifyAngleModeforStabilizerDO;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[6] =
      QD2_DroneStack_PID_FreqSwp_20_B.NetThrottle;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[16] =
      QD2_DroneStack_PID_FreqSwp_20_B.NetThrottle;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[7] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[10] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[13] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[17] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[8] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[11] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[14] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[18] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[9] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeAngleCommands[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[12] =
      QD2_DroneStack_PID_FreqSwp_20_B.AttitudeTorqueCommands[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[15] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum6[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_a[19] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[2];
  }

  /* DataTypeConversion: '<S7>/Data Type Conversion1' */
  QD2_DroneStack_PID_FreqSwp_20_B.u1 =
    QD2_DroneStack_PID_FreqSwp_20_B.SafeFlightTrueFalse;
  if (rtb_Compare_gx) {
    /* SignalConversion generated from: '<S7>/To Host File- SYSID' */
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.SimTimes;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[16];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.u1;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.activeswp;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[4] =
      QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[4];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[5] =
      QD2_DroneStack_PID_FreqSwp_20_B.AxisSelector;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[6] =
      QD2_DroneStack_PID_FreqSwp_20_B.AngularFrq;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[7] =
      QD2_DroneStack_PID_FreqSwp_20_B.SwpSignal;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[8] =
      QD2_DroneStack_PID_FreqSwp_20_B.Reshape_d[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[9] =
      QD2_DroneStack_PID_FreqSwp_20_B.Reshape_d[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[10] =
      QD2_DroneStack_PID_FreqSwp_20_B.Reshape_d[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[11] =
      QD2_DroneStack_PID_FreqSwp_20_B.Reshape_d[3];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[12] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[13] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[14] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationCommandAuthorityNm1[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[15] =
      QD2_DroneStack_PID_FreqSwp_20_B.Product_n[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[16] =
      QD2_DroneStack_PID_FreqSwp_20_B.Product_n[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[17] =
      QD2_DroneStack_PID_FreqSwp_20_B.Product_n[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[18] =
      QD2_DroneStack_PID_FreqSwp_20_B.Product_n[3];
    memcpy(&QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[19],
           &QD2_DroneStack_PID_FreqSwp_20_B.Reshape[0], 9U * sizeof(real_T));
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[34] =
      QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[35] =
      QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[36] =
      QD2_DroneStack_PID_FreqSwp_20_B.MatrixMultiply1[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[37] =
      QD2_DroneStack_PID_FreqSwp_20_B.Product1[2];
    for (i = 0; i < 6; i++) {
      QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[i + 28] =
        QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[i + 5];
      QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[i + 38] =
        QD2_DroneStack_PID_FreqSwp_20_B.Product4[i];
    }

    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[44] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[47] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationMaxRaterads[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[45] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum1[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[48] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationMaxRaterads[1];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[46] =
      QD2_DroneStack_PID_FreqSwp_20_B.Sum1[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[49] =
      QD2_DroneStack_PID_FreqSwp_20_B.SaturationMaxRaterads[2];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[50] =
      QD2_DroneStack_PID_FreqSwp_20_B.HILRead_o1[0];
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[51] =
      QD2_DroneStack_PID_FreqSwp_20_B.SpecifyAngleModeforStabilizerDO;
    QD2_DroneStack_PID_FreqSwp_20_B.TmpSignalConversionAtToHostFi_n[52] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1;

    /* End of SignalConversion generated from: '<S7>/To Host File- SYSID' */
    /* Stop: '<S123>/Stop Simulation' incorporates:
     *  Constant: '<S126>/Constant'
     *  RelationalOperator: '<S126>/Compare'
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.RelationalOperator_e !=
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_dj) {
      rtmSetStopRequested(QD2_DroneStack_PID_FreqSwp_2_M, true);
    }

    /* End of Stop: '<S123>/Stop Simulation' */
    /* Stop: '<S124>/Stop Simulation' incorporates:
     *  Constant: '<S127>/Constant'
     *  RelationalOperator: '<S127>/Compare'
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.RelationalOperator_gi !=
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_g) {
      rtmSetStopRequested(QD2_DroneStack_PID_FreqSwp_2_M, true);
    }

    /* End of Stop: '<S124>/Stop Simulation' */
    /* Stop: '<S125>/Stop Simulation' incorporates:
     *  Constant: '<S128>/Constant'
     *  RelationalOperator: '<S128>/Compare'
     */
    if (QD2_DroneStack_PID_FreqSwp_20_B.HILWatchdog !=
        QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_p) {
      rtmSetStopRequested(QD2_DroneStack_PID_FreqSwp_2_M, true);
    }

    /* End of Stop: '<S125>/Stop Simulation' */

    /* DataTypeConversion: '<S121>/Data Type Conversion' */
    QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_m = rtb_Relation_js;
  }

  /* DataTypeConversion: '<S122>/Data Type Conversion' */
  QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_ah = rtb_Relation_mo;
}

/* Model update function for TID0 */
void QD2_DroneStack_PID_FreqSwp_2021a_update0(void) /* Sample time: [0.0s, 0.0s] */
{
  /* local scratch DWork variables */
  int32_T ForEach_itr_a;
  int32_T idxDelay;
  boolean_T tmp;
  tmp = rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M);
  if (tmp) {
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      {
        if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Target !=
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesiredheightwhenenabled_c.h_dm1)
        {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Target =
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesiredheightwhenenabled_c.h_dm1;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag = 1;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel =
            QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_vel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag = 1;
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_accel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc =
            QD2_DroneStack_PID_FreqSwp_20_B.max_throttle_accel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag = 1;
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      {
        if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Target_d !=
            QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredXwhenenabled.h_dm1) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Target_d =
            QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredXwhenenabled.h_dm1;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h = 1;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel_l) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel_l =
            QD2_DroneStack_PID_FreqSwp_20_B.max_x_vel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h = 1;
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_B.max_x_accel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc_p) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc_p =
            QD2_DroneStack_PID_FreqSwp_20_B.max_x_accel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h = 1;
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      {
        if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Target !=
            QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredYwhenenabled.h_dm1) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Target =
            QD2_DroneStack_PID_FreqSwp_20_B.UsedesiredYwhenenabled.h_dm1;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag = 1;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MVel) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MVel =
            QD2_DroneStack_PID_FreqSwp_20_B.max_y_vel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag = 1;
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_B.max_y_accel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MAcc) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MAcc =
            QD2_DroneStack_PID_FreqSwp_20_B.max_y_accel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag = 1;
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      {
        if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Target !=
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesheightwhenenabled.h_dm1) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Target =
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesheightwhenenabled.h_dm1;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag = 1;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MVel) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MVel =
            QD2_DroneStack_PID_FreqSwp_20_B.max_height_vel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag = 1;
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_B.max_height_accel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MAcc) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MAcc =
            QD2_DroneStack_PID_FreqSwp_20_B.max_height_accel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag = 1;
    ...
    if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
      {
        if (QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Target !=
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesyawwhenenabled.h_dm1) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Target =
            QD2_DroneStack_PID_FreqSwp_20_B.Usedesyawwhenenabled.h_dm1;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag = 1;
        }

        if (QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MVel) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MVel =
            QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_vel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag = 1;
        ...
        if (QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_accel !=
            QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MAcc) {
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MAcc =
            QD2_DroneStack_PID_FreqSwp_20_B.max_yaw_accel;
          QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag = 1;
  ...
  for (ForEach_itr_a = 0; ForEach_itr_a < 2; ForEach_itr_a++) {
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys_pn[ForEach_itr_a].
      Integrator1_DWORK1 = false;
  ...
  QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1 = false;

  /* Update for RateLimiter: '<S13>/Rate Limiter (N//s)' */
  QD2_DroneStack_PID_FreqSwp_2_DW.PrevY =
    QD2_DroneStack_PID_FreqSwp_20_B.RateLimiterNs;
  QD2_DroneStack_PID_FreqSwp_2_DW.LastMajorTime =
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[0];
  if (tmp) {
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRese = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_g = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_d = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_o = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_p = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_gh = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oz = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oi = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_e = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_n = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_p5 = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_dl = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_nn = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_eu = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTATE_c +=
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion_ai;
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_gx = (int8_T)
      QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_lm;
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_f = (int8_T)
      QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_i;

    /* Update for Delay: '<S7>/Delay' */
    for (idxDelay = 0; idxDelay < 99; idxDelay++) {
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE[idxDelay] =
        QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE[idxDelay + 1];
    }

    QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE[99] =
      QD2_DroneStack_PID_FreqSwp_20_B.DataTypeConversion1;

    /* End of Update for Delay: '<S7>/Delay' */

    /* Update for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOu_kc[0];

    /* Update for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut4_[0];

    /* Update for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[0] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut_k[0];

    /* Update for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOu_kc[1];

    /* Update for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut4_[1];

    /* Update for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut_k[1];

    /* Update for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOu_kc[2];

    /* Update for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut4_[2];

    /* Update for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[2] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut_k[2];

    /* Update for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOu_kc[3];

    /* Update for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut4_[3];

    /* Update for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[3] =
      QD2_DroneStack_PID_FreqSwp_20_B.ImpAsg_InsertedFor_ESCDataOut_k[3];

    /* Update for Delay: '<S70>/Delay3' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay3_DSTATE[0] =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay3_DSTATE[1];
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay3_DSTATE[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[0];

    /* Update for Delay: '<S70>/Delay2' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay2_DSTATE[0] =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay2_DSTATE[1];
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay2_DSTATE[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[1];

    /* Update for Delay: '<S70>/Delay1' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay1_DSTATE[0] =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay1_DSTATE[1];
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay1_DSTATE[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[2];

    /* Update for Delay: '<S70>/Delay' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE_e[0] =
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE_e[1];
    QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE_e[1] =
      QD2_DroneStack_PID_FreqSwp_20_B.Selector[3];
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_oj = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevRe_a = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_df = (int8_T)
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_PrevR_az = (int8_T)
      QD2_DroneStack_PID_FreqSwp_20_B.LogicalOperator_c;
  }

  /* Update for Integrator: '<S52>/Integrator1' */
  QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1_p = false;
  if (rtmIsMajorTimeStep(QD2_DroneStack_PID_FreqSwp_2_M)) {
    rt_ertODEUpdateContinuousStates(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo);
  }
   ...
   */
  if (!(++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick0)) {
    ++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH0;
  }

  QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[0] = rtsiGetSolverStopTime
    (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo);
   ...
   */
  if (!(++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick1)) {
    ++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH1;
  }

  QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[1] =
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick1 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize1 +
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH1 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize1 * 4294967296.0;
}

/* Derivatives for root system: '<Root>' */
void QD2_DroneStack_PID_FreqSwp_2021a_derivatives(void)
{
  /* local scratch DWork variables */
  int32_T ForEach_itr_a;
  XDot_QD2_DroneStack_PID_FreqS_T *_rtXdot;
  boolean_T lsat;
  boolean_T usat;
  _rtXdot = ((XDot_QD2_DroneStack_PID_FreqS_T *)
             QD2_DroneStack_PID_FreqSwp_2_M->derivs);

  /* Derivatives for Integrator: '<S3>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = QD2_DroneStack_PID_FreqSwp_20_B.Sum2;

  /* Derivatives for Integrator: '<S1>/Integrator1' */
  lsat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] <=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[0]);
  usat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[0] >=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[0]);
  if ((!lsat && !usat) || (lsat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[0] >
        0.0)) || (usat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[0] < 0.0))) {
    _rtXdot->Integrator1_CSTATE_f[0] = QD2_DroneStack_PID_FreqSwp_20_B.Gain1[0];
  } else {
    /* in saturation */
    _rtXdot->Integrator1_CSTATE_f[0] = 0.0;
  }

  lsat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] <=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[1]);
  usat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[1] >=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[1]);
  if ((!lsat && !usat) || (lsat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[1] >
        0.0)) || (usat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[1] < 0.0))) {
    _rtXdot->Integrator1_CSTATE_f[1] = QD2_DroneStack_PID_FreqSwp_20_B.Gain1[1];
  } else {
    /* in saturation */
    _rtXdot->Integrator1_CSTATE_f[1] = 0.0;
  }

  lsat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] <=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[2]);
  usat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[2] >=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[2]);
  if ((!lsat && !usat) || (lsat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[2] >
        0.0)) || (usat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[2] < 0.0))) {
    _rtXdot->Integrator1_CSTATE_f[2] = QD2_DroneStack_PID_FreqSwp_20_B.Gain1[2];
  } else {
    /* in saturation */
    _rtXdot->Integrator1_CSTATE_f[2] = 0.0;
  }

  lsat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] <=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_LowerSat[3]);
  usat = (QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_f[3] >=
          QD2_DroneStack_PID_FreqSwp_20_P.Integrator1_UpperSat[3]);
  if ((!lsat && !usat) || (lsat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[3] >
        0.0)) || (usat && (QD2_DroneStack_PID_FreqSwp_20_B.Gain1[3] < 0.0))) {
    _rtXdot->Integrator1_CSTATE_f[3] = QD2_DroneStack_PID_FreqSwp_20_B.Gain1[3];
  } else {
    /* in saturation */
  ...
  _rtXdot->Integrator6_CSTATE[0] = QD2_DroneStack_PID_FreqSwp_20_B.Sum9[0];
  _rtXdot->Integrator6_CSTATE[1] = QD2_DroneStack_PID_FreqSwp_20_B.Sum9[1];
  _rtXdot->Integrator6_CSTATE[2] = QD2_DroneStack_PID_FreqSwp_20_B.Sum9[2];
  ...
  _rtXdot->Integrator1_CSTATE_h[0] = QD2_DroneStack_PID_FreqSwp_20_B.Product1_m
    [0];

  /* Derivatives for Integrator: '<S39>/Integrator2' */
  _rtXdot->Integrator2_CSTATE[0] = QD2_DroneStack_PID_FreqSwp_20_B.Product_i[0];

  /* Derivatives for Integrator: '<S39>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_h[1] = QD2_DroneStack_PID_FreqSwp_20_B.Product1_m
    [1];

  /* Derivatives for Integrator: '<S39>/Integrator2' */
  _rtXdot->Integrator2_CSTATE[1] = QD2_DroneStack_PID_FreqSwp_20_B.Product_i[1];

  /* Derivatives for Integrator: '<S3>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_o = QD2_DroneStack_PID_FreqSwp_20_B.Ki1;

  /* Derivatives for Integrator: '<S3>/Integrator7' */
  _rtXdot->Integrator7_CSTATE[0] = QD2_DroneStack_PID_FreqSwp_20_B.Ki3[0];

  /* Derivatives for Integrator: '<S52>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_c[0] = QD2_DroneStack_PID_FreqSwp_20_B.Product_b[0];

  /* Derivatives for Integrator: '<S52>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_j[0] = QD2_DroneStack_PID_FreqSwp_20_B.Product1_j
    [0];

  /* Derivatives for Integrator: '<S3>/Integrator7' */
  _rtXdot->Integrator7_CSTATE[1] = QD2_DroneStack_PID_FreqSwp_20_B.Ki3[1];

  /* Derivatives for Integrator: '<S52>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_c[1] = QD2_DroneStack_PID_FreqSwp_20_B.Product_b[1];

  /* Derivatives for Integrator: '<S52>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_j[1] = QD2_DroneStack_PID_FreqSwp_20_B.Product1_j
    [1];

  /* Derivatives for Integrator: '<S3>/Integrator7' */
  _rtXdot->Integrator7_CSTATE[2] = QD2_DroneStack_PID_FreqSwp_20_B.Ki3[2];

  /* Derivatives for Integrator: '<S52>/Integrator2' */
  _rtXdot->Integrator2_CSTATE_c[2] = QD2_DroneStack_PID_FreqSwp_20_B.Product_b[2];

  /* Derivatives for Integrator: '<S52>/Integrator1' */
  _rtXdot->Integrator1_CSTATE_j[2] = QD2_DroneStack_PID_FreqSwp_20_B.Product1_j
    [2];
}

/* Model output function for TID2 */
void QD2_DroneStack_PID_FreqSwp_2021a_output2(void) /* Sample time: [0.002s, 0.0s] */
{
  /* local block i/o variables */
  ...
  memcpy(&rtb_TmpSignalConversionAtStream[0],
         &QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition8_Buffer[0], 12U *
         sizeof(real_T));
  memcpy(&rtb_TmpSignalConversionAtStream[12],
         &QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition15_Buffer[0], 9U *
         sizeof(real_T));
  memcpy(&rtb_TmpSignalConversionAtStream[21],
         &QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition17_Buffer[0], 9U *
         sizeof(real_T));
  memcpy(&rtb_TmpSignalConversionAtStream[30],
         &QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition19_Buffer[0], 9U *
         sizeof(real_T));
  ...
  /* Memory: '<S5>/Memory3' */
  rtb_Memory3 = QD2_DroneStack_PID_FreqSwp_2_DW.Memory3_PreviousInput;
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Stream Server (stream_server_block) */
  {
    t_pstream_state state;
    t_error send_result;
    t_error receive_result;
    ...
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition14 = 0;
    if (send_result < 0 && send_result != -QERR_WOULD_BLOCK) {
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition14 = send_result;
    } else if (receive_result < 0 && receive_result != -QERR_WOULD_BLOCK) {
      QD2_DroneStack_PID_FreqSwp_20_B.RateTransition14 = receive_result;
    }

    pstream_get_state(QD2_DroneStack_PID_FreqSwp_2_DW.StreamServer_Stream,
                      &state);
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition16 = state;
  }
...
void QD2_DroneStack_PID_FreqSwp_2021a_update2(void) /* Sample time: [0.002s, 0.0s] */
{
   ...
   */
  if (!(++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick2)) {
    ++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH2;
  }

  QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[2] =
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick2 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize2 +
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH2 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize2 * 4294967296.0;
}

/* Model output function for TID3 */
void QD2_DroneStack_PID_FreqSwp_2021a_output3(void) /* Sample time: [0.01s, 0.0s] */
{
  /* local block i/o variables */
  ...
  for (i = 0; i < 7; i++) {
    /* RateTransition: '<S5>/Rate Transition' */
    QD2_DroneStack_PID_FreqSwp_20_B.RateTransition_p[i] =
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition_Buffer[i];
  }

  /* Constant: '<S72>/x0' */
  QD2_DroneStack_PID_FreqSwp_20_B.x0 = QD2_DroneStack_PID_FreqSwp_20_P.x0_Value;
   ...
   *  Sum: '<S72>/Sum1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product_j[0] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.RateTransition_p[0] -
      QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator1_DSTATE[0]) -
     QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTAT_a1[0] *
   ...
   *  DiscreteIntegrator: '<S72>/Discrete-Time Integrator'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_d[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.DiscreteSecondOrderLowPassFilte *
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTAT_a1[0];
   ...
   *  Sum: '<S72>/Sum1'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product_j[1] =
    ((QD2_DroneStack_PID_FreqSwp_20_B.RateTransition_p[1] -
      QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator1_DSTATE[1]) -
     QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTAT_a1[1] *
     QD2_DroneStack_PID_FreqSwp_20_P.Constant_Value_b *
     QD2_DroneStack_PID_FreqSwp_20_P.DiscreteSecondOrderLowPassFil_p) *
    QD2_DroneStack_PID_FreqSwp_20_P.DiscreteSecondOrderLowPassFilte;
   ...
   *  DiscreteIntegrator: '<S72>/Discrete-Time Integrator'
   */
  QD2_DroneStack_PID_FreqSwp_20_B.Product1_d[1] =
    QD2_DroneStack_PID_FreqSwp_20_P.DiscreteSecondOrderLowPassFilte *
    QD2_DroneStack_PID_FreqSwp_2_DW.DiscreteTimeIntegrator_DSTAT_a1[1];
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Computation Time1 (computation_time_block) */
  {
    rtb_ComputationTime1 =
      QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime1_ComputationTim.seconds +
      QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime1_ComputationTim.nanoseconds
      * 1e-9;
  }

  /* RateTransition: '<S81>/Rate Transition' */
  QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition_Buffer0 = rtb_ComputationTime1;

  /* S-Function (sample_time_block): '<S81>/Sample Time1' */

  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Sample Time1 (sample_time_block) */
  {
    t_error result;
    t_timeout current_time;
    t_timeout time_difference;
    ...
    if (result >= 0) {
      ...
      rtb_SampleTime1 = time_difference.seconds + time_difference.nanoseconds *
        1e-9;
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.SampleTime1_PreviousTime,
             &current_time, sizeof(t_timeout));
    }
  ...
  /* RateTransition: '<S81>/Rate Transition1' */
  QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition1_Buffer0_m = rtb_SampleTime1;
}

/* Model update function for TID3 */
void QD2_DroneStack_PID_FreqSwp_2021a_update3(void) /* Sample time: [0.01s, 0.0s] */
{
   ...
   */
  if (!(++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick3)) {
    ++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH3;
  }

  QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[3] =
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick3 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize3 +
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH3 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize3 * 4294967296.0;
}

/* Model output function for TID4 */
void QD2_DroneStack_PID_FreqSwp_2021a_output4(void) /* Sample time: [0.04s, 0.0s] */
{
  /* local block i/o variables */
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Ranging Sensor (ranging_sensor_block) */
  {
    t_error result;
    result = vl53l1x_read(QD2_DroneStack_PID_FreqSwp_2_DW.RangingSensor_Sensor,
                          &QD2_DroneStack_PID_FreqSwp_2_DW.RangingSensor_Measurements);
    if (result >= 0) {
      QD2_DroneStack_PID_FreqSwp_20_B.RangingSensor_o1 =
        QD2_DroneStack_PID_FreqSwp_2_DW.RangingSensor_Measurements.distance;
    } else {
  ...
  rtb_MatrixMultiply[0] =
    QD2_DroneStack_PID_FreqSwp_20_P.ToFSensorXYOffsetsm_Value[0];
  rtb_MatrixMultiply[1] =
    QD2_DroneStack_PID_FreqSwp_20_P.ToFSensorXYOffsetsm_Value[1];
  ...
  for (i = 0; i < 3; i++) {
    rtb_MatrixMultiply_0 +=
      QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition3_Buffer[3 * i + 2] *
  ...
  /* RateTransition: '<S5>/Rate Transition1' */
  QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition1_Buffer0 = rtb_MatrixMultiply[2];
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Computation Time2 (computation_time_block) */
  {
    rtb_ComputationTime2 =
      QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime2_ComputationTim.seconds +
      QD2_DroneStack_PID_FreqSwp_2_DW.ComputationTime2_ComputationTim.nanoseconds
      * 1e-9;
  }
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Timing Monitors/Sample Time2 (sample_time_block) */
  {
    t_error result;
    t_timeout current_time;
    t_timeout time_difference;
    ...
    if (result >= 0) {
      ...
      rtb_SampleTime2 = time_difference.seconds + time_difference.nanoseconds *
        1e-9;
      memcpy(&QD2_DroneStack_PID_FreqSwp_2_DW.SampleTime2_PreviousTime,
             &current_time, sizeof(t_timeout));
    }
  ...
  /* RateTransition: '<S81>/Rate Transition3' */
  QD2_DroneStack_PID_FreqSwp_2_DW.RateTransition3_Buffer0 = rtb_SampleTime2;
}

/* Model update function for TID4 */
void QD2_DroneStack_PID_FreqSwp_2021a_update4(void) /* Sample time: [0.04s, 0.0s] */
{
   ...
   */
  if (!(++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick4)) {
    ++QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH4;
  }

  QD2_DroneStack_PID_FreqSwp_2_M->Timing.t[4] =
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTick4 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize4 +
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.clockTickH4 *
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize4 * 4294967296.0;
}

/* Use this function only if you need to maintain compatibility with an existing static main program. */
void QD2_DroneStack_PID_FreqSwp_2021a_output(int_T tid)
{
  switch (tid) {
   case 0 :
    QD2_DroneStack_PID_FreqSwp_2021a_output0();
    break;

   case 2 :
    QD2_DroneStack_PID_FreqSwp_2021a_output2();
    break;

   case 3 :
    QD2_DroneStack_PID_FreqSwp_2021a_output3();
    break;

   case 4 :
    QD2_DroneStack_PID_FreqSwp_2021a_output4();
    break;
...
/* Use this function only if you need to maintain compatibility with an existing static main program. */
void QD2_DroneStack_PID_FreqSwp_2021a_update(int_T tid)
{
  switch (tid) {
   case 0 :
    QD2_DroneStack_PID_FreqSwp_2021a_update0();
    break;

   case 2 :
    QD2_DroneStack_PID_FreqSwp_2021a_update2();
    break;

   case 3 :
    QD2_DroneStack_PID_FreqSwp_2021a_update3();
    break;

   case 4 :
    QD2_DroneStack_PID_FreqSwp_2021a_update4();
    break;
...
void QD2_DroneStack_PID_FreqSwp_2021a_initialize(void)
{
  {
    /* local scratch DWork variables */
    int32_T ForEach_itr_a;
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/HIL Initialize (hil_initialize_block) */
    {
      t_int result;
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIPStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIPEnter &&
           is_switching)) {
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMinimums[0] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AILow;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMinimums[1] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AILow;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMinimums[2] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AILow;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMinimums[3] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AILow;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMaximums[0] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIHigh;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMaximums[1] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIHigh;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMaximums[2] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIHigh;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMaximums[3] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIHigh;
        result = hil_set_analog_input_ranges
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_AIChannels, 4U,
           &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMinimums[0],
           &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_AIMaximums[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
      ...
      result = hil_set_digital_directions
        (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
         QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DIChannels, 6U,
         QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOChannels, 6U);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M, _rt_error_message);
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOEnter && is_switching))
      {
        {
          int_T i1;
          boolean_T *dw_DOBits =
            &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_DOBits[0];
          for (i1=0; i1 < 6; i1++) {
            dw_DOBits[i1] =
        ...
        result = hil_write_digital
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOChannels, 6U,
           (t_boolean *) &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_DOBits[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
          rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M, _rt_error_message);
      ...
      if (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOReset) {
        result = hil_watchdog_set_digital_expiration_state
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOChannels, 6U, (const
            t_digital_state *)
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIPStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIPEnter &&
           is_switching)) {
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_QuadratureModes[0] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIQuadrature;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_QuadratureModes[1] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIQuadrature;
        result = hil_set_encoder_quadrature_mode
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIChannels, 2U,
        ...
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_FilterFrequency[0] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIFrequency;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_FilterFrequency[1] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIFrequency;
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIEnter && is_switching))
      {
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_InitialEICounts[0] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIInitial;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_InitialEICounts[1] =
          QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_EIInitial;
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POPStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POPEnter &&
           is_switching)) {
        uint32_T num_duty_cycle_modes = 0;
        uint32_T num_frequency_modes = 0;
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[0] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[0]);
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[1] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[1]);
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[2] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[2]);
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[3] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[3]);
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[4] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[4]);
        QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[5] =
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POModes[4]);
        result = hil_set_pwm_mode
          (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
           QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POChannels, 6U,
           (t_pwm_mode *)
           &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POModeValues[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
...

        {
          ...
          for (i1=0; i1 < 6; i1++) {
            if (dw_POModeValues[i1] == PWM_DUTY_CYCLE_MODE || dw_POModeValues[i1]
              ...
              QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedChans[num_duty_cycle_modes]
                = (p_HILInitialize_POChannels[i1]);
              QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedFreqs[num_duty_cycle_modes]
                = QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POFrequency;
              num_duty_cycle_modes++;
            } else {
              QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedChans[5U -
                num_frequency_modes] = (p_HILInitialize_POChannels[i1]);
              QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedFreqs[5U -
                num_frequency_modes] =
                QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POFrequency;
              num_frequency_modes++;
            }
        ...
        if (num_duty_cycle_modes > 0) {
          result = hil_set_pwm_frequency
            (QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card,
             &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedChans[0],
             num_duty_cycle_modes,
             &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POSortedFreqs[0]);
          if (result < 0) {
            msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
              (_rt_error_message));
            rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M, _rt_error_message);
...

        {
          ...
          int32_T *dw_POAlignValues =
            &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POAlignValues[0];
          for (i1=0; i1 < 6; i1++) {
            dw_POAlignValues[i1] =
...

        {
          ...
          int32_T *dw_POPolarityVals =
            &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POPolarityVals[0];
          for (i1=0; i1 < 6; i1++) {
      ...
      if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POStart &&
           !is_switching) ||
          (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POEnter && is_switching))
      {
        {
          int_T i1;
          real_T *dw_POValues =
            &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POValues[0];
          for (i1=0; i1 < 6; i1++) {
            dw_POValues[i1] =
      ...
      if (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POReset) {
        {
          int_T i1;
          real_T *dw_POValues =
            &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_POValues[0];
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/Communication/Stream Client (stream_client_block) */
    {
      QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream = NULL;

      {
        int_T i1;
        real_T *y3 = &QD2_DroneStack_PID_FreqSwp_20_B.StreamClient_o4[0];
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Connected = false;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/COMMANDER (ANGLE MODE)/THROTTLE SWITCHBOX /Continuous Sigmoid (continuous_sigmoid_block) */
    {
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_PVel =
        QD2_DroneStack_PID_FreqSwp_20_P.ContinuousSigmoid_VI;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc = 0;
    }
    ...
    {
      real_T* params;
      params = &QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Sigmoid_l[0 *
        NUMBER_OF_SIGMOID_PARAMETERS];
      params[SIGMOID_PARAMETER_T1] = 0;
      params[SIGMOID_PARAMETER_T2] = 0;
      params[SIGMOID_PARAMETER_T3] = 0;
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_PVel_p =
        QD2_DroneStack_PID_FreqSwp_20_P.ContinuousSigmoid_VI_n;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_Flag_h = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MVel_l = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid_MAcc_p = 0;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid1 (continuous_sigmoid_block) */
    {
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_PVel =
        QD2_DroneStack_PID_FreqSwp_20_P.ContinuousSigmoid1_VI;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_Flag = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MVel = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid1_MAcc = 0;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid2 (continuous_sigmoid_block) */
    {
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_PVel =
        QD2_DroneStack_PID_FreqSwp_20_P.ContinuousSigmoid2_VI;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_Flag = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MVel = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid2_MAcc = 0;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/HORIZON FRAME CONVERSION AND ESTIMATION/Pose Switchbox/Continuous Sigmoid3 (continuous_sigmoid_block) */
    {
      ...
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_PVel =
        QD2_DroneStack_PID_FreqSwp_20_P.ContinuousSigmoid3_VI;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_Flag = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MVel = 0;
      QD2_DroneStack_PID_FreqSwp_2_DW.ContinuousSigmoid3_MAcc = 0;
    }
    ...
    for (ForEach_itr_a = 0; ForEach_itr_a < 2; ForEach_itr_a++) {
      ...
      QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Sum1[0] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_B.CoreSubsys_pn[ForEach_itr_a].Sum1[1] = 0.0;
    }

    /* End of Start for SubSystem: '<S63>/For Each Subsystem - Iterate over IMU0 and IMU1' */

    /* Start for Constant: '<S7>/Axis Selector' */
    QD2_DroneStack_PID_FreqSwp_20_B.AxisSelector =
      QD2_DroneStack_PID_FreqSwp_20_P.AxisSelector_Value;
    ...
    QD2_DroneStack_P_emxInit_real_T(&QD2_DroneStack_PID_FreqSwp_2_DW.buffer, 2);
    ...
    /* Start for S-Function (sample_time_block): '<S116>/Sample Time' */
    ...
    /* Start for S-Function (hil_watchdog_block): '<S116>/HIL Watchdog' */

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/STABILIZER - QDRONE 2/FLIGHT SAFETY/HIL Watchdog (hil_watchdog_block) */
    {
      QD2_DroneStack_PID_FreqSwp_2_DW.HILWatchdog_IsStarted = false;
    }
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Stream Server (stream_server_block) */
    {
      ...
      t_pstream_options options;
      t_error result;
      QD2_DroneStack_PID_FreqSwp_2_DW.StreamServer_Stream = NULL;
      QD2_DroneStack_PID_FreqSwp_20_B.StreamServer_o4 =
        QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_default_value;
      result = 0;
      options.size = sizeof(options);
      options.flags = QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_Endian &
        PSTREAM_FLAG_ENDIAN_MASK;
      if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_Implementation ==
          STREAM_SERVER_IMPLEMENTATION_THREAD) {
        options.flags |= PSTREAM_FLAG_MULTITHREADED;
      }

      if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_Optimize ==
      ...
      options.num_send_dimensions = 0;
      options.max_send_dimensions = NULL;
      if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_SndPriority <
          min_priority) {
        scheduling_parameters.sched_priority = min_priority;
      } else if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_SndPriority >
                 max_priority) {
        scheduling_parameters.sched_priority = max_priority;
      } else {
        scheduling_parameters.sched_priority =
      ...
      options.num_receive_dimensions = 0;
      options.max_receive_dimensions = NULL;
      if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_RcvPriority <
          min_priority) {
        scheduling_parameters.sched_priority = min_priority;
      } else if (QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_RcvPriority >
                 max_priority) {
        scheduling_parameters.sched_priority = max_priority;
      } else {
        scheduling_parameters.sched_priority =
      ...
      if (result == 0) {
        result = pstream_listen((const char *)
          QD2_DroneStack_PID_FreqSwp_20_P.StreamServer_URI, &options,
          &QD2_DroneStack_PID_FreqSwp_2_DW.StreamServer_Stream);
        if (result < 0 && result != -QERR_WOULD_BLOCK) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
    ...
    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Ranging Sensor (ranging_sensor_block) */
    {
      ...
      result = vl53l1x_open("i2c-cpu://localhost:0?address='0x29',baud='400000',memsize='512'",
        ...
        - 1), QD2_DroneStack_PID_FreqSwp_20_P.RangingSensor_Budget,
  ...
  QD2_DroneStack_PID_Freq_PrevZCX.Integrator1_Reset_ZCE = UNINITIALIZED_ZCSIG;
  QD2_DroneStack_PID_Freq_PrevZCX.Integrator2_Reset_ZCE = UNINITIALIZED_ZCSIG;
  QD2_DroneStack_PID_Freq_PrevZCX.Integrator7_Reset_ZCE = UNINITIALIZED_ZCSIG;
  QD2_DroneStack_PID_Freq_PrevZCX.TriggeredSubsystem_Trig_ZCE_g = POS_ZCSIG;
  QD2_DroneStack_PID_Freq_PrevZCX.LatchEStop_Trig_ZCE = POS_ZCSIG;
  QD2_DroneStack_PID_Freq_PrevZCX.TriggeredSubsystemLatchingFlag_ = POS_ZCSIG;

  {
    ...
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator6_IC;
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator6_IC;
    QD2_DroneStack_PID_FreqSwp_20_X.Integrator6_CSTATE[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Integrator6_IC;

    /* InitializeConditions for Integrator: '<S39>/Integrator1' */
    if (rtmIsFirstInitCond(QD2_DroneStack_PID_FreqSwp_2_M)) {
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[0] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_h[1] = 0.0;
    }

    QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1 = true;

    /* End of InitializeConditions for Integrator: '<S39>/Integrator1' */

    /* InitializeConditions for RateLimiter: '<S13>/Rate Limiter (N//s)' */
    QD2_DroneStack_PID_FreqSwp_2_DW.LastMajorTime = (rtInf);
    ...
    for (i = 0; i < 100; i++) {
      QD2_DroneStack_PID_FreqSwp_2_DW.Delay_DSTATE[i] =
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_l[0];

    /* InitializeConditions for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_lk[0];

    /* InitializeConditions for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[0] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_cr[0];

    /* InitializeConditions for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_l[1];

    /* InitializeConditions for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_lk[1];

    /* InitializeConditions for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[1] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_cr[1];

    /* InitializeConditions for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_l[2];

    /* InitializeConditions for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_lk[2];

    /* InitializeConditions for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[2] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_cr[2];

    /* InitializeConditions for Memory: '<S67>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_a[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_l[3];

    /* InitializeConditions for Memory: '<S69>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_as[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_lk[3];

    /* InitializeConditions for Memory: '<S68>/Memory' */
    QD2_DroneStack_PID_FreqSwp_2_DW.Memory_PreviousInput_n[3] =
      QD2_DroneStack_PID_FreqSwp_20_P.Memory_InitialCondition_cr[3];
    ...
    if (rtmIsFirstInitCond(QD2_DroneStack_PID_FreqSwp_2_M)) {
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[0] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[1] = 0.0;
      QD2_DroneStack_PID_FreqSwp_20_X.Integrator1_CSTATE_j[2] = 0.0;
    }

    QD2_DroneStack_PID_FreqSwp_2_DW.Integrator1_DWORK1_p = true;
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.state = 0.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.state_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_nd = QD2_DroneStack_PID_F_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S70>/MATLAB Function' */
    QD2_DroneStack_PID_FreqSwp_2_DW.buffer_not_empty = false;
    QD2_DroneStack_PID_FreqSwp_2_DW.idx = 1.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.idx_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_c = QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause = 99.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.next_state_after_pause_not_empt = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.state_counter = 1000.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_after_pause = 1000.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.state_counter_after_pause_not_e = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.esc_timeout_state = 0.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.esc_timeout_state_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_p = QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.ms_time_prev = 0.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.ms_time_prev_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_l = QD2_DroneStack_PID_F_CALL_EVENT;
    ...
    QD2_DroneStack_PID_FreqSwp_2_DW.tStart = 0.0;
    QD2_DroneStack_PID_FreqSwp_2_DW.tStart_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest = false;
    QD2_DroneStack_PID_FreqSwp_2_DW.previousRequest_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.aborted = false;
    QD2_DroneStack_PID_FreqSwp_2_DW.aborted_not_empty = true;
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent_j = QD2_DroneStack_PID_F_CALL_EVENT;

    /* SystemInitialize for MATLAB Function: '<S7>/SYSID Axis Router' */
    QD2_DroneStack_PID_FreqSwp_2_DW.sfEvent = QD2_DroneStack_PID_F_CALL_EVENT;

    /* set "at time zero" to false */
    if (rtmIsFirstInitCond(QD2_DroneStack_PID_FreqSwp_2_M)) {
      rtmSetFirstInitCond(QD2_DroneStack_PID_FreqSwp_2_M, 0);
    }
  }
}

/* Model terminate function */
void QD2_DroneStack_PID_FreqSwp_2021a_terminate(void)
{
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/HIL Initialize (hil_initialize_block) */
  {
    ...
    hil_task_stop_all(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    hil_monitor_stop_all(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    is_switching = false;

    /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/STABILIZER - QDRONE 2/FLIGHT SAFETY/HIL Watchdog (hil_watchdog_block) */
    {
      hil_watchdog_stop(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    }

    if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOTerminate &&
         !is_switching) || (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOExit
         && is_switching)) {
      {
        int_T i1;
        boolean_T *dw_DOBits =
          &QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_DOBits[0];
        for (i1=0; i1 < 6; i1++) {
          dw_DOBits[i1] = QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_DOFinal;
        }
      }
    ...
    if ((QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POTerminate &&
         !is_switching) || (QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POExit
         && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues =
    ...
    if (0
      ...
      result = hil_write(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card
                         , NULL, 0
                         ,
                         QD2_DroneStack_PID_FreqSwp_20_P.HILInitialize_POChannels,
    ...
    hil_task_delete_all(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    hil_monitor_delete_all(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    hil_close(QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card);
    QD2_DroneStack_PID_FreqSwp_2_DW.HILInitialize_Card = NULL;
  }
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/Communication/Stream Client (stream_client_block) */
  {
    if (QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream != NULL) {
      pstream_close(QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream);
    }

    QD2_DroneStack_PID_FreqSwp_2_DW.StreamClient_Stream = NULL;
  }

  QD2_DroneStack_P_emxFree_real_T(&QD2_DroneStack_PID_FreqSwp_2_DW.buffer);

  /* Terminate for S-Function (stream_server_block): '<S5>/Stream Server' */

  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Stream Server (stream_server_block) */
  {
    if (QD2_DroneStack_PID_FreqSwp_2_DW.StreamServer_Stream != NULL) {
      pstream_close(QD2_DroneStack_PID_FreqSwp_2_DW.StreamServer_Stream);
    }
  ...
  /* S-Function Block: QD2_DroneStack_PID_FreqSwp_2021a/QDrone 2 DAQ/Ranging Sensor (ranging_sensor_block) */
  {
    vl53l1x_close(QD2_DroneStack_PID_FreqSwp_2_DW.RangingSensor_Sensor);
    QD2_DroneStack_PID_FreqSwp_2_DW.RangingSensor_Sensor = NULL;
  }
}
...
void MdlOutputs(int_T tid)
{
  if (tid == 1)
    tid = 0;
  QD2_DroneStack_PID_FreqSwp_2021a_output(tid);
}
...
void MdlUpdate(int_T tid)
{
  if (tid == 1)
    tid = 0;
  QD2_DroneStack_PID_FreqSwp_2021a_update(tid);
}
...
void MdlStart(void)
{
  QD2_DroneStack_PID_FreqSwp_2021a_initialize();
}

void MdlTerminate(void)
{
  QD2_DroneStack_PID_FreqSwp_2021a_terminate();
}

/* Registration function */
RT_MODEL_QD2_DroneStack_PID_F_T *QD2_DroneStack_PID_FreqSwp_2021a(void)
{
  /* Registration code */
  ...
  QD2_DroneStack_PID_FreqSwp_20_P.Constant1_Value_j = rtInf;

  /* initialize real-time model */
  (void) memset((void *)QD2_DroneStack_PID_FreqSwp_2_M, 0,
                sizeof(RT_MODEL_QD2_DroneStack_PID_F_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                          &QD2_DroneStack_PID_FreqSwp_2_M->Timing.simTimeStep);
    rtsiSetTPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, &rtmGetTPtr
                (QD2_DroneStack_PID_FreqSwp_2_M));
    rtsiSetStepSizePtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                       &QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize0);
    rtsiSetdXPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                 &QD2_DroneStack_PID_FreqSwp_2_M->derivs);
    rtsiSetContStatesPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, (real_T **)
                         &QD2_DroneStack_PID_FreqSwp_2_M->contStates);
    rtsiSetNumContStatesPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
      &QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
      &QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr
      (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
       &QD2_DroneStack_PID_FreqSwp_2_M->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr
      (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
       &QD2_DroneStack_PID_FreqSwp_2_M->periodicContStateRanges);
    rtsiSetContStateDisabledPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
      (boolean_T**) &QD2_DroneStack_PID_FreqSwp_2_M->contStateDisabled);
    rtsiSetErrorStatusPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                          (&rtmGetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M)));
    rtsiSetRTModelPtr(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                      QD2_DroneStack_PID_FreqSwp_2_M);
  }

  rtsiSetSimTimeStep(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                     MAJOR_TIME_STEP);
  rtsiSetIsMinorTimeStepWithModeChange
    (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, false);
  rtsiSetIsContModeFrozen(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, false);
  QD2_DroneStack_PID_FreqSwp_2_M->intgData.f[0] =
    QD2_DroneStack_PID_FreqSwp_2_M->odeF[0];
  QD2_DroneStack_PID_FreqSwp_2_M->contStates = ((real_T *)
    &QD2_DroneStack_PID_FreqSwp_20_X);
  QD2_DroneStack_PID_FreqSwp_2_M->contStateDisabled = ((boolean_T *)
    &QD2_DroneStack_PID_FreqSwp_XDis);
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.tStart = (0.0);
  rtsiSetSolverData(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, (void *)
                    &QD2_DroneStack_PID_FreqSwp_2_M->intgData);
  rtsiSetSolverName(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,"ode1");

  /* Initialize timing info */
  {
    int_T *mdlTsMap =
      QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimeTaskIDArray;
    int_T i;
    for (i = 0; i < 5; i++) {
      mdlTsMap[i] = i;
    }

    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes =
      (&QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimesArray[0]);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes =
      (&QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimesArray[0]);

    /* task periods */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes[0] = (0.0);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes[1] = (0.001);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes[2] = (0.002);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes[3] = (0.01);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleTimes[4] = (0.04);

    /* task offsets */
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes[0] = (0.0);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes[1] = (0.0);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes[2] = (0.0);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes[3] = (0.0);
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.offsetTimes[4] = (0.0);
  }

  rtmSetTPtr(QD2_DroneStack_PID_FreqSwp_2_M,
             &QD2_DroneStack_PID_FreqSwp_2_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleHitArray;
    int_T *mdlPerTaskSampleHits =
      QD2_DroneStack_PID_FreqSwp_2_M->Timing.perTaskSampleHitsArray;
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.perTaskSampleHits =
      (&mdlPerTaskSampleHits[0]);
    mdlSampleHits[0] = 1;
    QD2_DroneStack_PID_FreqSwp_2_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(QD2_DroneStack_PID_FreqSwp_2_M, -1);
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize0 = 0.001;
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize1 = 0.001;
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize2 = 0.002;
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize3 = 0.01;
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize4 = 0.04;
  rtmSetFirstInitCond(QD2_DroneStack_PID_FreqSwp_2_M, 1);

  /* External mode info */
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.checksums[0] = (3806767742U);
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.checksums[1] = (1760334808U);
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.checksums[2] = (1654648833U);
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.checksums[3] = (487077538U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[71];
    QD2_DroneStack_PID_FreqSwp_2_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    systemRan[1] = &rtAlwaysEnabled;
    systemRan[2] = (sysRanDType *)&QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys[2]
    ...
    systemRan[15] = (sysRanDType *)
      &QD2_DroneStack_PID_FreqSwp_2_DW.CoreSubsys_p[8].
    ...
    rteiSetModelMappingInfoPtr(QD2_DroneStack_PID_FreqSwp_2_M->extModeInfo,
      &QD2_DroneStack_PID_FreqSwp_2_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(QD2_DroneStack_PID_FreqSwp_2_M->extModeInfo,
                        QD2_DroneStack_PID_FreqSwp_2_M->Sizes.checksums);
    rteiSetTPtr(QD2_DroneStack_PID_FreqSwp_2_M->extModeInfo, rtmGetTPtr
                (QD2_DroneStack_PID_FreqSwp_2_M));
  }

  QD2_DroneStack_PID_FreqSwp_2_M->solverInfoPtr =
    (&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo);
  QD2_DroneStack_PID_FreqSwp_2_M->Timing.stepSize = (0.001);
  rtsiSetFixedStepSize(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo, 0.001);
  rtsiSetSolverMode(&QD2_DroneStack_PID_FreqSwp_2_M->solverInfo,
                    SOLVER_MODE_MULTITASKING);

  /* block I/O */
  QD2_DroneStack_PID_FreqSwp_2_M->blockIO = ((void *)
    &QD2_DroneStack_PID_FreqSwp_20_B);
  (void) memset(((void *) &QD2_DroneStack_PID_FreqSwp_20_B), 0,
                sizeof(B_QD2_DroneStack_PID_FreqSwp__T));

  /* parameters */
  QD2_DroneStack_PID_FreqSwp_2_M->defaultParam = ((real_T *)
    &QD2_DroneStack_PID_FreqSwp_20_P);

  /* states (continuous) */
  {
    real_T *x = (real_T *) &QD2_DroneStack_PID_FreqSwp_20_X;
    QD2_DroneStack_PID_FreqSwp_2_M->contStates = (x);
    (void) memset((void *)&QD2_DroneStack_PID_FreqSwp_20_X, 0,
                  sizeof(X_QD2_DroneStack_PID_FreqSwp__T));
  }

  /* disabled states */
  {
    boolean_T *xdis = (boolean_T *) &QD2_DroneStack_PID_FreqSwp_XDis;
    QD2_DroneStack_PID_FreqSwp_2_M->contStateDisabled = (xdis);
    (void) memset((void *)&QD2_DroneStack_PID_FreqSwp_XDis, 0,
                  sizeof(XDis_QD2_DroneStack_PID_FreqS_T));
  }

  /* states (dwork) */
  QD2_DroneStack_PID_FreqSwp_2_M->dwork = ((void *)
    &QD2_DroneStack_PID_FreqSwp_2_DW);
  (void) memset((void *)&QD2_DroneStack_PID_FreqSwp_2_DW, 0,
                sizeof(DW_QD2_DroneStack_PID_FreqSwp_T));
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    QD2_DroneStack_PID_FreqSwp_2_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  /* Initialize Sizes */
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numContStates = (56);/* Number of continuous states */
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numPeriodicContStates = (0);
                                      /* Number of periodic continuous states */
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numY = (0);/* Number of model outputs */
  ...
  QD2_DroneStack_PID_FreqSwp_2_M->Sizes.numBlockIO = (283);/* Number of block outputs */
