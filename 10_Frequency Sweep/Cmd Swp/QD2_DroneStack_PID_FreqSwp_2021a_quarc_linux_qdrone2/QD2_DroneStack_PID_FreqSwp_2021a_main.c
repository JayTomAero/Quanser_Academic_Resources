...
typedef RT_MODEL_QD2_DroneStack_PID_F_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QD2_DroneStack_PID_FreqSwp_2021a(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QD2_DroneStack_PID_FreqSwp_2_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QD2_DroneStack_PID_FreqSwp_2021a -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = QD2_DroneStack_PID_FreqSwp_2021a();
  if (rtmGetErrorStatus(S) != NULL) {
  ...
  string_copy((char *) QD2_DroneStack_PID_FreqSwp_20_B.ModelArgument, 80,
              extra_arg1);
