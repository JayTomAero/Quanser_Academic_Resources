...
#ifndef quarc_basic_server_demo_h_
#define quarc_basic_server_demo_h_
#ifndef quarc_basic_server_demo_COMMON_INCLUDES_
#define quarc_basic_server_demo_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* quarc_basic_server_demo_COMMON_INCLUDES_ */

#include "quarc_basic_server_demo_types.h"
...
#define quarc_basic_server_demo_rtModel RT_MODEL_quarc_basic_server_d_T

/* Block signals (default storage) */
typedef struct {
  real_T SineWave;                     /* '<Root>/Sine Wave' */
  real_T StreamServer_o4;              /* '<Root>/Stream Server' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } SentDataServer_PWORK;              /* '<Root>/Sent Data - Server' */
...
} DW_quarc_basic_server_demo_T;

/* Backward compatible GRT Identifiers */
#define rtB                            quarc_basic_server_demo_B
#define BlockIO                        B_quarc_basic_server_demo_T
#define rtP                            quarc_basic_server_demo_P
#define Parameters                     P_quarc_basic_server_demo_T
#define rtDWork                        quarc_basic_server_demo_DW
#define D_Work                         DW_quarc_basic_server_demo_T

/* Parameters (default storage) */
struct P_quarc_basic_server_demo_T_ {
...
struct tag_RTM_quarc_basic_server_de_T {
  const char_T *path;
...
extern P_quarc_basic_server_demo_T quarc_basic_server_demo_P;

/* Block signals (default storage) */
extern B_quarc_basic_server_demo_T quarc_basic_server_demo_B;

/* Block states (default storage) */
extern DW_quarc_basic_server_demo_T quarc_basic_server_demo_DW;

/* Model entry point functions */
extern void quarc_basic_server_demo_initialize(void);
extern void quarc_basic_server_demo_output(void);
extern void quarc_basic_server_demo_update(void);
extern void quarc_basic_server_demo_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern quarc_basic_server_demo_rtModel *quarc_basic_server_demo(void);
...
extern RT_MODEL_quarc_basic_server_d_T *const quarc_basic_server_demo_M;
 ...
 *
 * '<Root>' : 'quarc_basic_server_demo'
 * '<S1>'   : 'quarc_basic_server_demo/Powered by QUARC'
 * '<S2>'   : 'quarc_basic_server_demo/Quanser'
 */
#endif                                 /* quarc_basic_server_demo_h_ */
