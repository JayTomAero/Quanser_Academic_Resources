...
RT_MODEL_QD2_MissionCtrl_Hove_T *QD2_MissionCtrl_Hover_2021a(void)
{
  ...
  /* External mode info */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[0] = (139012830U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[1] = (882497957U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[2] = (3386229246U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[3] = (3438026380U);
