...
RT_MODEL_QD2_MissionCtrl_Hove_T *QD2_MissionCtrl_Hover_2021a(void)
{
  ...
  /* External mode info */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[0] = (2602223710U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[1] = (1480510760U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[2] = (3261983794U);
  QD2_MissionCtrl_Hover_2021a_M->Sizes.checksums[3] = (1873449622U);
  ...
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlocks = (268);/* Number of blocks */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlockIO = (66);/* Number of block outputs */
  QD2_MissionCtrl_Hover_2021a_M->Sizes.numBlockPrms = (300);/* Sum of parameter "widths" */
