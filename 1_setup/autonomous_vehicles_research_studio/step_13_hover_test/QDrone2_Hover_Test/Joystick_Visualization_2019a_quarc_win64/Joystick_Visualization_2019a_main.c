...
typedef RT_MODEL_Joystick_Visualizati_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Joystick_Visualization_2019a(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Joystick_Visualization_2019a_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Joystick_Visualization_2019a:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Joystick_Visualization_2019a -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = Joystick_Visualization_2019a();
  if (rtmGetErrorStatus(S) != NULL) {
