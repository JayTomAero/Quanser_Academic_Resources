...
#ifndef quarc_basic_client_demo_h_
#define quarc_basic_client_demo_h_
#ifndef quarc_basic_client_demo_COMMON_INCLUDES_
#define quarc_basic_client_demo_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* quarc_basic_client_demo_COMMON_INCLUDES_ */

#include "quarc_basic_client_demo_types.h"
...
#define quarc_basic_client_demo_rtModel RT_MODEL_quarc_basic_client_d_T

/* Block signals (default storage) */
typedef struct {
  real_T SignalGenerator;              /* '<Root>/Signal Generator' */
  real_T StreamClient_o4;              /* '<Root>/Stream Client' */
  int32_T StreamClient_o2;             /* '<Root>/Stream Client' */
  uint8_T StreamClient_o1;             /* '<Root>/Stream Client' */
  boolean_T StreamClient_o3;           /* '<Root>/Stream Client' */
  boolean_T StreamClient_o5;           /* '<Root>/Stream Client' */
} B_quarc_basic_client_demo_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  t_pstream StreamClient_Stream;       /* '<Root>/Stream Client' */
  struct {
    void *LoggedData;
  ...
  struct {
    void *LoggedData;
  } ReceivedDataClient_PWORK;          /* '<Root>/Received Data - Client' */

  struct {
    void *LoggedData;
  } SentDataClient_PWORK;              /* '<Root>/Sent Data - Client' */
...
} DW_quarc_basic_client_demo_T;

/* Backward compatible GRT Identifiers */
#define rtB                            quarc_basic_client_demo_B
#define BlockIO                        B_quarc_basic_client_demo_T
#define rtP                            quarc_basic_client_demo_P
#define Parameters                     P_quarc_basic_client_demo_T
#define rtDWork                        quarc_basic_client_demo_DW
#define D_Work                         DW_quarc_basic_client_demo_T

/* Parameters (default storage) */
struct P_quarc_basic_client_demo_T_ {
  real_T StreamClient_default_value;
  ...
  int8_T StreamClient_Implementation;
                               ...
                               * Referenced by: '<Root>/Stream Client'
                               */
  uint8_T StreamClient_URI[28];        /* Expression: uri_argument
                                        * Referenced by: '<Root>/Stream Client'
                                        */
...
struct tag_RTM_quarc_basic_client_de_T {
  const char_T *path;
...
extern P_quarc_basic_client_demo_T quarc_basic_client_demo_P;

/* Block signals (default storage) */
extern B_quarc_basic_client_demo_T quarc_basic_client_demo_B;

/* Block states (default storage) */
extern DW_quarc_basic_client_demo_T quarc_basic_client_demo_DW;

/* Model entry point functions */
extern void quarc_basic_client_demo_initialize(void);
extern void quarc_basic_client_demo_output(void);
extern void quarc_basic_client_demo_update(void);
extern void quarc_basic_client_demo_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern quarc_basic_client_demo_rtModel *quarc_basic_client_demo(void);
...
extern RT_MODEL_quarc_basic_client_d_T *const quarc_basic_client_demo_M;
 ...
 *
 * '<Root>' : 'quarc_basic_client_demo'
 * '<S1>'   : 'quarc_basic_client_demo/Powered by QUARC'
 * '<S2>'   : 'quarc_basic_client_demo/Quanser'
 */
#endif                                 /* quarc_basic_client_demo_h_ */
