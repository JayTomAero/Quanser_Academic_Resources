...
RT_MODEL_quarc_basic_client_d_T *quarc_basic_client_demo(void)
{
  ...
  /* External mode info */
  quarc_basic_client_demo_M->Sizes.checksums[0] = (1762916436U);
  quarc_basic_client_demo_M->Sizes.checksums[1] = (1317946868U);
  quarc_basic_client_demo_M->Sizes.checksums[2] = (2898688565U);
  quarc_basic_client_demo_M->Sizes.checksums[3] = (1242002068U);
