...
## Generated on : Mon Aug 10 14:23:52 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/quarc_basic_client_demo.rt-linux_qdrone2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/quarc_basic_client_demo.rt-linux_qdrone2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/blocks/COMMUN~1 -IC:/PROGRA~1/Quanser/QUARC/include
...
SRCS = $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo.c $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo_data.c $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo_main.c $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rtGetInf.c $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rtGetNaN.c $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = quarc_basic_client_demo.o quarc_basic_client_demo_data.o quarc_basic_client_demo_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
LIBS = C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/LI9EE3~1.A C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/LI2CD2~1.A C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/LIBQUA~2.A C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/LIBQUA~1.A C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/libcurl.a C:/PROGRA~1/Quanser/QUARC/lib/LI3E92~1/LIBCIV~1.A
...
%.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
quarc_basic_client_demo.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo.c
	$(CC) $(CFLAGS) -o"$@" "$<"


quarc_basic_client_demo_data.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


quarc_basic_client_demo_main.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/quarc_basic_client_demo_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/quarc_basic_client_demo_quarc_linux_qdrone2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
