...
typedef RT_MODEL_QD2_DroneStack_Manua_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * QD2_DroneStack_Manual_2021a(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(QD2_DroneStack_Manual_2021a_M, GBLbuf.message);
}
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&QD2_DroneStack_Manual_2021a_DW.ComputationTime1_ComputationTim,
           &end_time, &QD2_DroneStack_Manual_2021a_DW.ComputationTime1_BeginTime);
      }
      ...
      if (local_result == 0) {
        local_result = timeout_subtract
          (&QD2_DroneStack_Manual_2021a_DW.ComputationTime2_ComputationTim,
           &end_time, &QD2_DroneStack_Manual_2021a_DW.ComputationTime2_BeginTime);
      }
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: QD2_DroneStack_Manual_2021a -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
  ...
  string_copy((char *)
              QD2_DroneStack_Manual_2021a_B.IPAddressofSupervisoryModelMiss, 80,
              extra_arg1);
