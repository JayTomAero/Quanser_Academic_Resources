...
## Generated on : Fri Aug 14 16:41:58 2026
...
PRODUCT_NAME              = QD2_DroneStack_PID_2021a
MAKEFILE                  = QD2_DroneStack_PID_2021a.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2026a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2026a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/jayca/Quanser_Academic_Resources/5_research/autonomous_vehicles/qdrone2/manual_flight_position_command
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/QD2_DroneStack_PID_2021a.rt-linux_qdrone2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/blocks/COMMUN~1 -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=QD2_DroneStack_PID_2021a -DNUMST=5 -DNCSTATES=56 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a_data.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a_main.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rtGetInf.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rtGetNaN.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rt_nonfinite.c $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rt_zcfcn.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = QD2_DroneStack_PID_2021a.o QD2_DroneStack_PID_2021a_data.o QD2_DroneStack_PID_2021a_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_zcfcn.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
QD2_DroneStack_PID_2021a.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a.c
	$(CC) $(CFLAGS) -o"$@" "$<"


QD2_DroneStack_PID_2021a_data.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


QD2_DroneStack_PID_2021a_main.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/QD2_DroneStack_PID_2021a_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_zcfcn.o : $(START_DIR)/QD2_DroneStack_PID_2021a_quarc_linux_qdrone2/rt_zcfcn.c
	$(CC) $(CFLAGS) -o"$@" "$<"
